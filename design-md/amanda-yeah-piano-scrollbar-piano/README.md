# Amanda Yeh Piano Scrollbar Piano Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Amanda Yeh Piano Scrollbar Piano](https://amandayehh.github.io/scrollbar-piano) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/amanda-yeah-piano-scrollbar-piano). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: playful, sound-design, colorful
- Credits: Amanda Yeh
...
### Web
![Amanda Yeh Piano Scrollbar Piano desktop capture](./screenshots/desktop.jpg)

### Mobile
![Amanda Yeh Piano Scrollbar Piano mobile capture](./screenshots/mobile.jpg)
