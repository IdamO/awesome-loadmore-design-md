# Minimal Space - Peach Sunrise Inspired Design System

[DESIGN.md](./DESIGN.md) derived from the Arte Collective poster [Minimal Space - Peach Sunrise](https://arte-collective.com/collections/minimalism/products/minimal-space-peach-sunrise). This entry intentionally ignores the storefront chrome and instead translates the poster artwork into an imagined interactive website system with web/mobile guidance, spatial mechanics, and motion rules.
...
### Web
![Minimal Space - Peach Sunrise desktop capture](./screenshots/desktop.jpg)

### Mobile
![Minimal Space - Peach Sunrise mobile capture](./screenshots/mobile.jpg)
