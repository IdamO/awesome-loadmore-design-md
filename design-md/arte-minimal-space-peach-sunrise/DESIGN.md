...
- Core palette: #fea71e, #e6e6e6, #ffa71e, #e4e4e4
...
- Aura: Minimal Space - Peach Sunrise should feel like a drifting internet relic whose full poster composition becomes a shallow-depth, glow-rail field.
...
- Color 1: #fea71e - canvas / dominant background
- Color 2: #e6e6e6 - primary text or opposing surface
- Color 3: #ffa71e - accent / interactive signal
- Color 4: #e4e4e4 - supporting surface or hover state
- Color 5: #785721 - supporting surface or hover state
- Color 6: #fea71d - supporting surface or hover state
- Color 7: #fba71e - supporting surface or hover state
...
- Let the main background color (#fea71e) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #fea71d backgrounds with #111111 text, and links inherit #fea71d as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(254, 167, 29, 0.35)
...
- Keep the palette anchored to #fea71e, #e6e6e6, and #ffa71e.
...
- Source: Arte Collective (https://arte-collective.com/collections/minimalism/products/minimal-space-peach-sunrise)
- Live site: https://arte-collective.com/collections/minimalism/products/minimal-space-peach-sunrise
