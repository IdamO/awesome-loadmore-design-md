...
### World Systems
- Primary: Luxury Archive - tags include photography; archetype affinity: editorial archive index
...
- Why: tags include educational; tags include photography; description mentions search; sticky layout
- Core verbs: browse, filter, open, drag
...
- Preserve asymmetry when present - the archive tags (tactile, photography, educational) imply the system is intentionally non-generic.
...
- Preserve the experimental posture signaled by the archive tags: tactile, photography, educational.
