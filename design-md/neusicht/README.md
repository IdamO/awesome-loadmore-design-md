# Neusicht Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Neusicht](https://www.neusicht.ch/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/neusicht). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Neusicht desktop capture](./screenshots/desktop.jpg)

### Mobile
![Neusicht mobile capture](./screenshots/mobile.jpg)
