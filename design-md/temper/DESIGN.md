...
### World Systems
- Primary: Playable Poster - tags include typography; archetype affinity: playable poster; large display type
- Secondary: Collage Core - archetype affinity: playable poster

### Interaction Archetype
- Archetype: Playable Poster (68% confidence)
- Why: tags include typography; large display type; sticky layout
...
- Support: Indicate Mono Condensed
- Support: Balkenschrift
...
- Preserve asymmetry when present - the archive tags (typography, minimal) imply the system is intentionally non-generic.
- Buttons tend toward rgba(0, 0, 0, 0) backgrounds with rgb(0, 0, 0) text, and links inherit rgb(0, 0, 238) as the interaction signal.
...
- Preserve the experimental posture signaled by the archive tags: typography, minimal.
...
> Build this as a Playable Poster page with a secondary cue from Collage Core using the Playable Poster interaction model. Keep Scope as the voice anchor, preserve the palette around #0e0e0e, #fc772f, #0c59fa, drive the page through scroll, tap, hover, and implement the mobile fallback as: Split the poster into two to four scenes, preserve one hero interaction, and drop hover-only secondary behavior.
