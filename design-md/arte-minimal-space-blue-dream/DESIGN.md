...
- Core palette: #77c9dc, #e5e5e5, #77c9db, #47666d
...
- Aura: Minimal Space - Blue Dream should feel like a drifting internet relic whose full poster composition becomes a shallow-depth, glow-rail field.
...
- Color 1: #77c9dc - canvas / dominant background
- Color 2: #e5e5e5 - primary text or opposing surface
- Color 3: #77c9db - accent / interactive signal
- Color 4: #47666d - supporting surface or hover state
- Color 5: #77cadd - supporting surface or hover state
- Color 6: #77c9dd - supporting surface or hover state
- Color 7: #75cadd - supporting surface or hover state
- Color 8: #91d1df - supporting surface or hover state
...
- Let the main background color (#77c9dc) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #75cadd backgrounds with #111111 text, and links inherit #75cadd as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(117, 202, 221, 0.35)
...
- Keep the palette anchored to #77c9dc, #e5e5e5, and #77c9db.
...
- Source: Arte Collective (https://arte-collective.com/collections/minimalism/products/minimal-space-blue-dream)
- Live site: https://arte-collective.com/collections/minimalism/products/minimal-space-blue-dream
