# Badbadbadbad Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Badbadbadbad](https://badbadbadbad.com/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/badbadbadbad). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Badbadbadbad desktop capture](./screenshots/desktop.jpg)

### Mobile
![Badbadbadbad mobile capture](./screenshots/mobile.jpg)
