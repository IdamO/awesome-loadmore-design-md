# Design System Inspiration of Loading Giacomonanni

## 1. Visual Theme & Atmosphere

Loading Giacomonanni reads as restrained minimalism, retro-computing cues. The live capture resolves to a light-leaning system built around #dbdbdb, #141819, and accent notes from #5a625c. A website that never stops loading.

Desktop and mobile stay aligned but not identical: the desktop capture emphasizes a looser scroll narrative, while mobile compresses the same language into tighter interaction zones. The site's type system centers a bespoke stack, which becomes the fastest way to reproduce the feel.

Key Characteristics:
- Primary tone: bright surfaces with editorial contrast
- Core palette: #dbdbdb, #141819, #5a625c, #9fa5a0
...
- Archetype: Desktop Shell World (66% confidence)
- Why: tags include retro
- Core verbs: open, drag, shuffle
- Inputs: drag, tap, click

## 3. Color Palette & Roles

- Color 1: #dbdbdb - canvas / dominant background
- Color 2: #141819 - primary text or opposing surface
- Color 3: #5a625c - accent / interactive signal
- Color 4: #9fa5a0 - supporting surface or hover state
- Color 5: #196919 - supporting surface or hover state
- Color 6: #a25352 - supporting surface or hover state
- Color 7: #3b5142 - supporting surface or hover state
- Color 8: #ceafae - supporting surface or hover state
...
- Let the main background color (#dbdbdb) carry the atmosphere instead of layering multiple competing surfaces.
- Preserve asymmetry when present - the archive tags (minimal, retro) imply the site is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #5a625c as the interaction signal.
...
- Keep the palette anchored to #dbdbdb, #141819, and #5a625c.
- Preserve the experimental posture signaled by the loadmo.re tags: minimal, retro.
...
> Build this as a Cozy Desktop page with a secondary cue from Collage Core using the Desktop Shell World interaction model. Keep the extracted primary font as the voice anchor, preserve the palette around #dbdbdb, #141819, #5a625c, drive the page through drag, tap, click, and implement the mobile fallback as: Translate the window system into a card stack, bottom drawer, or tabbed shell while preserving the desktop fiction in the chrome.

## 15. Source Capture & Validation

- Source: loadmo.re (https://loadmo.re/posts/loading-giacomonanni)
- Live site: https://loading.giacomonanni.info/
- Credits: Giacomo Nanni
- Capture mode: live
