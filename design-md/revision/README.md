# Revision Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Revision](https://www.revision.io/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/revision). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Revision desktop capture](./screenshots/desktop.jpg)

### Mobile
![Revision mobile capture](./screenshots/mobile.jpg)
