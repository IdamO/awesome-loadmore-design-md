# Andrea Perato Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Andrea Perato](http://andreaperato.com/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/andrea-perato). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Andrea Perato desktop capture](./screenshots/desktop.jpg)

### Mobile
![Andrea Perato mobile capture](./screenshots/mobile.jpg)
