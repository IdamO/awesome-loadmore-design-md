# ONE Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [ONE](https://one-is.com/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/one). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![ONE desktop capture](./screenshots/desktop.jpg)

### Mobile
![ONE mobile capture](./screenshots/mobile.jpg)
