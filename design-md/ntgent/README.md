# Ntgent Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Ntgent](https://www.ntgent.be/en) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/ntgent). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Ntgent desktop capture](./screenshots/desktop.jpg)

### Mobile
![Ntgent mobile capture](./screenshots/mobile.jpg)
