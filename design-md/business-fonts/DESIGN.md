# Design System Inspiration of Business Fonts

## 1. Visual Theme & Atmosphere

Business Fonts reads as type-led composition. The live capture resolves to a light-leaning system built around #7bf84f, #493830, and accent notes from #312420. Fun website to promote a font, featuring a text editor to try it live.

Desktop and mobile stay aligned but not identical: the desktop capture emphasizes a looser scroll narrative, while mobile compresses the same language into tighter interaction zones. The site's type system centers a bespoke stack, which becomes the fastest way to reproduce the feel.

Key Characteristics:
- Primary tone: bright surfaces with editorial contrast
- Core palette: #7bf84f, #493830, #312420, #554439
...
- Secondary: Collage Core - tags include graphic-design; archetype affinity: playable poster; archival visual bias
...
- Color 1: #7bf84f - canvas / dominant background
- Color 2: #493830 - primary text or opposing surface
- Color 3: #312420 - accent / interactive signal
- Color 4: #554439 - supporting surface or hover state
- Color 5: #685452 - supporting surface or hover state
- Color 6: #8b7069 - supporting surface or hover state
- Color 7: #88f55d - supporting surface or hover state
- Color 8: #0e29dc - supporting surface or hover state
...
- Let the main background color (#7bf84f) carry the atmosphere instead of layering multiple competing surfaces.
- Preserve asymmetry when present - the archive tags (typography, graphic-design) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #312420 as the interaction signal.
...
- Keep the palette anchored to #7bf84f, #493830, and #312420.
- Preserve the experimental posture signaled by the archive tags: typography, graphic-design.
...
> Build this as a Playable Poster page with a secondary cue from Collage Core using the Playable Poster interaction model. Keep the extracted primary font as the voice anchor, preserve the palette around #7bf84f, #493830, #312420, drive the page through scroll, tap, hover, and implement the mobile fallback as: Split the poster into two to four scenes, preserve one hero interaction, and drop hover-only secondary behavior.

## 15. Source Capture & Validation

- Source: loadmo.re (https://loadmo.re/posts/business-fonts)
- Live site: https://www.businessfonts.biz/
- Credits: not listed
