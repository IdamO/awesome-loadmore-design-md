# Snake Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Snake](https://snake.messyplayground.com/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/snake). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: participative, playful, illustration
- Credits: not listed
...
### Web
![Snake desktop capture](./screenshots/desktop.jpg)

### Mobile
![Snake mobile capture](./screenshots/mobile.jpg)
