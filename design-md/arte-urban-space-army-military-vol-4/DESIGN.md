# Design System Inspiration of Urban Space Army - Military vol.4

## 1. Visual Theme & Atmosphere

Urban Space Army - Military vol.4 reads as playful interaction, sonic pacing, retro-computing cues. The concept capture resolves to a dark-leaning system built around #171615, #141312, and accent notes from #e6e6e6. Urban Space Army - Military vol.4 is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #171615, #141312, #e6e6e6, #10100f
...
- Aura: Urban Space Army - Military vol.4 should feel like a live control poster whose full composition becomes a responsive HUD field instead of flat merch storytelling.
...
- Color 1: #171615 - canvas / dominant background
- Color 2: #141312 - primary text or opposing surface
- Color 3: #e6e6e6 - accent / interactive signal
- Color 4: #10100f - supporting surface or hover state
- Color 5: #e2e2e2 - supporting surface or hover state
- Color 6: #0e0d0c - supporting surface or hover state
- Color 7: #121110 - supporting surface or hover state
- Color 8: #343e43 - supporting surface or hover state
...
- Let the main background color (#171615) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #343e43 backgrounds with #ffffff text, and links inherit #343e43 as the interaction signal.
...
- Render tier: mixed
- Primary depth cue in capture: 0 24px 80px rgba(52, 62, 67, 0.35)
...
- Keep the palette anchored to #171615, #141312, and #e6e6e6.
...
- Source: Arte Collective (https://arte-collective.com/collections/technology/products/urban-space-army-military-vol-4)
- Live site: https://arte-collective.com/collections/technology/products/urban-space-army-military-vol-4
