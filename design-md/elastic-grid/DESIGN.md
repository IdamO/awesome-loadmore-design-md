# Design System Inspiration of Elastic Grid

## 1. Visual Theme & Atmosphere

Elastic Grid reads as retro-computing cues. The live capture resolves to a light-leaning system built around #fdfdfd, #000000, and accent notes from #d9d9d9. Drag the screen to stretch and pinch an elastic checkered grid. Tap to switch up the layout.

Desktop and mobile stay aligned but not identical: the desktop capture emphasizes a looser scroll narrative, while mobile compresses the same language into tighter interaction zones. The site's type system centers a bespoke stack, which becomes the fastest way to reproduce the feel.

Key Characteristics:
- Primary tone: bright surfaces with editorial contrast
- Core palette: #fdfdfd, #000000, #d9d9d9, #252525
...
### World Systems
- Primary: Collage Core - tags include net.art; tags include retro; tags include tactile
- Secondary: Playable Poster - tags include tactile; description mentions drag; archetype affinity: collage field

### Interaction Archetype
- Archetype: Collage Field (68% confidence)
- Why: tags include net.art; tags include retro
- Core verbs: scan, hover, collect, drag
- Inputs: scroll, hover, tap, drag
...
- Color 4: #252525 - supporting surface or hover state
- Color 5: #787878 - supporting surface or hover state
- Color 6: #888888 - supporting surface or hover state
...
- Preserve asymmetry when present - the archive tags (tactile, net.art, retro) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #d9d9d9 as the interaction signal.
...
- Inputs to preserve: scroll, hover, tap, drag
...
- Keep the palette anchored to #fdfdfd, #000000, and #d9d9d9.
- Preserve the experimental posture signaled by the archive tags: tactile, net.art, retro.
...
> Build this as a Collage Core page with a secondary cue from Playable Poster using the Collage Field interaction model. Keep the extracted primary font as the voice anchor, preserve the palette around #fdfdfd, #000000, #d9d9d9, drive the page through scroll, hover, tap, drag, and implement the mobile fallback as: Flatten the field into a guided scavenger feed or chapter stack while preserving overlap, stickers, and hyperlink energy.

## 15. Source Capture & Validation

- Source: loadmo.re (https://loadmo.re/posts/elastic-grid)
- Live site: https://elasticgrid.pinkus.link/
- Credits: Juan Pinkus
- Capture mode: live
