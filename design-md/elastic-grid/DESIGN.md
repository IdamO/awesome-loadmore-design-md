...
- Preserve asymmetry when present - the archive tags (tactile, net.art, retro) imply the site is intentionally non-generic.
...
- Preserve the experimental posture signaled by the loadmo.re tags: tactile, net.art, retro.
