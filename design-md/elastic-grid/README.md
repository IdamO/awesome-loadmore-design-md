# Elastic Grid Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Elastic Grid](https://elasticgrid.pinkus.link/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/elastic-grid). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Elastic Grid desktop capture](./screenshots/desktop.jpg)

### Mobile
![Elastic Grid mobile capture](./screenshots/mobile.jpg)
