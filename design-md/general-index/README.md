# General Index Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [General Index](https://general-index.eu/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/general-index). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: e-commerce, fashion, graphic-design
...
### Web
![General Index desktop capture](./screenshots/desktop.jpg)

### Mobile
![General Index mobile capture](./screenshots/mobile.jpg)
