...
### World Systems
- Primary: Luxury Archive - tags include fashion; tags include e-commerce; archetype affinity: editorial archive index
- Secondary: Fan Shrine - tags include fashion; tags include e-commerce

### Interaction Archetype
- Archetype: Editorial Archive Index (91% confidence)
- Why: description mentions index; title mentions index; sticky layout
...
- Preserve asymmetry when present - the archive tags (e-commerce, fashion, graphic-design) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #e5d9aa as the interaction signal.
...
- Preserve the experimental posture signaled by the archive tags: e-commerce, fashion, graphic-design.
...
> Build this as a Luxury Archive page with a secondary cue from Fan Shrine using the Editorial Archive Index interaction model. Keep the extracted primary font as the voice anchor, preserve the palette around #fdfdfd, #a4a9a0, #e5d9aa, drive the page through scroll, tap, filter, and implement the mobile fallback as: Keep a single-column feed, bottom-sheet filters, a persistent current-section pill, and inline detail expansion.
