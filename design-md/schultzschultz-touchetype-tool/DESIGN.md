...
### World Systems
- Primary: Cozy Desktop - tags include participative; archetype affinity: retro tool emulator
- Secondary: Playable Poster - tags include typography; tags include tactile

### Interaction Archetype
- Archetype: Retro Tool Emulator (68% confidence)
- Why: tags include typography; description mentions tool
...
- Preserve asymmetry when present - the archive tags (typography, tactile, participative) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit rgb(136, 136, 136) as the interaction signal.
...
- Preserve the experimental posture signaled by the archive tags: typography, tactile, participative.
...
> Build this as a Cozy Desktop page with a secondary cue from Playable Poster using the Retro Tool Emulator interaction model. Keep FontAwesome as the voice anchor, preserve the palette around #fefefe, #e7e7e7, #d8d8d8, drive the page through tap, drag, type, and implement the mobile fallback as: Turn dense panels into a one-tool-at-a-time inspector or wizard while preserving the visual chrome.
