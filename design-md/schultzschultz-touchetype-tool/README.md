# Schultzschultz - ToucheType Tool Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Schultzschultz - ToucheType Tool](https://schultzschultz.com/touchtype) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/schultzschultz-touchetype-tool). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: typography, tactile, participative
- Credits: not listed
...
### Web
![Schultzschultz - ToucheType Tool desktop capture](./screenshots/desktop.jpg)

### Mobile
![Schultzschultz - ToucheType Tool mobile capture](./screenshots/mobile.jpg)
