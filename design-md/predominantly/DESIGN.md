...
### World Systems
- Primary: Luxury Archive - archetype affinity: editorial archive index
- Secondary: Club Instrument - description mentions music

### Interaction Archetype
- Archetype: Editorial Archive Index (66% confidence)
- Why: description mentions search
...
- Preserve asymmetry when present - the archive tags (experience, colorful) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #0a0707 as the interaction signal.
...
- Preserve the experimental posture signaled by the archive tags: experience, colorful.
...
> Build this as a Luxury Archive page with a secondary cue from Club Instrument using the Editorial Archive Index interaction model. Keep the extracted primary font as the voice anchor, preserve the palette around #da362a, #f7f6f5, #0a0707, drive the page through scroll, tap, filter, and implement the mobile fallback as: Keep a single-column feed, bottom-sheet filters, a persistent current-section pill, and inline detail expansion.
