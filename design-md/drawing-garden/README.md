# Drawing Garden Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Drawing Garden](https://drawing.garden/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/drawing-garden). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- World systems: Collage Core, Club Instrument
...
- Tags: net.art, sound-design, colorful
- Credits: Ben Moren
...
### Web
![Drawing Garden desktop capture](./screenshots/desktop.jpg)

### Mobile
![Drawing Garden mobile capture](./screenshots/mobile.jpg)
