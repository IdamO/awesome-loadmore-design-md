...
### World Systems
- Primary: Collage Core - tags include glitches; tags include tactile; archetype affinity: collage field
- Secondary: Playable Poster - tags include tactile; description mentions typography; archetype affinity: collage field

### Interaction Archetype
- Archetype: Collage Field (68% confidence)
- Why: tags include glitches; large display type
...
- Preserve asymmetry when present - the archive tags (tactile, portfolio, glitches) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit rgba(0, 0, 0, 0) as the interaction signal.
...
- Preserve the experimental posture signaled by the archive tags: tactile, portfolio, glitches.
