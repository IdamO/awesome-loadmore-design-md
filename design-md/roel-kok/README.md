# Roel Kok Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Roel Kok](http://roelkok.net/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/roel-kok). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: tactile, portfolio, glitches
...
### Web
![Roel Kok desktop capture](./screenshots/desktop.jpg)

### Mobile
![Roel Kok mobile capture](./screenshots/mobile.jpg)
