...
- Why: tags include music; tags include playful; tags include 3d-space; description mentions opera
...
- Buttons tend toward transparent backgrounds with inherit text, and links inherit rgb(60, 64, 67) as the interaction signal.
...
- Nice-to-have embellishments:
  ...
  - description mentions opera
  - description mentions sing
  - title mentions opera
