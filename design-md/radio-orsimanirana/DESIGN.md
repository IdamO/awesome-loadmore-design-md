...
- Secondary: Luxury Archive - tags include arts&culture; description mentions exhibition

### Interaction Archetype
- Archetype: Club Instrument (80% confidence)
- Why: tags include music; description mentions radio; title mentions radio
...
- Preserve asymmetry when present - the archive tags (music, arts&culture, glitches) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #a49f9d as the interaction signal.
...
- Preserve the experimental posture signaled by the archive tags: music, arts&culture, glitches.
