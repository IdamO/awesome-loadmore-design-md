# Samuel Dumez Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Samuel Dumez](https://sa-m.fr/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/sam-dumez). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: playful, portfolio, minimal
...
### Web
![Samuel Dumez desktop capture](./screenshots/desktop.jpg)

### Mobile
![Samuel Dumez mobile capture](./screenshots/mobile.jpg)
