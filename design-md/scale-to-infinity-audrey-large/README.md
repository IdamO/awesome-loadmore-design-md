# Scale to Infinity, Audrey Large Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Scale to Infinity, Audrey Large](https://scaletoinfinity.nilufar.com/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/scale-to-infinity-audrey-large). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: digital-exhibition, arts&culture, 3d-space
...
### Web
![Scale to Infinity, Audrey Large desktop capture](./screenshots/desktop.jpg)

### Mobile
![Scale to Infinity, Audrey Large mobile capture](./screenshots/mobile.jpg)
