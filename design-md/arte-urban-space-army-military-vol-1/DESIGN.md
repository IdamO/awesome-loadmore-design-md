# Design System Inspiration of Urban Space Army - Military vol.1

## 1. Visual Theme & Atmosphere

Urban Space Army - Military vol.1 reads as playful interaction, sonic pacing, retro-computing cues. The concept capture resolves to a light-leaning system built around #cac3b6, #e5e5e5, and accent notes from #3690c1. Urban Space Army - Military vol.1 is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #cac3b6, #e5e5e5, #3690c1, #324b58
...
- Aura: Urban Space Army - Military vol.1 should feel like a live control poster whose full composition becomes a responsive HUD field instead of flat merch storytelling.
...
- Color 1: #cac3b6 - canvas / dominant background
- Color 2: #e5e5e5 - primary text or opposing surface
- Color 3: #3690c1 - accent / interactive signal
- Color 4: #324b58 - supporting surface or hover state
- Color 5: #c9c3b6 - supporting surface or hover state
- Color 6: #cbc3b6 - supporting surface or hover state
- Color 7: #d3ccc2 - supporting surface or hover state
- Color 8: #cac3b7 - supporting surface or hover state
...
- Let the main background color (#cac3b6) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #3690c1 backgrounds with #ffffff text, and links inherit #3690c1 as the interaction signal.
...
- Render tier: mixed
- Primary depth cue in capture: 0 24px 80px rgba(54, 144, 193, 0.35)
...
- Keep the palette anchored to #cac3b6, #e5e5e5, and #3690c1.
...
- Live site: https://arte-collective.com/collections/technology/products/urban-space-army-military-vol-1
