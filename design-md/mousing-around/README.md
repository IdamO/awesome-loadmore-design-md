# Mousing Around Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Mousing Around](http://domitilledebret.net/cursor/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/mousing-around). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: default-aesthetics, tactile, playful
...
### Web
![Mousing Around desktop capture](./screenshots/desktop.jpg)

### Mobile
![Mousing Around mobile capture](./screenshots/mobile.jpg)
