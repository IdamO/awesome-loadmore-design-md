...
### World Systems
- Primary: Club Instrument - tags include playful; archetype affinity: club instrument
- Secondary: Cozy Desktop - tags include default-aesthetics; tags include playful

### Interaction Archetype
- Archetype: Club Instrument (66% confidence)
- Why: tags include playful; description mentions sing
...
- Preserve asymmetry when present - the archive tags (default-aesthetics, tactile, playful) imply the system is intentionally non-generic.
...
- Preserve the experimental posture signaled by the archive tags: default-aesthetics, tactile, playful.
