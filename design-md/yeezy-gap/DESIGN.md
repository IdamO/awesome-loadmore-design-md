...
- Links inherit #8e585c as the interaction signal.
...
- Preserve asymmetry when present - the archive tags (fashion, game, retro) imply the site is intentionally non-generic.
...
- Preserve the experimental posture signaled by the loadmo.re tags: fashion, game, retro.
...
> Build a responsive landing page inspired by Yeezy Gap. Keep the palette centered on #22060b, #5b191e, and #8e585c. Use the extracted primary font for headlines, preserve the playful interaction, editorial fashion energy, retro-computing cues mood, and treat desktop and mobile as distinct compositions rather than a single squashed layout.
