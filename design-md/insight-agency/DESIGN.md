...
- Why: tags include portfolio; tags include photography; description mentions portfolio
...
- Preserve asymmetry when present - the archive tags (portfolio, photography, colorful) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit rgb(255, 0, 206) as the interaction signal.
...
- Preserve the experimental posture signaled by the archive tags: portfolio, photography, colorful.
