# Nike Moonshot Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Nike Moonshot](https://johnprovencher.com/moonshot/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/nike-moonshot). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Nike Moonshot desktop capture](./screenshots/desktop.jpg)

### Mobile
![Nike Moonshot mobile capture](./screenshots/mobile.jpg)
