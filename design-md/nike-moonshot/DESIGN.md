...
- Preserve asymmetry when present - the archive tags (net.art, minimal) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit rgb(2, 128, 125) as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: rgba(53, 58, 62, 0.06) 0px 1px 10px 0px, rgba(53, 58, 62, 0.08) 0px 2px 4px 0px
...
- Preserve the experimental posture signaled by the archive tags: net.art, minimal.
...
> Build this as a Collage Core page with a secondary cue from Luxury Archive using the Collage Field interaction model. Keep the extracted primary font as the voice anchor, preserve the palette around #fefefe, #a9adaf, #accdcb, drive the page through scroll, hover, tap, and implement the mobile fallback as: Flatten the field into a guided scavenger feed or chapter stack while preserving overlap, stickers, and hyperlink energy.
