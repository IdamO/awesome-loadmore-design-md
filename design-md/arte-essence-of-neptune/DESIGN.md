# Design System Inspiration of Essence of Neptune

## 1. Visual Theme & Atmosphere

Essence of Neptune reads as type-led composition, spatial depth. The concept capture resolves to a light-leaning system built around #e4e3e2, #ccccce, and accent notes from #789db0. Essence of Neptune is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #e4e3e2, #ccccce, #789db0, #92c1d1
...
- Aura: Essence of Neptune should feel like a drifting internet relic whose full poster composition becomes a shallow-depth, glow-rail field.
...
- Color 1: #e4e3e2 - canvas / dominant background
- Color 2: #ccccce - primary text or opposing surface
- Color 3: #789db0 - accent / interactive signal
- Color 4: #92c1d1 - supporting surface or hover state
- Color 5: #f4f4f3 - supporting surface or hover state
- Color 6: #4a4a6b - supporting surface or hover state
- Color 7: #e6e2de - supporting surface or hover state
- Color 8: #b0dede - supporting surface or hover state
...
- Let the main background color (#e4e3e2) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #789db0 backgrounds with #ffffff text, and links inherit #789db0 as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(120, 157, 176, 0.35)
...
- Keep the palette anchored to #e4e3e2, #ccccce, and #789db0.
...
- Source: Arte Collective (https://arte-collective.com/collections/aesthetic/products/essence-of-neptune)
- Live site: https://arte-collective.com/collections/aesthetic/products/essence-of-neptune
