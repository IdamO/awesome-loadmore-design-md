...
- Core palette: #5e3533, #e4e4e4, #e5e5e5, #e6e6e6
...
- Aura: No Second Earth - Brown should feel like a text artifact stretched into a calm browser field, where bars and phrases become the whole interaction surface.
...
- Color 1: #5e3533 - canvas / dominant background
...
- Color 5: #2d2121 - supporting surface or hover state
- Color 6: #5f3533 - supporting surface or hover state
- Color 7: #5d3533 - supporting surface or hover state
- Color 8: #9c7069 - supporting surface or hover state
...
- Let the main background color (#5e3533) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #5f3533 backgrounds with #ffffff text, and links inherit #5f3533 as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(95, 53, 51, 0.35)
...
- Keep the palette anchored to #5e3533, #e4e4e4, and #e5e5e5.
...
- Source: Arte Collective (https://arte-collective.com/collections/minimalism/products/no-second-earth-brown)
- Live site: https://arte-collective.com/collections/minimalism/products/no-second-earth-brown
