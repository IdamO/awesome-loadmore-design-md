# Design System Inspiration of FLIP

## 1. Visual Theme & Atmosphere

FLIP reads as playful interaction. The live capture resolves to a light-leaning system built around #fefefe, #010101, and accent notes from #a1a1a1. Just flip your phone.

Desktop and mobile stay aligned but not identical: the desktop capture emphasizes a looser scroll narrative, while mobile compresses the same language into tighter interaction zones. The site's type system centers a bespoke stack, which becomes the fastest way to reproduce the feel.

Key Characteristics:
- Primary tone: bright surfaces with editorial contrast
- Core palette: #fefefe, #010101, #a1a1a1, #5b5b5b
...
### World Systems
- Primary: Playable Poster - tags include playful; archetype affinity: playable poster; large display type
...
- Why: tags include playful; large display type; sticky layout
...
- Color 4: #5b5b5b - supporting surface or hover state
- Color 5: #d2d2d2 - supporting surface or hover state
- Color 6: #181818 - supporting surface or hover state
- Color 7: #2f2f2f - supporting surface or hover state
...
### Hierarchy Snapshot
- Heading sample: 196px / weight 700 / letter-spacing -1.96px
- Body sample: 196px / weight 700 / line-height 196px
...
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #a1a1a1 as the interaction signal.
...
- Keep the palette anchored to #fefefe, #010101, and #a1a1a1.
