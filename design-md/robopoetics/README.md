# Robopoetics Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Robopoetics](https://robopoetics.com) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/robopoetics). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Robopoetics desktop capture](./screenshots/desktop.jpg)

### Mobile
![Robopoetics mobile capture](./screenshots/mobile.jpg)
