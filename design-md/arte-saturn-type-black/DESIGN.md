# Design System Inspiration of Type Saturn - Black

## 1. Visual Theme & Atmosphere

Type Saturn - Black reads as type-led composition, spatial depth. The concept capture resolves to a light-leaning system built around #e4e4e4, #161514, and accent notes from #1f1c1b. Type Saturn - Black is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #e4e4e4, #161514, #1f1c1b, #12100f
...
- Aura: Type Saturn - Black should feel like a spatial type specimen whose full poster composition has been pushed into browser depth, not a flat print inside a grid.
...
- Color 2: #161514 - primary text or opposing surface
- Color 3: #1f1c1b - accent / interactive signal
- Color 4: #12100f - supporting surface or hover state
- Color 5: #3a3939 - supporting surface or hover state
- Color 6: #0d0c0b - supporting surface or hover state
- Color 7: #e7e7e7 - supporting surface or hover state
- Color 8: #9c9c9b - supporting surface or hover state
...
- Buttons tend toward #12100f backgrounds with #ffffff text, and links inherit #12100f as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(18, 16, 15, 0.35)
...
- Keep the palette anchored to #e4e4e4, #161514, and #1f1c1b.
...
- Source: Arte Collective (https://arte-collective.com/collections/aesthetic/products/saturn-type-black)
- Live site: https://arte-collective.com/collections/aesthetic/products/saturn-type-black
