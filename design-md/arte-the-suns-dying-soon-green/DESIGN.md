...
- Core palette: #e5e5e5, #e7ddd0, #e6dbce, #335142
...
- Aura: The Sun's Dying Soon - Green should feel like a text artifact stretched into a calm browser field, where bars and phrases become the whole interaction surface.
...
- Color 2: #e7ddd0 - primary text or opposing surface
- Color 3: #e6dbce - accent / interactive signal
- Color 4: #335142 - supporting surface or hover state
- Color 5: #e3d9cd - supporting surface or hover state
- Color 6: #e9e0d5 - supporting surface or hover state
- Color 7: #adb5a7 - supporting surface or hover state
- Color 8: #e4e0da - supporting surface or hover state
...
- Buttons tend toward #335142 backgrounds with #ffffff text, and links inherit #335142 as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(51, 81, 66, 0.35)
...
- Keep the palette anchored to #e5e5e5, #e7ddd0, and #e6dbce.
...
- Source: Arte Collective (https://arte-collective.com/collections/minimalism/products/the-suns-dying-soon-green)
- Live site: https://arte-collective.com/collections/minimalism/products/the-suns-dying-soon-green
