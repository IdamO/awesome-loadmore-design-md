# Pizza Pizza Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Pizza Pizza](https://pizzapizza.io/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/pizza-pizza). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Pizza Pizza desktop capture](./screenshots/desktop.jpg)

### Mobile
![Pizza Pizza mobile capture](./screenshots/mobile.jpg)
