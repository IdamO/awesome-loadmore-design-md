# Gravity Studio Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Gravity Studio](https://gravitystudio.fun/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/gravity-studio). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: playful, colorful, participative
...
### Web
![Gravity Studio desktop capture](./screenshots/desktop.jpg)

### Mobile
![Gravity Studio mobile capture](./screenshots/mobile.jpg)
