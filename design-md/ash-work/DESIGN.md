...
- Preserve asymmetry when present - the archive tags (portfolio, 3d) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit rgb(242, 242, 242) as the interaction signal.
...
- Preserve the experimental posture signaled by the archive tags: portfolio, 3d.
