# Ash Work Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Ash Work](https://ash.work/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/ash-work). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Ash Work desktop capture](./screenshots/desktop.jpg)

### Mobile
![Ash Work mobile capture](./screenshots/mobile.jpg)
