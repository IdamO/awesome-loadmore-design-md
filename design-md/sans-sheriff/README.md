# Sans Sheriff Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Sans Sheriff](https://www.sanssheriff.wtf/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/sans-sheriff). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Sans Sheriff desktop capture](./screenshots/desktop.jpg)

### Mobile
![Sans Sheriff mobile capture](./screenshots/mobile.jpg)
