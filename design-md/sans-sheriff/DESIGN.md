...
### World Systems
- Primary: Playable Poster - tags include typography; archetype affinity: toy loop microgame
...
- Preserve asymmetry when present - the archive tags (game, typography) imply the system is intentionally non-generic.
- Buttons tend toward rgba(0, 0, 0, 0) backgrounds with rgb(254, 198, 63) text, and links inherit rgb(254, 176, 147) as the interaction signal.
...
- Preserve the experimental posture signaled by the archive tags: game, typography.
