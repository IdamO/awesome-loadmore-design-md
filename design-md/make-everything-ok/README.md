# Make Everything Ok Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Make Everything Ok](http://make-everything-ok.com/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/make-everything-ok). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Make Everything Ok desktop capture](./screenshots/desktop.jpg)

### Mobile
![Make Everything Ok mobile capture](./screenshots/mobile.jpg)
