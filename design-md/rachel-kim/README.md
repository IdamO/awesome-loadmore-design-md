# Rachel Kim Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Rachel Kim](https://yek99kr.github.io/ppp/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/rachel-kim). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Rachel Kim desktop capture](./screenshots/desktop.jpg)

### Mobile
![Rachel Kim mobile capture](./screenshots/mobile.jpg)
