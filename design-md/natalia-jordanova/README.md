# Natalia Jordanova Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Natalia Jordanova](https://nataliajordanova.com) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/natalia-jordanova). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Natalia Jordanova desktop capture](./screenshots/desktop.jpg)

### Mobile
![Natalia Jordanova mobile capture](./screenshots/mobile.jpg)
