...
- Secondary: Collage Core - tags include graphic-design; archival visual bias

### Interaction Archetype
- Archetype: Spatial Exhibition World (96% confidence)
- Why: tags include digital-exhibition; tags include arts&culture; description mentions room; description mentions rooms
...
- Preserve asymmetry when present - the archive tags (digital-exhibition, graphic-design, arts&culture) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #acd7eb as the interaction signal.
...
- Preserve the experimental posture signaled by the archive tags: digital-exhibition, graphic-design, arts&culture.
