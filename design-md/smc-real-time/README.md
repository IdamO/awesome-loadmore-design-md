# SMC REAL:TIME Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [SMC REAL:TIME](http://smc-real-time.com/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/smc-real-time). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: digital-exhibition, graphic-design, arts&culture
...
### Web
![SMC REAL:TIME desktop capture](./screenshots/desktop.jpg)

### Mobile
![SMC REAL:TIME mobile capture](./screenshots/mobile.jpg)
