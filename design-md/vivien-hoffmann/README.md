# Vivien Hoffmann Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Vivien Hoffmann](http://www.vivienhoffmann.com/index.html) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/vivien-hoffmann). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Vivien Hoffmann desktop capture](./screenshots/desktop.jpg)

### Mobile
![Vivien Hoffmann mobile capture](./screenshots/mobile.jpg)
