# Touch Grass Inspired Design System

[DESIGN.md](./DESIGN.md) derived from the Arte Collective poster [Touch Grass](https://arte-collective.com/collections/technology/products/touch-grass). This entry intentionally ignores the storefront chrome and instead translates the poster artwork into an imagined interactive website system with web/mobile guidance, spatial mechanics, and motion rules.
...
### Web
![Touch Grass desktop capture](./screenshots/desktop.jpg)

### Mobile
![Touch Grass mobile capture](./screenshots/mobile.jpg)
