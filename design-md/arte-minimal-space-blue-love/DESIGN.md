...
- Core palette: #5d6eb3, #5d6eb4, #e6e6e6, #e4e4e4
...
- Aura: Minimal Space - Blue Love should feel like a drifting internet relic whose full poster composition becomes a shallow-depth, glow-rail field.
...
- Color 1: #5d6eb3 - canvas / dominant background
- Color 2: #5d6eb4 - primary text or opposing surface
- Color 3: #e6e6e6 - accent / interactive signal
- Color 4: #e4e4e4 - supporting surface or hover state
- Color 5: #5c6eb3 - supporting surface or hover state
- Color 6: #2a2f43 - supporting surface or hover state
- Color 7: #5c6bad - supporting surface or hover state
- Color 8: #8590bd - supporting surface or hover state
...
- Let the main background color (#5d6eb3) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #5c6eb3 backgrounds with #ffffff text, and links inherit #5c6eb3 as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(92, 110, 179, 0.35)
...
- Keep the palette anchored to #5d6eb3, #5d6eb4, and #e6e6e6.
...
- Live site: https://arte-collective.com/collections/minimalism/products/minimal-space-blue-love
