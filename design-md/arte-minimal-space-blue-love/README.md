# Minimal Space - Blue Love Inspired Design System

[DESIGN.md](./DESIGN.md) derived from the Arte Collective poster [Minimal Space - Blue Love](https://arte-collective.com/collections/minimalism/products/minimal-space-blue-love). This entry intentionally ignores the storefront chrome and instead translates the poster artwork into an imagined interactive website system with web/mobile guidance, spatial mechanics, and motion rules.
...
### Web
![Minimal Space - Blue Love desktop capture](./screenshots/desktop.jpg)

### Mobile
![Minimal Space - Blue Love mobile capture](./screenshots/mobile.jpg)
