# Design System Inspiration of TIME : HUMAN

## 1. Visual Theme & Atmosphere

TIME : HUMAN reads as retro-computing cues, type-led composition, spatial depth. The concept capture resolves to a light-leaning system built around #e5e4e4, #84898a, and accent notes from #f3f3f3. TIME : HUMAN is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #e5e4e4, #84898a, #f3f3f3, #2f302f
...
- Aura: TIME : HUMAN should feel like a sacred object from Technology, with the entire poster composition expanded into a shallow 3D archive room.
...
- Color 1: #e5e4e4 - canvas / dominant background
- Color 2: #84898a - primary text or opposing surface
- Color 3: #f3f3f3 - accent / interactive signal
- Color 4: #2f302f - supporting surface or hover state
- Color 5: #a2a7a7 - supporting surface or hover state
- Color 6: #ab494b - supporting surface or hover state
- Color 7: #d9dad9 - supporting surface or hover state
- Color 8: #e8e9e9 - supporting surface or hover state
...
- Let the main background color (#e5e4e4) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #ab494b backgrounds with #ffffff text, and links inherit #ab494b as the interaction signal.
...
- Render tier: mixed
- Primary depth cue in capture: 0 24px 80px rgba(171, 73, 75, 0.35)
...
- Keep the palette anchored to #e5e4e4, #84898a, and #f3f3f3.
...
- Source: Arte Collective (https://arte-collective.com/collections/technology/products/time-human)
- Live site: https://arte-collective.com/collections/technology/products/time-human
