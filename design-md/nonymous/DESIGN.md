# Design System Inspiration of Nonymous

## 1. Visual Theme & Atmosphere

Nonymous reads as type-led composition. The live capture resolves to a light-leaning system built around #fefefe, #c6c6c6, and accent notes from #b7b7b7. They made the act of scrolling elastic and satisfying.

Desktop and mobile stay aligned but not identical: the desktop capture emphasizes a looser scroll narrative, while mobile compresses the same language into tighter interaction zones. The site's type system centers a bespoke stack, which becomes the fastest way to reproduce the feel.

Key Characteristics:
- Primary tone: bright surfaces with editorial contrast
- Core palette: #fefefe, #c6c6c6, #b7b7b7, #aaaaaa
...
### World Systems
- Primary: Playable Poster - tags include typography; tags include animation
- Secondary: Luxury Archive - tags include typography; archetype affinity: portfolio artifact

### Interaction Archetype
- Archetype: Portfolio Artifact (68% confidence)
- Why: tags include portfolio; tags include typography
...
- Color 2: #c6c6c6 - primary text or opposing surface
- Color 3: #b7b7b7 - accent / interactive signal
- Color 4: #aaaaaa - supporting surface or hover state
- Color 5: #e5e5e5 - supporting surface or hover state
- Color 6: #dcdcdc - supporting surface or hover state
- Color 7: #000000 - supporting surface or hover state
...
- Preserve asymmetry when present - the archive tags (typography, animation, portfolio) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #b7b7b7 as the interaction signal.
...
- Keep the palette anchored to #fefefe, #c6c6c6, and #b7b7b7.
- Preserve the experimental posture signaled by the archive tags: typography, animation, portfolio.
