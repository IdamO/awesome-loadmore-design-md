...
- Preserve asymmetry when present - the archive tags (typography, animation, portfolio) imply the site is intentionally non-generic.
...
- Preserve the experimental posture signaled by the loadmo.re tags: typography, animation, portfolio.
