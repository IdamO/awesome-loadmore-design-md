# Nonymous Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Nonymous](https://nonymous.com) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/nonymous). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: typography, animation, portfolio
- Credits: not listed
...
### Web
![Nonymous desktop capture](./screenshots/desktop.jpg)

### Mobile
![Nonymous mobile capture](./screenshots/mobile.jpg)
