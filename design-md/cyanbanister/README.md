# Cyan Banister Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Cyan Banister](https://cyanbanister.com/) website, cross-referenced with [manual curation](https://cyanbanister.com/). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: portfolio, typography, playful
...
### Web
![Cyan Banister desktop capture](./screenshots/desktop.jpg)

### Mobile
![Cyan Banister mobile capture](./screenshots/mobile.jpg)
