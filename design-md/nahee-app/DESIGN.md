...
- Preserve asymmetry when present - the archive tags (animation, colorful, portfolio) imply the system is intentionally non-generic.
...
- Preserve the experimental posture signaled by the archive tags: animation, colorful, portfolio.
