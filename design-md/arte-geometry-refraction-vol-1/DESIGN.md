# Design System Inspiration of Geometry refraction vol.1

## 1. Visual Theme & Atmosphere

Geometry refraction vol.1 reads as type-led composition, spatial depth. The concept capture resolves to a dark-leaning system built around #1b1a18, #e4e4e4, and accent notes from #131211. Geometry refraction vol.1 is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #1b1a18, #e4e4e4, #131211, #161515
...
- Aura: Geometry refraction vol.1 should feel like a sacred object from Aesthetic, with the entire poster composition expanded into a shallow 3D archive room.
...
- Color 1: #1b1a18 - canvas / dominant background
- Color 2: #e4e4e4 - primary text or opposing surface
- Color 3: #131211 - accent / interactive signal
- Color 4: #161515 - supporting surface or hover state
- Color 5: #0f0e0d - supporting surface or hover state
- Color 6: #a39d8d - supporting surface or hover state
- Color 7: #e8e8e8 - supporting surface or hover state
- Color 8: #2c2826 - supporting surface or hover state
...
- Let the main background color (#1b1a18) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #2c2826 backgrounds with #ffffff text, and links inherit #2c2826 as the interaction signal.
...
- Render tier: mixed
- Primary depth cue in capture: 0 24px 80px rgba(44, 40, 38, 0.35)
...
- Keep the palette anchored to #1b1a18, #e4e4e4, and #131211.
...
- Live site: https://arte-collective.com/collections/aesthetic/products/geometry-refraction-vol-1
