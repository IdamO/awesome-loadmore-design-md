...
- Why: description mentions play; description mentions interact
...
- Preserve asymmetry when present - the archive tags (video) imply the system is intentionally non-generic.
...
- Preserve the experimental posture signaled by the archive tags: video.
