# Design System Inspiration of Normal is boring

## 1. Visual Theme & Atmosphere

Normal is boring reads as type-led composition, spatial depth. The concept capture resolves to a light-leaning system built around #e4e4e4, #686868, and accent notes from #d2d2d2. Normal is boring is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #e4e4e4, #686868, #d2d2d2, #4f4f4f
...
- Aura: Normal is boring should feel like a drifting internet relic whose full poster composition becomes a shallow-depth, glow-rail field.
...
- Color 2: #686868 - primary text or opposing surface
- Color 3: #d2d2d2 - accent / interactive signal
- Color 4: #4f4f4f - supporting surface or hover state
- Color 5: #8a8a8a - supporting surface or hover state
- Color 6: #2a2a2a - supporting surface or hover state
- Color 7: #b5b5b5 - supporting surface or hover state
...
- Buttons tend toward #2a2a2a backgrounds with #ffffff text, and links inherit #2a2a2a as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(42, 42, 42, 0.35)
...
- Keep the palette anchored to #e4e4e4, #686868, and #d2d2d2.
...
- Source: Arte Collective (https://arte-collective.com/collections/aesthetic/products/normal-is-boring)
- Live site: https://arte-collective.com/collections/aesthetic/products/normal-is-boring
