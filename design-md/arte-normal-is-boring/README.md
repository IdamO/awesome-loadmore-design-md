# Normal is boring Inspired Design System

[DESIGN.md](./DESIGN.md) derived from the Arte Collective poster [Normal is boring](https://arte-collective.com/collections/aesthetic/products/normal-is-boring). This entry intentionally ignores the storefront chrome and instead translates the poster artwork into an imagined interactive website system with web/mobile guidance, spatial mechanics, and motion rules.
...
### Web
![Normal is boring desktop capture](./screenshots/desktop.jpg)

### Mobile
![Normal is boring mobile capture](./screenshots/mobile.jpg)
