# Venice W. Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Venice W.](https://www.venicew.com) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/venice-w). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Venice W. desktop capture](./screenshots/desktop.jpg)

### Mobile
![Venice W. mobile capture](./screenshots/mobile.jpg)
