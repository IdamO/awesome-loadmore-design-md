# Loverboy Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Loverboy](https://loverboy.net/reality) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/loverboy). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: fashion, e-commerce, illustration
- Credits: not listed
...
### Web
![Loverboy desktop capture](./screenshots/desktop.jpg)

### Mobile
![Loverboy mobile capture](./screenshots/mobile.jpg)
