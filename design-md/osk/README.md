# Osk Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Osk](http://osk.co) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/osk). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: sound-design, tactile, video
- Credits: not listed
...
### Web
![Osk desktop capture](./screenshots/desktop.jpg)

### Mobile
![Osk mobile capture](./screenshots/mobile.jpg)
