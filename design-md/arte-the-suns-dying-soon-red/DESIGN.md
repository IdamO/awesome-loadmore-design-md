...
- Core palette: #e4e4e4, #e8dcc9, #b06d68, #e6d8c6
...
- Aura: The Sun's Dying Soon - Red should feel like a text artifact stretched into a calm browser field, where bars and phrases become the whole interaction surface.
...
- Color 2: #e8dcc9 - primary text or opposing surface
- Color 3: #b06d68 - accent / interactive signal
- Color 4: #e6d8c6 - supporting surface or hover state
- Color 5: #e3d6c4 - supporting surface or hover state
- Color 6: #e7dac7 - supporting surface or hover state
- Color 7: #e6dbc8 - supporting surface or hover state
- Color 8: #e7e5e1 - supporting surface or hover state
...
- Buttons tend toward #b06d68 backgrounds with #ffffff text, and links inherit #b06d68 as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(176, 109, 104, 0.35)
...
- Keep the palette anchored to #e4e4e4, #e8dcc9, and #b06d68.
...
- Source: Arte Collective (https://arte-collective.com/collections/minimalism/products/the-suns-dying-soon-red)
- Live site: https://arte-collective.com/collections/minimalism/products/the-suns-dying-soon-red
