...
### World Systems
- Primary: Collage Core - tags include glitches; tags include playful
- Secondary: Cozy Desktop - tags include portfolio; tags include playful

### Interaction Archetype
- Archetype: Portfolio Artifact (78% confidence)
- Why: tags include portfolio; tags include playful; description mentions artist
...
- Preserve asymmetry when present - the archive tags (portfolio, playful, glitches) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit rgb(187, 34, 153) as the interaction signal.
...
- Preserve the experimental posture signaled by the archive tags: portfolio, playful, glitches.
