# K2design Calendar Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [K2design Calendar](https://calendar.k2design.gr/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/k2design-calendar). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![K2design Calendar desktop capture](./screenshots/desktop.jpg)

### Mobile
![K2design Calendar mobile capture](./screenshots/mobile.jpg)
