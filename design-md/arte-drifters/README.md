# Drifters Inspired Design System

[DESIGN.md](./DESIGN.md) derived from the Arte Collective poster [Drifters](https://arte-collective.com/collections/aesthetic/products/drifters). This entry intentionally ignores the storefront chrome and instead translates the poster artwork into an imagined interactive website system with web/mobile guidance, spatial mechanics, and motion rules.
...
### Web
![Drifters desktop capture](./screenshots/desktop.jpg)

### Mobile
![Drifters mobile capture](./screenshots/mobile.jpg)
