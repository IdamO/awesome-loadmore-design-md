# Design System Inspiration of Drifters

## 1. Visual Theme & Atmosphere

Drifters reads as type-led composition, spatial depth. The concept capture resolves to a dark-leaning system built around #151314, #e9e8e6, and accent notes from #534ea8. Drifters is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #151314, #e9e8e6, #534ea8, #9a97d0
...
- Aura: Drifters should feel like a drifting internet relic whose full poster composition becomes a shallow-depth, glow-rail field.
...
- Color 1: #151314 - canvas / dominant background
- Color 2: #e9e8e6 - primary text or opposing surface
- Color 3: #534ea8 - accent / interactive signal
- Color 4: #9a97d0 - supporting surface or hover state
- Color 5: #c5d1d9 - supporting surface or hover state
- Color 6: #202133 - supporting surface or hover state
- Color 7: #d1e7ed - supporting surface or hover state
- Color 8: #1a1a37 - supporting surface or hover state
...
- Let the main background color (#151314) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #534ea8 backgrounds with #ffffff text, and links inherit #534ea8 as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(83, 78, 168, 0.35)
...
- Keep the palette anchored to #151314, #e9e8e6, and #534ea8.
...
- Source: Arte Collective (https://arte-collective.com/collections/aesthetic/products/drifters)
- Live site: https://arte-collective.com/collections/aesthetic/products/drifters
