# Saaaam Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Saaaam](https://www.saaa.am/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/saaaam). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Saaaam desktop capture](./screenshots/desktop.jpg)

### Mobile
![Saaaam mobile capture](./screenshots/mobile.jpg)
