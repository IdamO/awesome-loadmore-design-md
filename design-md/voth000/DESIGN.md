...
- Archetype: Club Instrument (68% confidence)
...
- Buttons tend toward rgb(255, 255, 255) backgrounds with rgb(0, 0, 0) text, and links inherit #b8e3fc as the interaction signal.
...
- Render tier: mixed
- Primary depth cue in capture: rgba(38, 165, 255, 0.196) 2px 2px 1px 0px
