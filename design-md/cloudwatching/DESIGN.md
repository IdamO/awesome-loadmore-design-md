...
- Core verbs: scan, hover, collect, scroll, draw
...
- Preserve asymmetry when present - the archive tags (participative, playful, net.art) imply the system is intentionally non-generic.
...
- Preserve the experimental posture signaled by the archive tags: participative, playful, net.art.
