# Cloudwatching Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Cloudwatching](http://cloudwatching.glitch.me/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/cloudwatching). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: participative, playful, net.art
...
### Web
![Cloudwatching desktop capture](./screenshots/desktop.jpg)

### Mobile
![Cloudwatching mobile capture](./screenshots/mobile.jpg)
