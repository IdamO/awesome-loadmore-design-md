...
### World Systems
- Primary: Collage Core - tags include playful; archetype affinity: toy loop microgame; archival visual bias
...
- Preserve asymmetry when present - the archive tags (participative, playful, ai&generative) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #e7d9b3 as the interaction signal.
...
- Preserve the experimental posture signaled by the archive tags: participative, playful, ai&generative.
