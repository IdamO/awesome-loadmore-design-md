# Mind's Expansion Inspired Design System

[DESIGN.md](./DESIGN.md) derived from the Arte Collective poster [Mind's Expansion](https://arte-collective.com/collections/aesthetic/products/minds-expansion). This entry intentionally ignores the storefront chrome and instead translates the poster artwork into an imagined interactive website system with web/mobile guidance, spatial mechanics, motion rules, and any variant transpositions baked into `meta.json`.
...
### Web
![Mind's Expansion desktop capture](./screenshots/desktop.jpg)

### Mobile
![Mind's Expansion mobile capture](./screenshots/mobile.jpg)
