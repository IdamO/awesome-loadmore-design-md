# Design System Inspiration of Mind's Expansion

## 1. Visual Theme & Atmosphere

Mind's Expansion reads as type-led composition, spatial depth. The concept capture resolves to a dark-leaning system built around #131211, #e4e4e4, and accent notes from #2d4585. Mind's Expansion is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #131211, #e4e4e4, #2d4585, #ba4a4e
...
- Aura: Mind's Expansion should feel like a drifting internet relic whose full poster composition becomes a shallow-depth, glow-rail field.
...
- Color 1: #131211 - canvas / dominant background
- Color 2: #e4e4e4 - primary text or opposing surface
- Color 3: #2d4585 - accent / interactive signal
- Color 4: #ba4a4e - supporting surface or hover state
- Color 5: #d1a5a4 - supporting surface or hover state
- Color 6: #a56d8a - supporting surface or hover state
- Color 7: #e6e7e7 - supporting surface or hover state
- Color 8: #1d243d - supporting surface or hover state
...
- Let the main background color (#131211) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #2d4585 backgrounds with #ffffff text, and links inherit #2d4585 as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(45, 69, 133, 0.35)
...
- Keep the palette anchored to #131211, #e4e4e4, and #2d4585.
...
- Source: Arte Collective (https://arte-collective.com/collections/aesthetic/products/minds-expansion)
- Live site: https://arte-collective.com/collections/aesthetic/products/minds-expansion
