# f451.faith Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [f451.faith](https://f451.faith/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/f451-faith). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![f451.faith desktop capture](./screenshots/desktop.jpg)

### Mobile
![f451.faith mobile capture](./screenshots/mobile.jpg)
