...
- Core palette: #e8dbc8, #e6d8c6, #b07a69, #e6e6e6
...
- Aura: The Sun's Dying Soon - Orange should feel like a text artifact stretched into a calm browser field, where bars and phrases become the whole interaction surface.
...
- Color 1: #e8dbc8 - canvas / dominant background
- Color 2: #e6d8c6 - primary text or opposing surface
- Color 3: #b07a69 - accent / interactive signal
- Color 4: #e6e6e6 - supporting surface or hover state
- Color 5: #e3d6c4 - supporting surface or hover state
- Color 6: #e4e4e4 - supporting surface or hover state
- Color 7: #e6dbc8 - supporting surface or hover state
- Color 8: #e8e0d2 - supporting surface or hover state
...
- Let the main background color (#e8dbc8) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #b07a69 backgrounds with #ffffff text, and links inherit #b07a69 as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(176, 122, 105, 0.35)
...
- Keep the palette anchored to #e8dbc8, #e6d8c6, and #b07a69.
...
- Source: Arte Collective (https://arte-collective.com/collections/minimalism/products/the-suns-dying-soon-orange)
- Live site: https://arte-collective.com/collections/minimalism/products/the-suns-dying-soon-orange
