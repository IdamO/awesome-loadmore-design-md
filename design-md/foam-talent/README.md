# Foam Talent Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Foam Talent](https://talent.foam.org/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/foam-talent). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Foam Talent desktop capture](./screenshots/desktop.jpg)

### Mobile
![Foam Talent mobile capture](./screenshots/mobile.jpg)
