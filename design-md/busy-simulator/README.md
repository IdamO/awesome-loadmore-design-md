# Busy Simulator Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Busy Simulator](https://busysimulator.com/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/busy-simulator). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Busy Simulator desktop capture](./screenshots/desktop.jpg)

### Mobile
![Busy Simulator mobile capture](./screenshots/mobile.jpg)
