# Design System Inspiration of Steel Machine 001

## 1. Visual Theme & Atmosphere

Steel Machine 001 reads as retro-computing cues, type-led composition, spatial depth. The concept capture resolves to a light-leaning system built around #e6e5e5, #e5e3e2, and accent notes from #2a2621. Steel Machine 001 is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #e6e5e5, #e5e3e2, #2a2621, #7d7368
...
- Aura: Steel Machine 001 should feel like a sacred object from Technology, with the entire poster composition expanded into a shallow 3D archive room.
...
- Color 1: #e6e5e5 - canvas / dominant background
- Color 2: #e5e3e2 - primary text or opposing surface
- Color 3: #2a2621 - accent / interactive signal
- Color 4: #7d7368 - supporting surface or hover state
- Color 5: #eae8e7 - supporting surface or hover state
- Color 6: #d1b084 - supporting surface or hover state
- Color 7: #ddd7d4 - supporting surface or hover state
- Color 8: #e2e0e1 - supporting surface or hover state
...
- Let the main background color (#e6e5e5) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #d1b084 backgrounds with #111111 text, and links inherit #d1b084 as the interaction signal.
...
- Render tier: mixed
- Primary depth cue in capture: 0 24px 80px rgba(209, 176, 132, 0.35)
...
- Keep the palette anchored to #e6e5e5, #e5e3e2, and #2a2621.
...
- Source: Arte Collective (https://arte-collective.com/collections/technology/products/steel-machine-001)
- Live site: https://arte-collective.com/collections/technology/products/steel-machine-001
