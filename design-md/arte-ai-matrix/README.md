# AI Matrix Inspired Design System

[DESIGN.md](./DESIGN.md) derived from the Arte Collective poster [AI Matrix](https://arte-collective.com/collections/technology/products/ai-matrix). This entry intentionally ignores the storefront chrome and instead translates the poster artwork into an imagined interactive website system with web/mobile guidance, spatial mechanics, and motion rules.
...
### Web
![AI Matrix desktop capture](./screenshots/desktop.jpg)

### Mobile
![AI Matrix mobile capture](./screenshots/mobile.jpg)
