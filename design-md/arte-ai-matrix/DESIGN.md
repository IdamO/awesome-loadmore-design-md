# Design System Inspiration of AI Matrix

## 1. Visual Theme & Atmosphere

AI Matrix reads as playful interaction, sonic pacing, retro-computing cues. The concept capture resolves to a light-leaning system built around #e6e6e6, #2c3f31, and accent notes from #879a90. AI Matrix is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #e6e6e6, #2c3f31, #879a90, #6e8578
...
- Aura: AI Matrix should feel like a live control poster whose full composition becomes a responsive HUD field instead of flat merch storytelling.
...
- Color 2: #2c3f31 - primary text or opposing surface
- Color 3: #879a90 - accent / interactive signal
- Color 4: #6e8578 - supporting surface or hover state
- Color 5: #a2b0ac - supporting surface or hover state
- Color 6: #496251 - supporting surface or hover state
- Color 7: #1f2721 - supporting surface or hover state
- Color 8: #e1e2e2 - supporting surface or hover state
...
- Buttons tend toward #2c3f31 backgrounds with #ffffff text, and links inherit #2c3f31 as the interaction signal.
...
- Render tier: mixed
- Primary depth cue in capture: 0 24px 80px rgba(44, 63, 49, 0.35)
...
- Keep the palette anchored to #e6e6e6, #2c3f31, and #879a90.
...
- Source: Arte Collective (https://arte-collective.com/collections/technology/products/ai-matrix)
- Live site: https://arte-collective.com/collections/technology/products/ai-matrix
