# Cormio Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Cormio](https://cormio.com/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/cormio). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Cormio desktop capture](./screenshots/desktop.jpg)

### Mobile
![Cormio mobile capture](./screenshots/mobile.jpg)
