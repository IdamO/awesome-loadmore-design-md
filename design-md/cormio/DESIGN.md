...
### Web
- Buttons tend toward rgba(0, 0, 0, 0) backgrounds with rgb(61, 66, 70) text.
...
> Build a responsive landing page inspired by Cormio. Keep the palette centered on #faf8f8, #282521, and #696357. Use Work Sans for headlines, preserve the restrained minimalism, editorial fashion energy mood, and treat desktop and mobile as distinct compositions rather than a single squashed layout.
