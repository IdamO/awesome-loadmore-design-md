# Lucy Hard Castle Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Lucy Hard Castle](https://lucyhardcastle.com/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/lucy-hard-castle). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Lucy Hard Castle desktop capture](./screenshots/desktop.jpg)

### Mobile
![Lucy Hard Castle mobile capture](./screenshots/mobile.jpg)
