# Design System Inspiration of Code

## 1. Visual Theme & Atmosphere

Code reads as playful interaction, sonic pacing, retro-computing cues. The concept capture resolves to a dark-leaning system built around #292929, #e9be38, and accent notes from #e6e6e6. Code is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #292929, #e9be38, #e6e6e6, #e5ba38
...
- Aura: Code should feel like a live control poster whose full composition becomes a responsive HUD field instead of flat merch storytelling.
...
- Color 1: #292929 - canvas / dominant background
- Color 2: #e9be38 - primary text or opposing surface
- Color 3: #e6e6e6 - accent / interactive signal
- Color 4: #e5ba38 - supporting surface or hover state
- Color 5: #e3e2e2 - supporting surface or hover state
- Color 6: #2c2b2a - supporting surface or hover state
- Color 7: #87743a - supporting surface or hover state
- Color 8: #1f2023 - supporting surface or hover state
...
- Let the main background color (#292929) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #e9be38 backgrounds with #111111 text, and links inherit #e9be38 as the interaction signal.
...
- Render tier: mixed
- Primary depth cue in capture: 0 24px 80px rgba(233, 190, 56, 0.35)
...
- Keep the palette anchored to #292929, #e9be38, and #e6e6e6.
...
- Source: Arte Collective (https://arte-collective.com/collections/technology/products/code)
- Live site: https://arte-collective.com/collections/technology/products/code
