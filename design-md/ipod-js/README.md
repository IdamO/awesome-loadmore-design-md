# iPod.js Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [iPod.js](https://tannerv.com/ipod/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/ipod-js). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![iPod.js desktop capture](./screenshots/desktop.jpg)

### Mobile
![iPod.js mobile capture](./screenshots/mobile.jpg)
