# Design System Inspiration of iPod.js

## 1. Visual Theme & Atmosphere

iPod.js reads as sonic pacing. The live capture resolves to a light-leaning system built around #fbfbfb, #ababab, and accent notes from #727272. Feeling nostalgic?

Desktop and mobile stay aligned but not identical: the desktop capture emphasizes a looser scroll narrative, while mobile compresses the same language into tighter interaction zones. The site's type system centers a bespoke stack, which becomes the fastest way to reproduce the feel.

Key Characteristics:
- Primary tone: bright surfaces with editorial contrast
- Core palette: #fbfbfb, #ababab, #727272, #65abd5
...
- Color 4: #65abd5 - supporting surface or hover state
- Color 5: #359de0 - supporting surface or hover state
- Color 6: #07140b - supporting surface or hover state
- Color 7: #85afce - supporting surface or hover state
- Color 8: #1ca14b - supporting surface or hover state
...
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #727272 as the interaction signal.
...
- Keep the palette anchored to #fbfbfb, #ababab, and #727272.
...
> Build this as a Club Instrument page with a secondary cue from Fan Shrine using the Club Instrument interaction model. Keep the extracted primary font as the voice anchor, preserve the palette around #fbfbfb, #ababab, #727272, drive the page through tap, drag, press, and implement the mobile fallback as: Collapse to one active control strip, one focal stage, and tap-to-trigger presets instead of a dense multi-panel control surface.

## 15. Source Capture & Validation

- Source: loadmo.re (https://loadmo.re/posts/ipod-js)
- Live site: https://tannerv.com/ipod/
- Credits: Tanner Villarete, Ina
- Capture mode: live
