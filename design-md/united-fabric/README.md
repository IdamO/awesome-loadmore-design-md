# United Fabric Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [United Fabric](https://unitedfabric.org/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/united-fabric). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![United Fabric desktop capture](./screenshots/desktop.jpg)

### Mobile
![United Fabric mobile capture](./screenshots/mobile.jpg)
