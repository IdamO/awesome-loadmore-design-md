...
### World Systems
- Primary: Luxury Archive - tags include arts&culture; description mentions exhibition; archetype affinity: spatial exhibition world
- Secondary: Playable Poster - tags include tactile

### Interaction Archetype
- Archetype: Spatial Exhibition World (81% confidence)
- Why: tags include arts&culture; description mentions virtual; description mentions exhibition; sticky stage
...
- Preserve asymmetry when present - the archive tags (arts&culture, educational, tactile) imply the system is intentionally non-generic.
...
- Preserve the experimental posture signaled by the archive tags: arts&culture, educational, tactile.
