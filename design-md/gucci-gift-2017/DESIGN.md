...
- Links inherit #d7954e as the interaction signal.
...
- Preserve asymmetry when present - the archive tags (fashion, illustration) imply the site is intentionally non-generic.
...
- Preserve the experimental posture signaled by the loadmo.re tags: fashion, illustration.
...
> Build a responsive landing page inspired by Gucci Gift 2017. Keep the palette centered on #a0704b, #575152, and #d7954e. Use the extracted primary font for headlines, preserve the editorial fashion energy mood, and treat desktop and mobile as distinct compositions rather than a single squashed layout.
