# Kim Wermes Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Kim Wermes](https://kimdot.de/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/kim-wermes). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: portfolio, default-aesthetics
- Credits: Kim Wermes
...
### Web
![Kim Wermes desktop capture](./screenshots/desktop.jpg)

### Mobile
![Kim Wermes mobile capture](./screenshots/mobile.jpg)
