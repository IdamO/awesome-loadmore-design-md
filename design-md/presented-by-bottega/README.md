# Presented by Bottega Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Presented by Bottega](http://presentedbybottega.com) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/presented-by-bottega). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Presented by Bottega desktop capture](./screenshots/desktop.jpg)

### Mobile
![Presented by Bottega mobile capture](./screenshots/mobile.jpg)
