...
- Core palette: #a29e97, #121110, #0f0e0d, #e6e6e6
...
- Aura: Urban Space Army vol.2 should feel like a live control poster whose full composition becomes a responsive HUD field instead of flat merch storytelling.
...
- Color 1: #a29e97 - canvas / dominant background
- Color 2: #121110 - primary text or opposing surface
- Color 3: #0f0e0d - accent / interactive signal
- Color 4: #e6e6e6 - supporting surface or hover state
- Color 5: #191817 - supporting surface or hover state
- Color 6: #e4e4e4 - supporting surface or hover state
- Color 7: #0c0b0a - supporting surface or hover state
- Color 8: #7c7974 - supporting surface or hover state
...
- Let the main background color (#a29e97) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #0c0b0a backgrounds with #ffffff text, and links inherit #0c0b0a as the interaction signal.
...
- Render tier: mixed
- Primary depth cue in capture: 0 24px 80px rgba(12, 11, 10, 0.35)
...
- Keep the palette anchored to #a29e97, #121110, and #0f0e0d.
...
- Source: Arte Collective (https://arte-collective.com/collections/technology/products/urban-space-army-vol-2)
- Live site: https://arte-collective.com/collections/technology/products/urban-space-army-vol-2
