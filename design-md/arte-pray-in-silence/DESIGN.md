# Design System Inspiration of Eclipse

## 1. Visual Theme & Atmosphere

Eclipse reads as type-led composition, spatial depth. The concept capture resolves to a light-leaning system built around #e6e6e6, #252323, and accent notes from #1e1d1d. Eclipse is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #e6e6e6, #252323, #1e1d1d, #21201f
...
- Aura: Eclipse should feel like a drifting internet relic whose full poster composition becomes a shallow-depth, glow-rail field.
...
- Color 2: #252323 - primary text or opposing surface
- Color 3: #1e1d1d - accent / interactive signal
- Color 4: #21201f - supporting surface or hover state
- Color 5: #1f1e1d - supporting surface or hover state
- Color 6: #1b1a1a - supporting surface or hover state
- Color 7: #555556 - supporting surface or hover state
- Color 8: #e1e1e1 - supporting surface or hover state
...
- Buttons tend toward #1f1e1d backgrounds with #ffffff text, and links inherit #1f1e1d as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(31, 30, 29, 0.35)
...
- Keep the palette anchored to #e6e6e6, #252323, and #1e1d1d.
...
- Source: Arte Collective (https://arte-collective.com/collections/aesthetic/products/pray-in-silence)
- Live site: https://arte-collective.com/collections/aesthetic/products/pray-in-silence
