# Eclipse Inspired Design System

[DESIGN.md](./DESIGN.md) derived from the Arte Collective poster [Eclipse](https://arte-collective.com/collections/aesthetic/products/pray-in-silence). This entry intentionally ignores the storefront chrome and instead translates the poster artwork into an imagined interactive website system with web/mobile guidance, spatial mechanics, and motion rules.
...
### Web
![Eclipse desktop capture](./screenshots/desktop.jpg)

### Mobile
![Eclipse mobile capture](./screenshots/mobile.jpg)
