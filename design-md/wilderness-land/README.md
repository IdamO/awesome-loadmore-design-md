# Wilderness Land Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Wilderness Land](https://wilderness.land/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/wilderness-land). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- World systems: Collage Core, Cozy Desktop
...
- Tags: net.art, digital-exhibition, default-aesthetics
...
### Web
![Wilderness Land desktop capture](./screenshots/desktop.jpg)

### Mobile
![Wilderness Land mobile capture](./screenshots/mobile.jpg)
