...
### World Systems
- Primary: Collage Core - tags include net.art; description mentions internet; archetype affinity: collage field
- Secondary: Cozy Desktop - tags include default-aesthetics

### Interaction Archetype
- Archetype: Collage Field (78% confidence)
- Why: tags include net.art; description mentions internet
...
- Preserve asymmetry when present - the archive tags (net.art, digital-exhibition, default-aesthetics) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #e5ebe8 as the interaction signal.
...
- Preserve the experimental posture signaled by the archive tags: net.art, digital-exhibition, default-aesthetics.
...
> Build this as a Collage Core page with a secondary cue from Cozy Desktop using the Collage Field interaction model. Keep the extracted primary font as the voice anchor, preserve the palette around #6c9de9, #b2d4a6, #e5ebe8, drive the page through scroll, hover, tap, and implement the mobile fallback as: Flatten the field into a guided scavenger feed or chapter stack while preserving overlap, stickers, and hyperlink energy.
