# ZOO Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [ZOO](https://zooaszoo.com) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/zoo). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: 3d-space, colorful, digital-exhibition
- Credits: Pentagram
...
### Web
![ZOO desktop capture](./screenshots/desktop.jpg)

### Mobile
![ZOO mobile capture](./screenshots/mobile.jpg)
