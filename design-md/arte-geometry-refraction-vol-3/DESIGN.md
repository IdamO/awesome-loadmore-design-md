# Design System Inspiration of Geometry refraction vol.3

## 1. Visual Theme & Atmosphere

Geometry refraction vol.3 reads as type-led composition, spatial depth. The concept capture resolves to a light-leaning system built around #e4e4e4, #211c1b, and accent notes from #151413. Geometry refraction vol.3 is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #e4e4e4, #211c1b, #151413, #1a1818
...
- Aura: Geometry refraction vol.3 should feel like a sacred object from Aesthetic, with the entire poster composition expanded into a shallow 3D archive room.
...
- Color 2: #211c1b - primary text or opposing surface
- Color 3: #151413 - accent / interactive signal
- Color 4: #1a1818 - supporting surface or hover state
- Color 5: #100f0e - supporting surface or hover state
- Color 6: #3d2e2b - supporting surface or hover state
- Color 7: #999087 - supporting surface or hover state
- Color 8: #e8e8e7 - supporting surface or hover state
...
- Buttons tend toward #3d2e2b backgrounds with #ffffff text, and links inherit #3d2e2b as the interaction signal.
...
- Render tier: mixed
- Primary depth cue in capture: 0 24px 80px rgba(61, 46, 43, 0.35)
...
- Keep the palette anchored to #e4e4e4, #211c1b, and #151413.
...
- Source: Arte Collective (https://arte-collective.com/collections/aesthetic/products/geometry-refraction-vol-3)
- Live site: https://arte-collective.com/collections/aesthetic/products/geometry-refraction-vol-3
