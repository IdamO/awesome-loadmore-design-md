...
- Archetype: Collage Field (95% confidence)
...
- Preserve asymmetry when present - the archive tags (glitches, net.art, arts&culture) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit rgb(66, 139, 202) as the interaction signal.
...
- Preserve the experimental posture signaled by the archive tags: glitches, net.art, arts&culture.
