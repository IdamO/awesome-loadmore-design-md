...
- HUD layering: none
- Render tier: dom
- Primary depth cue in capture: rgba(0, 0, 0, 0.2) 0px -6px 12px 2px inset, rgba(255, 255, 255, 0.3) 0px 20px 6px 0px inset
