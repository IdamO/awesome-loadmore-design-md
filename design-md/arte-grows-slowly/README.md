# Grows Slowly Inspired Design System

[DESIGN.md](./DESIGN.md) derived from the Arte Collective poster [Grows Slowly](https://arte-collective.com/collections/minimalism/products/grows-slowly). This entry intentionally ignores the storefront chrome and instead translates the poster artwork into an imagined interactive website system with web/mobile guidance, spatial mechanics, and motion rules.
...
### Web
![Grows Slowly desktop capture](./screenshots/desktop.jpg)

### Mobile
![Grows Slowly mobile capture](./screenshots/mobile.jpg)
