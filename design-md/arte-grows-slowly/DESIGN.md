...
- Core palette: #e6e6e6, #0d4223, #114223, #194324
...
- Aura: Grows Slowly should feel like a text artifact stretched into a calm browser field, where bars and phrases become the whole interaction surface.
...
- Color 2: #0d4223 - primary text or opposing surface
- Color 3: #114223 - accent / interactive signal
- Color 4: #194324 - supporting surface or hover state
- Color 5: #154526 - supporting surface or hover state
- Color 6: #e7e2dc - supporting surface or hover state
- Color 7: #8f9c7c - supporting surface or hover state
- Color 8: #11331e - supporting surface or hover state
...
- Buttons tend toward #0d4223 backgrounds with #ffffff text, and links inherit #0d4223 as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(13, 66, 35, 0.35)
...
- Keep the palette anchored to #e6e6e6, #0d4223, and #114223.
...
- Source: Arte Collective (https://arte-collective.com/collections/minimalism/products/grows-slowly)
- Live site: https://arte-collective.com/collections/minimalism/products/grows-slowly
