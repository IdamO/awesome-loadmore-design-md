# Relic Inspired Design System

[DESIGN.md](./DESIGN.md) derived from the Arte Collective poster [Relic](https://arte-collective.com/collections/aesthetic/products/relic). This entry intentionally ignores the storefront chrome and instead translates the poster artwork into an imagined interactive website system with web/mobile guidance, spatial mechanics, and motion rules.
...
### Web
![Relic desktop capture](./screenshots/desktop.jpg)

### Mobile
![Relic mobile capture](./screenshots/mobile.jpg)
