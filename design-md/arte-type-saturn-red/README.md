# Type Saturn - Red Inspired Design System

[DESIGN.md](./DESIGN.md) derived from the Arte Collective poster [Type Saturn - Red](https://arte-collective.com/collections/aesthetic/products/type-saturn-red). This entry intentionally ignores the storefront chrome and instead translates the poster artwork into an imagined interactive website system with web/mobile guidance, spatial mechanics, and motion rules.
...
### Web
![Type Saturn - Red desktop capture](./screenshots/desktop.jpg)

### Mobile
![Type Saturn - Red mobile capture](./screenshots/mobile.jpg)
