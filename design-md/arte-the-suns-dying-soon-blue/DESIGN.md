...
- Core palette: #e4e4e4, #e9dcc8, #e6d9c6, #e3d6c5
...
- Aura: The Sun's Dying Soon - Blue should feel like a text artifact stretched into a calm browser field, where bars and phrases become the whole interaction surface.
...
- Color 2: #e9dcc8 - primary text or opposing surface
- Color 3: #e6d9c6 - accent / interactive signal
- Color 4: #e3d6c5 - supporting surface or hover state
- Color 5: #e7dac8 - supporting surface or hover state
- Color 6: #3d5484 - supporting surface or hover state
- Color 7: #a3aec8 - supporting surface or hover state
- Color 8: #e7e4df - supporting surface or hover state
...
- Buttons tend toward #3d5484 backgrounds with #ffffff text, and links inherit #3d5484 as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(61, 84, 132, 0.35)
...
- Keep the palette anchored to #e4e4e4, #e9dcc8, and #e6d9c6.
...
- Source: Arte Collective (https://arte-collective.com/collections/minimalism/products/the-suns-dying-soon-blue)
- Live site: https://arte-collective.com/collections/minimalism/products/the-suns-dying-soon-blue
