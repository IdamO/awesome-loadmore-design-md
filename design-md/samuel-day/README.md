# Samuel Day Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Samuel Day](https://www.samuelday.de/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/samuel-day). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Samuel Day desktop capture](./screenshots/desktop.jpg)

### Mobile
![Samuel Day mobile capture](./screenshots/mobile.jpg)
