...
### World Systems
- Primary: Collage Core - tags include playful; description mentions internet; archetype affinity: toy loop microgame
...
- Why: tags include game; tags include playful; description mentions click
...
- Preserve asymmetry when present - the archive tags (game, playful) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #1669a6 as the interaction signal.
...
- Preserve the experimental posture signaled by the archive tags: game, playful.
