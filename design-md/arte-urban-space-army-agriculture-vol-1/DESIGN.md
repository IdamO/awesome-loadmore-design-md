# Design System Inspiration of Urban Space Army - Agriculture vol.1

## 1. Visual Theme & Atmosphere

Urban Space Army - Agriculture vol.1 reads as playful interaction, sonic pacing, retro-computing cues. The concept capture resolves to a dark-leaning system built around #20301d, #e6e6e6, and accent notes from #009a4a. Urban Space Army - Agriculture vol.1 is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #20301d, #e6e6e6, #009a4a, #e2e2e2
...
- Aura: Urban Space Army - Agriculture vol.1 should feel like a live control poster whose full composition becomes a responsive HUD field instead of flat merch storytelling.
...
- Color 1: #20301d - canvas / dominant background
- Color 2: #e6e6e6 - primary text or opposing surface
- Color 3: #009a4a - accent / interactive signal
- Color 4: #e2e2e2 - supporting surface or hover state
- Color 5: #243722 - supporting surface or hover state
- Color 6: #009d4d - supporting surface or hover state
- Color 7: #1c281a - supporting surface or hover state
- Color 8: #41845e - supporting surface or hover state
...
- Let the main background color (#20301d) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #009a4a backgrounds with #ffffff text, and links inherit #009a4a as the interaction signal.
...
- Render tier: mixed
- Primary depth cue in capture: 0 24px 80px rgba(0, 154, 74, 0.35)
...
- Keep the palette anchored to #20301d, #e6e6e6, and #009a4a.
...
- Source: Arte Collective (https://arte-collective.com/collections/technology/products/urban-space-army-agriculture-vol-1)
- Live site: https://arte-collective.com/collections/technology/products/urban-space-army-agriculture-vol-1
