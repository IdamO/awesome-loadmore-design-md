# Design System Inspiration of Lost - Orange

## 1. Visual Theme & Atmosphere

Lost - Orange reads as type-led composition, spatial depth. The concept capture resolves to a dark-leaning system built around #e86c25, #35231e, and accent notes from #e6e6e6. Lost - Orange is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #e86c25, #35231e, #e6e6e6, #e86c23
...
- Aura: Lost - Orange should feel like a drifting internet relic whose full poster composition becomes a shallow-depth, glow-rail field.
...
- Color 1: #e86c25 - canvas / dominant background
- Color 2: #35231e - primary text or opposing surface
- Color 3: #e6e6e6 - accent / interactive signal
- Color 4: #e86c23 - supporting surface or hover state
- Color 5: #e4e4e4 - supporting surface or hover state
- Color 6: #d85d1f - supporting surface or hover state
- Color 7: #e47b3f - supporting surface or hover state
- Color 8: #e26c28 - supporting surface or hover state
...
- Let the main background color (#e86c25) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #d85d1f backgrounds with #ffffff text, and links inherit #d85d1f as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(216, 93, 31, 0.35)
...
- Keep the palette anchored to #e86c25, #35231e, and #e6e6e6.
...
- Source: Arte Collective (https://arte-collective.com/collections/aesthetic/products/lost-orange)
- Live site: https://arte-collective.com/collections/aesthetic/products/lost-orange
