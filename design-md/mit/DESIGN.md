...
- Preserve asymmetry when present - the archive tags (3d-space, educational) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #a7a7a7 as the interaction signal.
...
- Preserve the experimental posture signaled by the archive tags: 3d-space, educational.
