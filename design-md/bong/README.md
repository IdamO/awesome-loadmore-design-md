# Bong Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Bong](http://bong.international) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/bong). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: playful, portfolio, tactile
...
### Web
![Bong desktop capture](./screenshots/desktop.jpg)

### Mobile
![Bong mobile capture](./screenshots/mobile.jpg)
