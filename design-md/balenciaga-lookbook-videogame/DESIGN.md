...
- Preserve asymmetry when present - the archive tags (fashion, 3d) imply the system is intentionally non-generic.
...
- Preserve the experimental posture signaled by the archive tags: fashion, 3d.
