...
- Secondary: Playable Poster - tags include tactile; large display type
...
- Preserve asymmetry when present - the archive tags (3d-space, tactile) imply the system is intentionally non-generic.
...
- Preserve the experimental posture signaled by the archive tags: 3d-space, tactile.
