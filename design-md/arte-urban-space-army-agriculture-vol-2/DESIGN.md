# Design System Inspiration of Urban Space Army - Agriculture vol.2

## 1. Visual Theme & Atmosphere

Urban Space Army - Agriculture vol.2 reads as playful interaction, sonic pacing, retro-computing cues. The concept capture resolves to a light-leaning system built around #ddd9cc, #e1ddd1, and accent notes from #e6e6e6. Urban Space Army - Agriculture vol.2 is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #ddd9cc, #e1ddd1, #e6e6e6, #dedace
...
- Aura: Urban Space Army - Agriculture vol.2 should feel like a live control poster whose full composition becomes a responsive HUD field instead of flat merch storytelling.
...
- Color 1: #ddd9cc - canvas / dominant background
- Color 2: #e1ddd1 - primary text or opposing surface
- Color 3: #e6e6e6 - accent / interactive signal
- Color 4: #dedace - supporting surface or hover state
- Color 5: #868471 - supporting surface or hover state
- Color 6: #dad7cb - supporting surface or hover state
- Color 7: #e4e4e4 - supporting surface or hover state
- Color 8: #e4e0d5 - supporting surface or hover state
...
- Let the main background color (#ddd9cc) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #868471 backgrounds with #ffffff text, and links inherit #868471 as the interaction signal.
...
- Render tier: mixed
- Primary depth cue in capture: 0 24px 80px rgba(134, 132, 113, 0.35)
...
- Keep the palette anchored to #ddd9cc, #e1ddd1, and #e6e6e6.
...
- Source: Arte Collective (https://arte-collective.com/collections/technology/products/urban-space-army-agriculture-vol-2)
- Live site: https://arte-collective.com/collections/technology/products/urban-space-army-agriculture-vol-2
