...
- Why: tags include game; tags include playful; description mentions challenge; description mentions interact
...
- Preserve asymmetry when present - the archive tags (playful, game, tactile) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #d4d4d5 as the interaction signal.
...
- Nice-to-have embellishments:
  ...
  - description mentions challenge
...
- Preserve the experimental posture signaled by the archive tags: playful, game, tactile.
