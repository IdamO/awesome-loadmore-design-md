# Streaming Consciousness Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Streaming Consciousness](http://streaming-consciousness.live/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/streaming-consciousness). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: participative, digital-exhibition, colorful
...
### Web
![Streaming Consciousness desktop capture](./screenshots/desktop.jpg)

### Mobile
![Streaming Consciousness mobile capture](./screenshots/mobile.jpg)
