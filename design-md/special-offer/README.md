# Special Offer Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Special Offer](https://www.special-offer.studio/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/special-offer). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: portfolio, colorful, graphic-design
- Credits: not listed
...
### Web
![Special Offer desktop capture](./screenshots/desktop.jpg)

### Mobile
![Special Offer mobile capture](./screenshots/mobile.jpg)
