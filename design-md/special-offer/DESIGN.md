...
- Links inherit rgb(255, 0, 255) as the interaction signal.
- Border radius trends: 0px.
- Shadow language: minimal / none detected.

### Mobile
- Mobile preserves the same palette while reducing surface area and increasing gesture weight.
- Recreate the mobile feel with oversized tap targets, single-column pacing, and typography that keeps Helvetica Neue LT Std in control.
...
- Preserve asymmetry when present - the archive tags (portfolio, colorful, graphic-design) imply the site is intentionally non-generic.
...
- Preserve the experimental posture signaled by the loadmo.re tags: portfolio, colorful, graphic-design.
...
> Build a responsive landing page inspired by Special Offer. Keep the palette centered on #de0001, #261e19, and #51302b. Use Helvetica Neue LT Std for headlines, preserve the experimental mobile-first composition mood, and treat desktop and mobile as distinct compositions rather than a single squashed layout.
