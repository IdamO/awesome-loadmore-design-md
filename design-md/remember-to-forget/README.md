# Remember to Forget Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Remember to Forget](http://www.remembertoforget.me/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/remember-to-forget). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Remember to Forget desktop capture](./screenshots/desktop.jpg)

### Mobile
![Remember to Forget mobile capture](./screenshots/mobile.jpg)
