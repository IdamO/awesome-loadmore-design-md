# Elle's Homepage Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Elle's Homepage](https://ellesho.me/page) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/elle-s-homepage). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Elle's Homepage desktop capture](./screenshots/desktop.jpg)

### Mobile
![Elle's Homepage mobile capture](./screenshots/mobile.jpg)
