# Fix one bug - Orange Inspired Design System

[DESIGN.md](./DESIGN.md) derived from the Arte Collective poster [Fix one bug - Orange](https://arte-collective.com/collections/technology/products/fix-one-bug-orange). This entry intentionally ignores the storefront chrome and instead translates the poster artwork into an imagined interactive website system with web/mobile guidance, spatial mechanics, and motion rules.
...
### Web
![Fix one bug - Orange desktop capture](./screenshots/desktop.jpg)

### Mobile
![Fix one bug - Orange mobile capture](./screenshots/mobile.jpg)
