...
- Preserve asymmetry when present - the archive tags (portfolio, typography, retro) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit rgb(167, 175, 182) as the interaction signal.
...
- Preserve the experimental posture signaled by the archive tags: portfolio, typography, retro.
