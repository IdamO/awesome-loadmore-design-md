# Geometry refraction vol.2 Inspired Design System

[DESIGN.md](./DESIGN.md) derived from the Arte Collective poster [Geometry refraction vol.2](https://arte-collective.com/collections/aesthetic/products/geometry-refraction-vol-2). This entry intentionally ignores the storefront chrome and instead translates the poster artwork into an imagined interactive website system with web/mobile guidance, spatial mechanics, and motion rules.
...
### Web
![Geometry refraction vol.2 desktop capture](./screenshots/desktop.jpg)

### Mobile
![Geometry refraction vol.2 mobile capture](./screenshots/mobile.jpg)
