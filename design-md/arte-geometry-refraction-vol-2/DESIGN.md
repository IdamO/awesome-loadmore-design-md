# Design System Inspiration of Geometry refraction vol.2

## 1. Visual Theme & Atmosphere

Geometry refraction vol.2 reads as type-led composition, spatial depth. The concept capture resolves to a light-leaning system built around #e4e4e4, #1d1b1a, and accent notes from #11100f. Geometry refraction vol.2 is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #e4e4e4, #1d1b1a, #11100f, #141414
...
- Aura: Geometry refraction vol.2 should feel like a sacred object from Aesthetic, with the entire poster composition expanded into a shallow 3D archive room.
...
- Color 2: #1d1b1a - primary text or opposing surface
- Color 3: #11100f - accent / interactive signal
- Color 4: #141414 - supporting surface or hover state
- Color 5: #191818 - supporting surface or hover state
- Color 6: #2a2c31 - supporting surface or hover state
- Color 7: #e8e8e8 - supporting surface or hover state
- Color 8: #7c868a - supporting surface or hover state
...
- Buttons tend toward #2a2c31 backgrounds with #ffffff text, and links inherit #2a2c31 as the interaction signal.
...
- Render tier: mixed
- Primary depth cue in capture: 0 24px 80px rgba(42, 44, 49, 0.35)
...
- Keep the palette anchored to #e4e4e4, #1d1b1a, and #11100f.
...
- Source: Arte Collective (https://arte-collective.com/collections/aesthetic/products/geometry-refraction-vol-2)
- Live site: https://arte-collective.com/collections/aesthetic/products/geometry-refraction-vol-2
