# Emoji To Scale Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Emoji To Scale](https://javier.xyz/emoji-to-scale/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/emoji-to-scale). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Emoji To Scale desktop capture](./screenshots/desktop.jpg)

### Mobile
![Emoji To Scale mobile capture](./screenshots/mobile.jpg)
