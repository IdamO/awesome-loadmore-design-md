...
- Preserve asymmetry when present - the archive tags (glitches, colorful, retro) imply the system is intentionally non-generic.
...
- Preserve the experimental posture signaled by the archive tags: glitches, colorful, retro.
