...
### World Systems
- Primary: Fan Shrine - tags include fashion; tags include portfolio; archetype affinity: portfolio artifact
- Secondary: Luxury Archive - tags include fashion; archetype affinity: portfolio artifact

### Interaction Archetype
- Archetype: Portfolio Artifact (85% confidence)
- Why: tags include portfolio; tags include fashion
...
- Preserve asymmetry when present - the archive tags (portfolio, fashion) imply the system is intentionally non-generic.
- Buttons tend toward rgba(0, 0, 0, 0) backgrounds with rgb(30, 30, 28) text, and links inherit rgb(255, 255, 255) as the interaction signal.
...
- Preserve the experimental posture signaled by the archive tags: portfolio, fashion.
