...
[DESIGN.md](./DESIGN.md) extracted from the public [Virgil Abloh™](https://www.canary---yellow.com) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/virgil-abloh). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Virgil Abloh™ desktop capture](./screenshots/desktop.jpg)

### Mobile
![Virgil Abloh™ mobile capture](./screenshots/mobile.jpg)
