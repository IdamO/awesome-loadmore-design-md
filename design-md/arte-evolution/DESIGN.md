# Design System Inspiration of Evolution

## 1. Visual Theme & Atmosphere

Evolution reads as type-led composition, spatial depth. The concept capture resolves to a dark-leaning system built around #2b2f43, #2e344d, and accent notes from #e6e6e6. Evolution is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #2b2f43, #2e344d, #e6e6e6, #e2e2e2
...
- Aura: Evolution should feel like a sacred object from Aesthetic, with the entire poster composition expanded into a shallow 3D archive room.
...
- Color 1: #2b2f43 - canvas / dominant background
- Color 2: #2e344d - primary text or opposing surface
- Color 3: #e6e6e6 - accent / interactive signal
- Color 4: #e2e2e2 - supporting surface or hover state
- Color 5: #444f7e - supporting surface or hover state
- Color 6: #313b5e - supporting surface or hover state
- Color 7: #9294bb - supporting surface or hover state
- Color 8: #21232c - supporting surface or hover state
...
- Let the main background color (#2b2f43) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #313b5e backgrounds with #ffffff text, and links inherit #313b5e as the interaction signal.
...
- Render tier: mixed
- Primary depth cue in capture: 0 24px 80px rgba(49, 59, 94, 0.35)
...
- Keep the palette anchored to #2b2f43, #2e344d, and #e6e6e6.
...
- Source: Arte Collective (https://arte-collective.com/collections/aesthetic/products/evolution)
- Live site: https://arte-collective.com/collections/aesthetic/products/evolution
