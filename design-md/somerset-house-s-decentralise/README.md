# Somerset House’s Decentralise Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Somerset House’s Decentralise](https://www.somersethouse.org.uk/blog/decentralise) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/somerset-house-s-decentralise). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: tactile, illustration, sound-design
...
### Web
![Somerset House’s Decentralise desktop capture](./screenshots/desktop.jpg)

### Mobile
![Somerset House’s Decentralise mobile capture](./screenshots/mobile.jpg)
