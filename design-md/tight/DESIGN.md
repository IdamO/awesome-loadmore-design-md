# Design System Inspiration of Tight

## 1. Visual Theme & Atmosphere

Tight reads as playful interaction. The live capture resolves to a light-leaning system built around #99e0da, #9bf4ae, and accent notes from #fafafa. Immerse yourself in a OS system that becomes a tidy way of displaying a portfolio of work.

Desktop and mobile stay aligned but not identical: the desktop capture emphasizes a looser scroll narrative, while mobile compresses the same language into tighter interaction zones. The site's type system centers a bespoke stack, which becomes the fastest way to reproduce the feel.

Key Characteristics:
- Primary tone: bright surfaces with editorial contrast
- Core palette: #99e0da, #9bf4ae, #fafafa, #72ad98
...
### World Systems
- Primary: Cozy Desktop - tags include default-aesthetics; tags include portfolio; tags include playful
- Secondary: Collage Core - tags include playful

### Interaction Archetype
- Archetype: Portfolio Artifact (96% confidence)
- Why: tags include portfolio; tags include playful; description mentions portfolio
...
- Color 1: #99e0da - canvas / dominant background
- Color 2: #9bf4ae - primary text or opposing surface
- Color 3: #fafafa - accent / interactive signal
- Color 4: #72ad98 - supporting surface or hover state
- Color 5: #5a8b75 - supporting surface or hover state
- Color 6: #a1b2ab - supporting surface or hover state
- Color 7: #7cc19a - supporting surface or hover state
- Color 8: #6ccbf7 - supporting surface or hover state
...
- Let the main background color (#99e0da) carry the atmosphere instead of layering multiple competing surfaces.
- Preserve asymmetry when present - the archive tags (portfolio, playful, default-aesthetics) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #fafafa as the interaction signal.
...
- Keep the palette anchored to #99e0da, #9bf4ae, and #fafafa.
- Preserve the experimental posture signaled by the archive tags: portfolio, playful, default-aesthetics.
...
> Build this as a Cozy Desktop page with a secondary cue from Collage Core using the Portfolio Artifact interaction model. Keep the extracted primary font as the voice anchor, preserve the palette around #99e0da, #9bf4ae, #fafafa, drive the page through scroll, tap, and implement the mobile fallback as: Keep the asymmetry in rhythm and type, but simplify the layout into a single authored column with strong anchors.

## 15. Source Capture & Validation

- Source: loadmo.re (https://loadmo.re/posts/tight)
- Live site: http://tig.ht
- Credits: not listed
- Capture mode: live
