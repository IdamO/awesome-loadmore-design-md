# Tight Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Tight](http://tig.ht) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/tight). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: portfolio, playful, default-aesthetics
- Credits: not listed
...
### Web
![Tight desktop capture](./screenshots/desktop.jpg)

### Mobile
![Tight mobile capture](./screenshots/mobile.jpg)
