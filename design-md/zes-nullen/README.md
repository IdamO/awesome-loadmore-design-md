# Zes Nullen Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Zes Nullen](https://zesnullen.world/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/zes-nullen). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: e-commerce, animation, photography
...
### Web
![Zes Nullen desktop capture](./screenshots/desktop.jpg)

### Mobile
![Zes Nullen mobile capture](./screenshots/mobile.jpg)
