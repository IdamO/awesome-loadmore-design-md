...
### World Systems
- Primary: Luxury Archive - tags include arts&culture; tags include photography; archetype affinity: editorial archive index
- Secondary: Fan Shrine - tags include photography; tags include portfolio

### Interaction Archetype
- Archetype: Editorial Archive Index (66% confidence)
- Why: tags include arts&culture; tags include photography; sticky layout
...
- Preserve asymmetry when present - the archive tags (photography, portfolio, arts&culture) imply the system is intentionally non-generic.
- Buttons tend toward rgb(169, 169, 169) backgrounds with rgb(0, 0, 0) text, and links inherit rgb(0, 0, 0) as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: rgba(255, 255, 255, 0.75) 0px 0px 8px 0px inset
...
- Preserve the experimental posture signaled by the archive tags: photography, portfolio, arts&culture.
