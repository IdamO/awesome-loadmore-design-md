...
### World Systems
- Primary: Luxury Archive - tags include arts&culture; description mentions objects; description mentions museum
- Secondary: Collage Core - tags include playful

### Interaction Archetype
- Archetype: Editorial Archive Index (96% confidence)
- Why: tags include arts&culture; tags include educational; description mentions browse; description mentions search
...
- Preserve asymmetry when present - the archive tags (arts&culture, playful, educational) imply the system is intentionally non-generic.
...
- Render tier: dom
- Primary depth cue in capture: rgba(0, 0, 0, 0.05) 0px 4px 10px 0px
...
- Preserve the experimental posture signaled by the archive tags: arts&culture, playful, educational.
