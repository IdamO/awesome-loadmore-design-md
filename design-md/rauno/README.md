# Rauno Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Rauno](https://rauno.me/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/rauno). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: clean-ui, tactile, portfolio
- Credits: not listed
...
### Web
![Rauno desktop capture](./screenshots/desktop.jpg)

### Mobile
![Rauno mobile capture](./screenshots/mobile.jpg)
