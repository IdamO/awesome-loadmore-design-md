# Sabrina Zeltner Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Sabrina Zeltner](https://sabrinazeltner.com/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/sabrina-zeltner). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Sabrina Zeltner desktop capture](./screenshots/desktop.jpg)

### Mobile
![Sabrina Zeltner mobile capture](./screenshots/mobile.jpg)
