# Design System Inspiration of Neural Spectrum

## 1. Visual Theme & Atmosphere

Neural Spectrum reads as playful interaction, sonic pacing, type-led composition. The concept capture resolves to a dark-leaning system built around #1c1e23, #222128, and accent notes from #e6e6e6. Neural Spectrum is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #1c1e23, #222128, #e6e6e6, #e2e3e3
...
- Aura: Neural Spectrum should feel like a live control poster whose full composition becomes a responsive HUD field instead of flat merch storytelling.
...
- Color 1: #1c1e23 - canvas / dominant background
- Color 2: #222128 - primary text or opposing surface
- Color 3: #e6e6e6 - accent / interactive signal
- Color 4: #e2e3e3 - supporting surface or hover state
- Color 5: #737683 - supporting surface or hover state
- Color 6: #3e2d5c - supporting surface or hover state
- Color 7: #16171c - supporting surface or hover state
- Color 8: #191c27 - supporting surface or hover state
...
- Let the main background color (#1c1e23) carry the atmosphere instead of layering multiple competing surfaces.
- Preserve asymmetry when present - the archive tags (poster-derived, 3d-space, typography, animation, graphic-design, colorful, playful, sound-design, arte-aesthetic) imply the system is intentionally non-generic.
- Buttons tend toward #3e2d5c backgrounds with #ffffff text, and links inherit #3e2d5c as the interaction signal.
...
- Render tier: mixed
- Primary depth cue in capture: 0 24px 80px rgba(62, 45, 92, 0.35)
...
- Keep the palette anchored to #1c1e23, #222128, and #e6e6e6.
- Preserve the experimental posture signaled by the archive tags: poster-derived, 3d-space, typography, animation, graphic-design, colorful, playful, sound-design, arte-aesthetic.
...
- Source: Arte Collective (https://arte-collective.com/collections/aesthetic/products/neural-spectrum)
- Live site: https://arte-collective.com/collections/aesthetic/products/neural-spectrum
