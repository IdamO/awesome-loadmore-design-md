...
- Core palette: #8b6cb8, #e5e5e5, #4d3e5e, #8c6cb9
...
- Aura: Minimal Space - Purple Space should feel like a drifting internet relic whose full poster composition becomes a shallow-depth, glow-rail field.
...
- Color 1: #8b6cb8 - canvas / dominant background
- Color 2: #e5e5e5 - primary text or opposing surface
- Color 3: #4d3e5e - accent / interactive signal
- Color 4: #8c6cb9 - supporting surface or hover state
- Color 5: #8a6cb7 - supporting surface or hover state
- Color 6: #8b6cb9 - supporting surface or hover state
- Color 7: #9f8abf - supporting surface or hover state
- Color 8: #8b6cb7 - supporting surface or hover state
...
- Let the main background color (#8b6cb8) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #8b6cb9 backgrounds with #ffffff text, and links inherit #8b6cb9 as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(139, 108, 185, 0.35)
...
- Keep the palette anchored to #8b6cb8, #e5e5e5, and #4d3e5e.
...
- Source: Arte Collective (https://arte-collective.com/collections/minimalism/products/minimal-space-purple-space)
- Live site: https://arte-collective.com/collections/minimalism/products/minimal-space-purple-space
