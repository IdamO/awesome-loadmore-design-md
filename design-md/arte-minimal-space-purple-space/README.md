# Minimal Space - Purple Space Inspired Design System

[DESIGN.md](./DESIGN.md) derived from the Arte Collective poster [Minimal Space - Purple Space](https://arte-collective.com/collections/minimalism/products/minimal-space-purple-space). This entry intentionally ignores the storefront chrome and instead translates the poster artwork into an imagined interactive website system with web/mobile guidance, spatial mechanics, and motion rules.
...
### Web
![Minimal Space - Purple Space desktop capture](./screenshots/desktop.jpg)

### Mobile
![Minimal Space - Purple Space mobile capture](./screenshots/mobile.jpg)
