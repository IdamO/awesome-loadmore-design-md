...
### World Systems
- Primary: Playable Poster - tags include tactile; archetype affinity: playable poster
- Secondary: Collage Core - tags include tactile; archetype affinity: playable poster

### Interaction Archetype
- Archetype: Playable Poster (60% confidence)
- Why: tags include tactile; description mentions interactive; sticky layout
...
- Preserve asymmetry when present - the archive tags (tactile, portfolio) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit rgb(34, 139, 131) as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: rgb(0, 0, 0) 0px 0px 0px 1px, rgb(255, 255, 255) 0px 0px 0px 3px, rgb(0, 0, 0) 0px 0px 0px 4px
...
- Preserve the experimental posture signaled by the archive tags: tactile, portfolio.
...
> Build this as a Playable Poster page with a secondary cue from Collage Core using the Playable Poster interaction model. Keep Alegreya as the voice anchor, preserve the palette around #5b4a34, #342f25, #6b644e, drive the page through scroll, tap, hover, and implement the mobile fallback as: Split the poster into two to four scenes, preserve one hero interaction, and drop hover-only secondary behavior.
