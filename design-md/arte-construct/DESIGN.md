...
- Core palette: #e4e4e4, #1a1d1d, #181716, #647074
...
- Aura: Construct should feel like a sacred object from Aesthetic, with the entire poster composition expanded into a shallow 3D archive room.
...
- Color 2: #1a1d1d - primary text or opposing surface
- Color 3: #181716 - accent / interactive signal
- Color 4: #647074 - supporting surface or hover state
- Color 5: #131312 - supporting surface or hover state
- Color 6: #a2c2c1 - supporting surface or hover state
- Color 7: #e8e8e7 - supporting surface or hover state
- Color 8: #242221 - supporting surface or hover state
...
- Buttons tend toward #a2c2c1 backgrounds with #111111 text, and links inherit #a2c2c1 as the interaction signal.
...
- Render tier: mixed
- Primary depth cue in capture: 0 24px 80px rgba(162, 194, 193, 0.35)
...
- Keep the palette anchored to #e4e4e4, #1a1d1d, and #181716.
...
- Source: Arte Collective (https://arte-collective.com/collections/aesthetic/products/construct)
- Live site: https://arte-collective.com/collections/aesthetic/products/construct
