...
- Core palette: #e5e5e5, #f26f6d, #f2716e, #f2706e
...
- Aura: Minimal Space - Space Red should feel like a drifting internet relic whose full poster composition becomes a shallow-depth, glow-rail field.
...
- Color 2: #f26f6d - primary text or opposing surface
- Color 3: #f2716e - accent / interactive signal
- Color 4: #f2706e - supporting surface or hover state
- Color 5: #683b3a - supporting surface or hover state
- Color 6: #f4716f - supporting surface or hover state
- Color 7: #ef706d - supporting surface or hover state
- Color 8: #ea8481 - supporting surface or hover state
...
- Buttons tend toward #f26f6d backgrounds with #ffffff text, and links inherit #f26f6d as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(242, 111, 109, 0.35)
...
- Keep the palette anchored to #e5e5e5, #f26f6d, and #f2716e.
...
- Source: Arte Collective (https://arte-collective.com/collections/minimalism/products/minimal-space-space-red)
- Live site: https://arte-collective.com/collections/minimalism/products/minimal-space-space-red
