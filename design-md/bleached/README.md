# Bleached Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Bleached](http://bleached.info/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/bleached). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Bleached desktop capture](./screenshots/desktop.jpg)

### Mobile
![Bleached mobile capture](./screenshots/mobile.jpg)
