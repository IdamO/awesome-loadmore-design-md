# Glob Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Glob](https://glob.land/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/glob-land). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: e-commerce, tactile, fashion
...
### Web
![Glob desktop capture](./screenshots/desktop.jpg)

### Mobile
![Glob mobile capture](./screenshots/mobile.jpg)
