# Minimal Space - Orange Explore Inspired Design System

[DESIGN.md](./DESIGN.md) derived from the Arte Collective poster [Minimal Space - Orange Explore](https://arte-collective.com/collections/minimalism/products/minimal-space-orange-explore). This entry intentionally ignores the storefront chrome and instead translates the poster artwork into an imagined interactive website system with web/mobile guidance, spatial mechanics, and motion rules.
...
### Web
![Minimal Space - Orange Explore desktop capture](./screenshots/desktop.jpg)

### Mobile
![Minimal Space - Orange Explore mobile capture](./screenshots/mobile.jpg)
