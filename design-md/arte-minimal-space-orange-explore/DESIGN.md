...
- Core palette: #e5e5e5, #ef7b35, #f07b35, #ee7b35
...
- Aura: Minimal Space - Orange Explore should feel like a drifting internet relic whose full poster composition becomes a shallow-depth, glow-rail field.
...
- Color 1: #e5e5e5 - canvas / dominant background
- Color 2: #ef7b35 - primary text or opposing surface
- Color 3: #f07b35 - accent / interactive signal
- Color 4: #ee7b35 - supporting surface or hover state
- Color 5: #6b3f25 - supporting surface or hover state
- Color 6: #ef7b36 - supporting surface or hover state
- Color 7: #e39668 - supporting surface or hover state
- Color 8: #ef7b34 - supporting surface or hover state
...
- Let the main background color (#e5e5e5) carry the atmosphere instead of layering multiple competing surfaces.
- Preserve asymmetry when present - the archive tags (poster-derived, 3d-space, typography, animation, graphic-design, minimal, editorial, arte-minimalism) imply the system is intentionally non-generic.
- Buttons tend toward #ef7b34 backgrounds with #ffffff text, and links inherit #ef7b34 as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(239, 123, 52, 0.35)
...
- Keep the palette anchored to #e5e5e5, #ef7b35, and #f07b35.
- Preserve the experimental posture signaled by the archive tags: poster-derived, 3d-space, typography, animation, graphic-design, minimal, editorial, arte-minimalism.
...
- Source: Arte Collective (https://arte-collective.com/collections/minimalism/products/minimal-space-orange-explore)
- Live site: https://arte-collective.com/collections/minimalism/products/minimal-space-orange-explore
