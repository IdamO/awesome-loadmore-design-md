...
- Secondary: Playable Poster - tags include playful; tags include tactile; archetype affinity: toy loop microgame
...
- Preserve asymmetry when present - the archive tags (playful, tactile, sound-design) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #353535 as the interaction signal.
...
- Preserve the experimental posture signaled by the archive tags: playful, tactile, sound-design.
