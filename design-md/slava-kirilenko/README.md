# Slava Kirilenko Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Slava Kirilenko](https://slavakirilenko.com/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/slava-kirilenko). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: portfolio, typography, clean-ui
...
### Web
![Slava Kirilenko desktop capture](./screenshots/desktop.jpg)

### Mobile
![Slava Kirilenko mobile capture](./screenshots/mobile.jpg)
