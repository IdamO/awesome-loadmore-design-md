# Design System Inspiration of Liebermann Kiepe Reddemann

## 1. Visual Theme & Atmosphere

Liebermann Kiepe Reddemann reads as restrained minimalism. The live capture resolves to a light-leaning system built around #fefefe, #e9e9e9, and accent notes from #d7d6e9. Feels like trying to read a newspaper that you're holding upside down.
...
- Core palette: #fefefe, #e9e9e9, #d7d6e9, #9f9fe3
...
- Archetype: Portfolio Artifact (68% confidence)
- Why: tags include portfolio; tags include minimal
...
- Color 3: #d7d6e9 - accent / interactive signal
- Color 4: #9f9fe3 - supporting surface or hover state
- Color 5: #a6a6e5 - supporting surface or hover state
- Color 6: #a3a3a3 - supporting surface or hover state
- Color 7: #c0beeb - supporting surface or hover state
- Color 8: #c0c0bf - supporting surface or hover state
...
- Body sample: 21px / weight 400 / line-height 24px
...
- Preserve asymmetry when present - the archive tags (default-aesthetics, minimal, portfolio) imply the system is intentionally non-generic.
...
- HUD layering: none
- Render tier: dom
- Primary depth cue in capture: rgba(0, 0, 0, 0.3) 0px 0px 15px 1px
...
- Keep the palette anchored to #fefefe, #e9e9e9, and #d7d6e9.
- Preserve the experimental posture signaled by the archive tags: default-aesthetics, minimal, portfolio.
...
> Build this as a Cozy Desktop page with a secondary cue from Luxury Archive using the Portfolio Artifact interaction model. Keep TimesNewArial as the voice anchor, preserve the palette around #fefefe, #e9e9e9, #d7d6e9, drive the page through scroll, tap, and implement the mobile fallback as: Keep the asymmetry in rhythm and type, but simplify the layout into a single authored column with strong anchors.


## 15. Source Capture & Validation

- Source: loadmo.re (https://loadmo.re/posts/liebermann-kiepe-reddemann)
- Live site: https://liebermannkiepereddemann.de/
