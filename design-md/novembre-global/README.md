# Novembre Global Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Novembre Global](https://novembre.global) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/novembre-global). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Novembre Global desktop capture](./screenshots/desktop.jpg)

### Mobile
![Novembre Global mobile capture](./screenshots/mobile.jpg)
