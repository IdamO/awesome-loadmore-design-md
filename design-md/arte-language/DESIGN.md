...
- Core palette: #484848, #e4e4e4, #e5e5e5, #494949
...
- Aura: Language should feel like a text artifact stretched into a calm browser field, where bars and phrases become the whole interaction surface.
...
- Color 1: #484848 - canvas / dominant background
- Color 2: #e4e4e4 - primary text or opposing surface
- Color 3: #e5e5e5 - accent / interactive signal
- Color 4: #494949 - supporting surface or hover state
- Color 5: #e8e8e8 - supporting surface or hover state
- Color 6: #616161 - supporting surface or hover state
- Color 7: #c5c4c4 - supporting surface or hover state
- Color 8: #363636 - supporting surface or hover state
...
- Let the main background color (#484848) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #c5c4c4 backgrounds with #111111 text, and links inherit #c5c4c4 as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(197, 196, 196, 0.35)
...
- Keep the palette anchored to #484848, #e4e4e4, and #e5e5e5.
...
- Source: Arte Collective (https://arte-collective.com/collections/minimalism/products/language)
- Live site: https://arte-collective.com/collections/minimalism/products/language
