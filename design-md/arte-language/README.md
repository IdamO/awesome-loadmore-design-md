# Language Inspired Design System

[DESIGN.md](./DESIGN.md) derived from the Arte Collective poster [Language](https://arte-collective.com/collections/minimalism/products/language). This entry intentionally ignores the storefront chrome and instead translates the poster artwork into an imagined interactive website system with web/mobile guidance, spatial mechanics, and motion rules.
...
### Web
![Language desktop capture](./screenshots/desktop.jpg)

### Mobile
![Language mobile capture](./screenshots/mobile.jpg)
