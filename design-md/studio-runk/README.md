# Studio Runk Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Studio Runk](https://studiorunk.com/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/studio-runk). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Studio Runk desktop capture](./screenshots/desktop.jpg)

### Mobile
![Studio Runk mobile capture](./screenshots/mobile.jpg)
