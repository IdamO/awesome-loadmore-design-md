...
- Secondary: Playable Poster - tags include typography; tags include animation; archetype affinity: collage field
...
- Preserve asymmetry when present - the archive tags (typography, animation, net.art) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #171717 as the interaction signal.
...
- Preserve the experimental posture signaled by the archive tags: typography, animation, net.art.
