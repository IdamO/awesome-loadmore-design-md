# L'inconnue Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [L'inconnue](http://linconnue.biz) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/l-inconnue). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![L'inconnue desktop capture](./screenshots/desktop.jpg)

### Mobile
![L'inconnue mobile capture](./screenshots/mobile.jpg)
