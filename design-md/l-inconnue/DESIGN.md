...
- Why: tags include arts&culture; description mentions gallery
...
- Preserve asymmetry when present - the archive tags (tactile, arts&culture) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #aeaeae as the interaction signal.
...
- Preserve the experimental posture signaled by the archive tags: tactile, arts&culture.
