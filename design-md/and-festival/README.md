# And Festival Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [And Festival](https://andfestival.world) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/and-festival). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![And Festival desktop capture](./screenshots/desktop.jpg)

### Mobile
![And Festival mobile capture](./screenshots/mobile.jpg)
