# Design System Inspiration of Sleep later, more Science

## 1. Visual Theme & Atmosphere

Sleep later, more Science reads as type-led composition, spatial depth. The concept capture resolves to a light-leaning system built around #e6e6e6, #cdd5c9, and accent notes from #cbd1c6. Sleep later, more Science is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #e6e6e6, #cdd5c9, #cbd1c6, #a17a6c
...
- Aura: Sleep later, more Science should feel like a drifting internet relic whose full poster composition becomes a shallow-depth, glow-rail field.
...
- Color 2: #cdd5c9 - primary text or opposing surface
- Color 3: #cbd1c6 - accent / interactive signal
- Color 4: #a17a6c - supporting surface or hover state
- Color 5: #663231 - supporting surface or hover state
- Color 6: #cad4c9 - supporting surface or hover state
- Color 7: #c7c0b1 - supporting surface or hover state
- Color 8: #dee2df - supporting surface or hover state
...
- Buttons tend toward #663231 backgrounds with #ffffff text, and links inherit #663231 as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(102, 50, 49, 0.35)
...
- Keep the palette anchored to #e6e6e6, #cdd5c9, and #cbd1c6.
...
- Source: Arte Collective (https://arte-collective.com/collections/aesthetic/products/sleep-later-more-science)
- Live site: https://arte-collective.com/collections/aesthetic/products/sleep-later-more-science
