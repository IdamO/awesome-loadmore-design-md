...
- Core palette: #463be2, #ebebeb, #e6e6e6, #eaeaea
...
- Aura: Error 404 should feel like a live control poster whose full composition becomes a responsive HUD field instead of flat merch storytelling.
...
- Color 1: #463be2 - canvas / dominant background
...
- Color 5: #e2e2e3 - supporting surface or hover state
- Color 6: #ededec - supporting surface or hover state
- Color 7: #2f2885 - supporting surface or hover state
- Color 8: #6860cb - supporting surface or hover state
...
- Let the main background color (#463be2) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #463be2 backgrounds with #ffffff text, and links inherit #463be2 as the interaction signal.
...
- Render tier: mixed
- Primary depth cue in capture: 0 24px 80px rgba(70, 59, 226, 0.35)
...
- Keep the palette anchored to #463be2, #ebebeb, and #e6e6e6.
...
- Source: Arte Collective (https://arte-collective.com/collections/technology/products/error-404)
- Live site: https://arte-collective.com/collections/technology/products/error-404
