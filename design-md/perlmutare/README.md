# Perlmutare Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Perlmutare](https://www.perlmutare.net/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/perlmutare). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Perlmutare desktop capture](./screenshots/desktop.jpg)

### Mobile
![Perlmutare mobile capture](./screenshots/mobile.jpg)
