...
- Preserve asymmetry when present - the archive tags (colorful, typography) imply the system is intentionally non-generic.
...
- Preserve the experimental posture signaled by the archive tags: colorful, typography.
