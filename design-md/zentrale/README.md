# Zentrale Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Zentrale](http://www.zentrale-karlsruhe.com/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/zentrale). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Zentrale desktop capture](./screenshots/desktop.jpg)

### Mobile
![Zentrale mobile capture](./screenshots/mobile.jpg)
