...
- Core palette: #2d9363, #e5e5e5, #e4e4e4, #2b4f3e
...
- Aura: No Second Earth - Green should feel like a text artifact stretched into a calm browser field, where bars and phrases become the whole interaction surface.
...
- Color 1: #2d9363 - canvas / dominant background
- Color 2: #e5e5e5 - primary text or opposing surface
- Color 3: #e4e4e4 - accent / interactive signal
- Color 4: #2b4f3e - supporting surface or hover state
- Color 5: #2d9463 - supporting surface or hover state
- Color 6: #7db493 - supporting surface or hover state
- Color 7: #2c9363 - supporting surface or hover state
- Color 8: #e9e7e2 - supporting surface or hover state
...
- Let the main background color (#2d9363) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #2c9363 backgrounds with #ffffff text, and links inherit #2c9363 as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(44, 147, 99, 0.35)
...
- Keep the palette anchored to #2d9363, #e5e5e5, and #e4e4e4.
...
- Source: Arte Collective (https://arte-collective.com/collections/minimalism/products/no-second-earth-green)
- Live site: https://arte-collective.com/collections/minimalism/products/no-second-earth-green
