# Design System Inspiration of Gucci Mascara Hunt

## 1. Visual Theme & Atmosphere

Gucci Mascara Hunt reads as playful interaction, editorial fashion energy, spatial depth. The live capture resolves to a light-leaning system built around #f8e0f8, #9977c2, and accent notes from #d4aee4. Entertaining 3D pinball game with smooth interactions.

Desktop and mobile stay aligned but not identical: the desktop capture emphasizes a looser scroll narrative, while mobile compresses the same language into tighter interaction zones. The site's type system centers a bespoke stack, which becomes the fastest way to reproduce the feel.

Key Characteristics:
- Primary tone: bright surfaces with editorial contrast
- Core palette: #f8e0f8, #9977c2, #d4aee4, #a98bb3
...
- Why: tags include 3d-space; tags include fashion; description mentions 3d
...
- Color 1: #f8e0f8 - canvas / dominant background
- Color 2: #9977c2 - primary text or opposing surface
- Color 3: #d4aee4 - accent / interactive signal
- Color 4: #a98bb3 - supporting surface or hover state
- Color 5: #070607 - supporting surface or hover state
- Color 6: #b08ccf - supporting surface or hover state
- Color 7: #635b64 - supporting surface or hover state
- Color 8: #9877ad - supporting surface or hover state
...
- Let the main background color (#f8e0f8) carry the atmosphere instead of layering multiple competing surfaces.
- Preserve asymmetry when present - the archive tags (game, fashion, 3d-space) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #d4aee4 as the interaction signal.
...
- Keep the palette anchored to #f8e0f8, #9977c2, and #d4aee4.
- Preserve the experimental posture signaled by the archive tags: game, fashion, 3d-space.
