# Bus Group Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Bus Group](https://bus.group/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/bus-group). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Bus Group desktop capture](./screenshots/desktop.jpg)

### Mobile
![Bus Group mobile capture](./screenshots/mobile.jpg)
