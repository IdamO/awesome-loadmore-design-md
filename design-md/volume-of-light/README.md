# Volume of Light Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Volume of Light](https://volumeoflight.com/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/volume-of-light). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Volume of Light desktop capture](./screenshots/desktop.jpg)

### Mobile
![Volume of Light mobile capture](./screenshots/mobile.jpg)
