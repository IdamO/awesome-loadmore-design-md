...
- Preserve asymmetry when present - the archive tags (playful, tactile, portfolio) imply the site is intentionally non-generic.
...
- Preserve the experimental posture signaled by the loadmo.re tags: playful, tactile, portfolio.
