# Design System Inspiration of Estudio Piedras

## 1. Visual Theme & Atmosphere

Estudio Piedras reads as playful interaction. The live capture resolves to a light-leaning system built around #fefefe, #d7d7d7, and accent notes from #e8e8e8. Puzzle interaction to play with the studio's branding and content.

Desktop and mobile stay aligned but not identical: the desktop capture emphasizes anchored chrome and fixed-position framing, while mobile compresses the same language into tighter interaction zones. The site's type system centers NT Zeu, which becomes the fastest way to reproduce the feel.

Key Characteristics:
- Primary tone: bright surfaces with editorial contrast
- Core palette: #fefefe, #d7d7d7, #e8e8e8, #c9c9c9
- Typography stack: NT Zeu, Neu Leon Mono
...
### World Systems
- Primary: Playable Poster - tags include playful; tags include tactile
- Secondary: Collage Core - tags include playful; tags include tactile

### Interaction Archetype
- Archetype: Portfolio Artifact (76% confidence)
- Why: tags include portfolio; tags include playful; description mentions studio
...
- Color 3: #e8e8e8 - accent / interactive signal
- Color 4: #c9c9c9 - supporting surface or hover state
...
- Color 8: #888888 - supporting surface or hover state

## 4. Typography Rules

### Font Families
- Primary: NT Zeu
- Secondary: Neu Leon Mono

### Hierarchy Snapshot
- Heading sample: 16px / weight 400 / letter-spacing normal
- Body sample: 16px / weight 400 / line-height 18.4px
...
- Preserve asymmetry when present - the archive tags (playful, tactile, portfolio) imply the system is intentionally non-generic.
- Buttons tend toward rgba(0, 0, 0, 0) backgrounds with rgb(30, 30, 30) text, and links inherit rgb(30, 30, 30) as the interaction signal.
...
### Do
- Use NT Zeu consistently for headlines and interface labels.
- Keep the palette anchored to #fefefe, #d7d7d7, and #e8e8e8.
- Preserve the experimental posture signaled by the archive tags: playful, tactile, portfolio.
