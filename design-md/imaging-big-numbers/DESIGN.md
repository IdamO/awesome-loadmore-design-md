# Design System Inspiration of Imaging Big Numbers

## 1. Visual Theme & Atmosphere

Imaging Big Numbers reads as experimental mobile-first composition. The live capture resolves to a dark-leaning system built around #100f11, #575759, and accent notes from #98989c. An experience to help visitors conceptualize big numbers through interactive visuals and thoughtful text.

Desktop and mobile stay aligned but not identical: the desktop capture emphasizes a looser scroll narrative, while mobile compresses the same language into tighter interaction zones. The site's type system centers a bespoke stack, which becomes the fastest way to reproduce the feel.

Key Characteristics:
- Primary tone: cinematic dark surfaces with bright contrast
- Core palette: #100f11, #575759, #98989c, #2a2845
...
- Why: tags include colorful; tags include tactile; description mentions interactive
...
- Color 1: #100f11 - canvas / dominant background
- Color 2: #575759 - primary text or opposing surface
- Color 3: #98989c - accent / interactive signal
- Color 4: #2a2845 - supporting surface or hover state
- Color 5: #26452c - supporting surface or hover state
- Color 6: #452130 - supporting surface or hover state
- Color 7: #38464b - supporting surface or hover state
- Color 8: #463845 - supporting surface or hover state
...
- Let the main background color (#100f11) carry the atmosphere instead of layering multiple competing surfaces.
- Preserve asymmetry when present - the archive tags (educational, tactile, colorful) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #98989c as the interaction signal.
...
- Keep the palette anchored to #100f11, #575759, and #98989c.
- Preserve the experimental posture signaled by the archive tags: educational, tactile, colorful.
...
> Build this as a Playable Poster page with a secondary cue from Collage Core using the Playable Poster interaction model. Keep the extracted primary font as the voice anchor, preserve the palette around #100f11, #575759, #98989c, drive the page through scroll, tap, hover, and implement the mobile fallback as: Split the poster into two to four scenes, preserve one hero interaction, and drop hover-only secondary behavior.


## 15. Source Capture & Validation

- Source: loadmo.re (https://loadmo.re/posts/imaging-big-numbers)
- Live site: https://www.imagingbignumbers.xyz/
- Credits: not listed
