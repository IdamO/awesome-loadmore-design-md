# Michael Speichert Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Michael Speichert](https://www.michaelspeichert.com/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/michael-speichert). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Michael Speichert desktop capture](./screenshots/desktop.jpg)

### Mobile
![Michael Speichert mobile capture](./screenshots/mobile.jpg)
