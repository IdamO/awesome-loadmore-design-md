# Stripe Press Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Stripe Press](https://press.stripe.com/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/stripe-press). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Stripe Press desktop capture](./screenshots/desktop.jpg)

### Mobile
![Stripe Press mobile capture](./screenshots/mobile.jpg)
