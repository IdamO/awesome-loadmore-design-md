...
- Preserve asymmetry when present - the archive tags (3d-space, e-commerce) imply the system is intentionally non-generic.
...
- Preserve the experimental posture signaled by the archive tags: 3d-space, e-commerce.
