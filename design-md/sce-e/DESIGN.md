...
### World Systems
- Primary: Club Instrument - tags include sound-design; tags include playful; description mentions audio
- Secondary: Collage Core - tags include colorful; tags include playful

### Interaction Archetype
- Archetype: Club Instrument (96% confidence)
- Why: tags include sound-design; tags include playful; description mentions audio
...
- Support: __Inconsolata_bf9c6d
- Support: __Inconsolata_Fallback_bf9c6d
...
- Preserve asymmetry when present - the archive tags (sound-design, colorful, playful) imply the system is intentionally non-generic.
- Buttons tend toward rgba(0, 0, 0, 0) backgrounds with rgb(0, 0, 0) text, and links inherit #a2a09d as the interaction signal.
...
- Preserve the experimental posture signaled by the archive tags: sound-design, colorful, playful.
