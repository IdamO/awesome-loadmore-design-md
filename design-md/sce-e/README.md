# Sce.e Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Sce.e](https://www.ssccee.com/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/sce-e). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: sound-design, colorful, playful
...
### Web
![Sce.e desktop capture](./screenshots/desktop.jpg)

### Mobile
![Sce.e mobile capture](./screenshots/mobile.jpg)
