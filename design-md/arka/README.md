# Arka Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Arka](https://arka.video/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/arka). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: arts&culture, default-aesthetics
...
### Web
![Arka desktop capture](./screenshots/desktop.jpg)

### Mobile
![Arka mobile capture](./screenshots/mobile.jpg)
