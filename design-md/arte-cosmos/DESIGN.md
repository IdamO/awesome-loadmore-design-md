...
- Core palette: #344265, #e4e4e4, #e6e6e6, #76616e
...
- Aura: Cosmos should feel like a drifting internet relic whose full poster composition becomes a shallow-depth, glow-rail field.
...
- Color 1: #344265 - canvas / dominant background
- Color 2: #e4e4e4 - primary text or opposing surface
- Color 3: #e6e6e6 - accent / interactive signal
- Color 4: #76616e - supporting surface or hover state
- Color 5: #9a8895 - supporting surface or hover state
- Color 6: #494e6c - supporting surface or hover state
- Color 7: #d8d1d3 - supporting surface or hover state
- Color 8: #262d3f - supporting surface or hover state
...
- Let the main background color (#344265) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #344265 backgrounds with #ffffff text, and links inherit #344265 as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(52, 66, 101, 0.35)
...
- Keep the palette anchored to #344265, #e4e4e4, and #e6e6e6.
...
- Source: Arte Collective (https://arte-collective.com/collections/aesthetic/products/cosmos)
- Live site: https://arte-collective.com/collections/aesthetic/products/cosmos
