# Cosmos Inspired Design System

[DESIGN.md](./DESIGN.md) derived from the Arte Collective poster [Cosmos](https://arte-collective.com/collections/aesthetic/products/cosmos). This entry intentionally ignores the storefront chrome and instead translates the poster artwork into an imagined interactive website system with web/mobile guidance, spatial mechanics, and motion rules.
...
### Web
![Cosmos desktop capture](./screenshots/desktop.jpg)

### Mobile
![Cosmos mobile capture](./screenshots/mobile.jpg)
