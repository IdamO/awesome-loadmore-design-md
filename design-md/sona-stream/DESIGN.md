# Design System Inspiration of Sona Stream

## 1. Visual Theme & Atmosphere

Sona Stream reads as sonic pacing. The live capture resolves to a light-leaning system built around #fefefe, #d4dade, and accent notes from #dceaf1. Web3 music streaming service with a fun sinusoidal animation.

Desktop and mobile stay aligned but not identical: the desktop capture emphasizes a looser scroll narrative, while mobile compresses the same language into tighter interaction zones. The site's type system centers a bespoke stack, which becomes the fastest way to reproduce the feel.

Key Characteristics:
- Primary tone: bright surfaces with editorial contrast
- Core palette: #fefefe, #d4dade, #dceaf1, #eef5f7
...
- Color 2: #d4dade - primary text or opposing surface
- Color 3: #dceaf1 - accent / interactive signal
- Color 4: #eef5f7 - supporting surface or hover state
- Color 5: #d7e7ed - supporting surface or hover state
- Color 6: #adcee7 - supporting surface or hover state
- Color 7: #acacac - supporting surface or hover state
- Color 8: #696969 - supporting surface or hover state
...
- Body sample: 16px / weight 400 / line-height 26.4px
...
- Preserve asymmetry when present - the archive tags (music) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit rgb(0, 112, 243) as the interaction signal.
...
- Keep the palette anchored to #fefefe, #d4dade, and #dceaf1.
- Preserve the experimental posture signaled by the archive tags: music.
