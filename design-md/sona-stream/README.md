# Sona Stream Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Sona Stream](https://sona.stream/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/sona-stream). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Sona Stream desktop capture](./screenshots/desktop.jpg)

### Mobile
![Sona Stream mobile capture](./screenshots/mobile.jpg)
