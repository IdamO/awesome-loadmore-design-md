...
### World Systems
- Primary: Club Instrument - tags include music; tags include sound-design; description mentions piano
- Secondary: Fan Shrine - tags include music; tags include portfolio

### Interaction Archetype
- Archetype: Club Instrument (93% confidence)
- Why: tags include music; tags include sound-design; description mentions piano
...
- Preserve asymmetry when present - the archive tags (music, sound-design, portfolio) imply the system is intentionally non-generic.
...
- Preserve the experimental posture signaled by the archive tags: music, sound-design, portfolio.
