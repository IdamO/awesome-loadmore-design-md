# Chiara Rigato Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Chiara Rigato](http://www.chiararigato.com/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/chiara-rigato). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Chiara Rigato desktop capture](./screenshots/desktop.jpg)

### Mobile
![Chiara Rigato mobile capture](./screenshots/mobile.jpg)
