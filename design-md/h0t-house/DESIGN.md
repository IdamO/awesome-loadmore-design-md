...
- Why: description mentions search; sticky layout
...
- Preserve asymmetry when present - the archive tags (clean-ui) imply the system is intentionally non-generic.
- Buttons tend toward rgb(0, 0, 0) backgrounds with rgb(255, 255, 255) text, and links inherit rgb(227, 226, 219) as the interaction signal.
...
- Preserve the experimental posture signaled by the archive tags: clean-ui.
