# Dice Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Dice](https://dice.berlin/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/dice). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Dice desktop capture](./screenshots/desktop.jpg)

### Mobile
![Dice mobile capture](./screenshots/mobile.jpg)
