# uberraum Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [uberraum](https://uberraum.com/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/uberraum). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![uberraum desktop capture](./screenshots/desktop.jpg)

### Mobile
![uberraum mobile capture](./screenshots/mobile.jpg)
