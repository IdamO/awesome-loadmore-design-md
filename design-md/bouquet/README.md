# Bouquet Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Bouquet](http://www.bouquet.hhvv.org/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/bouquet). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Bouquet desktop capture](./screenshots/desktop.jpg)

### Mobile
![Bouquet mobile capture](./screenshots/mobile.jpg)
