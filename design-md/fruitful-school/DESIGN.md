# Design System Inspiration of Fruitful school

## 1. Visual Theme & Atmosphere

Fruitful school reads as retro-computing cues. The live capture resolves to a dark-leaning system built around #74716a, #2c2824, and accent notes from #8c8773. Fruitful school teaches code to people. Their website nicely combines retro/default HTML elements and fruits emojis.

Desktop and mobile stay aligned but not identical: the desktop capture emphasizes a looser scroll narrative, while mobile compresses the same language into tighter interaction zones. The site's type system centers a bespoke stack, which becomes the fastest way to reproduce the feel.

Key Characteristics:
- Primary tone: cinematic dark surfaces with bright contrast
- Core palette: #74716a, #2c2824, #8c8773, #8a706a
...
- Secondary: Collage Core - tags include retro; archival visual bias
...
- Color 1: #74716a - canvas / dominant background
- Color 2: #2c2824 - primary text or opposing surface
- Color 3: #8c8773 - accent / interactive signal
- Color 4: #8a706a - supporting surface or hover state
- Color 5: #545030 - supporting surface or hover state
- Color 6: #979086 - supporting surface or hover state
- Color 7: #9c971f - supporting surface or hover state
- Color 8: #4c362b - supporting surface or hover state
...
- Let the main background color (#74716a) carry the atmosphere instead of layering multiple competing surfaces.
- Preserve asymmetry when present - the archive tags (educational, retro, default-aesthetics) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #8c8773 as the interaction signal.
...
- Keep the palette anchored to #74716a, #2c2824, and #8c8773.
- Preserve the experimental posture signaled by the archive tags: educational, retro, default-aesthetics.
...
> Build this as a Cozy Desktop page with a secondary cue from Collage Core using the Desktop Shell World interaction model. Keep the extracted primary font as the voice anchor, preserve the palette around #74716a, #2c2824, #8c8773, drive the page through drag, tap, click, and implement the mobile fallback as: Translate the window system into a card stack, bottom drawer, or tabbed shell while preserving the desktop fiction in the chrome.

## 15. Source Capture & Validation

- Source: loadmo.re (https://loadmo.re/posts/fruitful-school)
- Live site: http://www.fruitful.school
- Credits: John Provencher, Laurel Schwulst
