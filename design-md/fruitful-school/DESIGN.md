...
- Preserve asymmetry when present - the archive tags (educational, retro, default-aesthetics) imply the site is intentionally non-generic.
...
- Preserve the experimental posture signaled by the loadmo.re tags: educational, retro, default-aesthetics.
