# Design System Inspiration of Coding brain

## 1. Visual Theme & Atmosphere

Coding brain reads as playful interaction, sonic pacing, retro-computing cues. The concept capture resolves to a light-leaning system built around #e3d6cd, #8f3b32, and accent notes from #e3d7cd. Coding brain is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #e3d6cd, #8f3b32, #e3d7cd, #e6e6e6
...
- Aura: Coding brain should feel like a live control poster whose full composition becomes a responsive HUD field instead of flat merch storytelling.
...
- Color 1: #e3d6cd - canvas / dominant background
- Color 2: #8f3b32 - primary text or opposing surface
- Color 3: #e3d7cd - accent / interactive signal
- Color 4: #e6e6e6 - supporting surface or hover state
- Color 5: #d7bdb1 - supporting surface or hover state
- Color 6: #e4e4e4 - supporting surface or hover state
- Color 7: #e2d6cc - supporting surface or hover state
- Color 8: #e4dcd4 - supporting surface or hover state
...
- Let the main background color (#e3d6cd) carry the atmosphere instead of layering multiple competing surfaces.
- Preserve asymmetry when present - the archive tags (poster-derived, 3d-space, typography, animation, graphic-design, retro, colorful, playful, sound-design, culture-tech, arte-aesthetic, arte-technology) imply the system is intentionally non-generic.
- Buttons tend toward #8f3b32 backgrounds with #ffffff text, and links inherit #8f3b32 as the interaction signal.
...
- Render tier: mixed
- Primary depth cue in capture: 0 24px 80px rgba(143, 59, 50, 0.35)
...
- Keep the palette anchored to #e3d6cd, #8f3b32, and #e3d7cd.
- Preserve the experimental posture signaled by the archive tags: poster-derived, 3d-space, typography, animation, graphic-design, retro, colorful, playful, sound-design, culture-tech, arte-aesthetic, arte-technology.
...
- Source: Arte Collective (https://arte-collective.com/collections/aesthetic/products/coding-brain)
- Live site: https://arte-collective.com/collections/aesthetic/products/coding-brain
