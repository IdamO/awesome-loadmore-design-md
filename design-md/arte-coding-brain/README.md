# Coding brain Inspired Design System

[DESIGN.md](./DESIGN.md) derived from the Arte Collective poster [Coding brain](https://arte-collective.com/collections/aesthetic/products/coding-brain). This entry intentionally ignores the storefront chrome and instead translates the poster artwork into an imagined interactive website system with web/mobile guidance, spatial mechanics, and motion rules.
...
- Tags: poster-derived, 3d-space, typography, animation, graphic-design, retro, colorful, playful, sound-design, culture-tech, arte-aesthetic, arte-technology
...
- Poster collections: Aesthetic, Technology
- Poster crop asset: assets/poster-crop.jpg

## Preview

### Web
![Coding brain desktop capture](./screenshots/desktop.jpg)

### Mobile
![Coding brain mobile capture](./screenshots/mobile.jpg)
