...
### World Systems
- Primary: Playable Poster - tags include colorful; tags include playful; archetype affinity: toy loop microgame
- Secondary: Collage Core - tags include colorful; tags include playful; archetype affinity: toy loop microgame

### Interaction Archetype
- Archetype: Toy Loop Microgame (68% confidence)
- Why: tags include playful; tags include participative; tags include colorful
...
- Preserve asymmetry when present - the archive tags (playful, participative, colorful) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #9c16cc as the interaction signal.
...
- Preserve the experimental posture signaled by the archive tags: playful, participative, colorful.
