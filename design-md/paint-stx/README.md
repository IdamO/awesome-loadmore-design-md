# Paint.stx Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Paint.stx](https://paint.stx.studio/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/paint-stx). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: playful, participative, colorful
...
### Web
![Paint.stx desktop capture](./screenshots/desktop.jpg)

### Mobile
![Paint.stx mobile capture](./screenshots/mobile.jpg)
