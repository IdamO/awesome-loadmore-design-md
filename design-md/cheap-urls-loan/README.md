# Cheap URLs Loan Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Cheap URLs Loan](https://cheap.urls.loan/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/cheap-urls-loan). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Cheap URLs Loan desktop capture](./screenshots/desktop.jpg)

### Mobile
![Cheap URLs Loan mobile capture](./screenshots/mobile.jpg)
