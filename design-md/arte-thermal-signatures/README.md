# Thermal Signatures Inspired Design System

[DESIGN.md](./DESIGN.md) derived from the Arte Collective poster [Thermal Signatures](https://arte-collective.com/collections/aesthetic/products/thermal-signatures). This entry intentionally ignores the storefront chrome and instead translates the poster artwork into an imagined interactive website system with web/mobile guidance, spatial mechanics, and motion rules.
...
### Web
![Thermal Signatures desktop capture](./screenshots/desktop.jpg)

### Mobile
![Thermal Signatures mobile capture](./screenshots/mobile.jpg)
