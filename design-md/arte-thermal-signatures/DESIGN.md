# Design System Inspiration of Thermal Signatures

## 1. Visual Theme & Atmosphere

Thermal Signatures reads as type-led composition, spatial depth. The concept capture resolves to a light-leaning system built around #e4e4e4, #1a1b1a, and accent notes from #8b655f. Thermal Signatures is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #e4e4e4, #1a1b1a, #8b655f, #161614
...
- Aura: Thermal Signatures should feel like a drifting internet relic whose full poster composition becomes a shallow-depth, glow-rail field.
...
- Color 3: #8b655f - accent / interactive signal
- Color 4: #161614 - supporting surface or hover state
- Color 5: #11110f - supporting surface or hover state
- Color 6: #a5c0b8 - supporting surface or hover state
- Color 7: #e9e8e8 - supporting surface or hover state
- Color 8: #581f1f - supporting surface or hover state
...
- Buttons tend toward #581f1f backgrounds with #ffffff text, and links inherit #581f1f as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(88, 31, 31, 0.35)
...
- Keep the palette anchored to #e4e4e4, #1a1b1a, and #8b655f.
...
- Live site: https://arte-collective.com/collections/aesthetic/products/thermal-signatures
