...
### World Systems
- Primary: Collage Core - tags include glitches; tags include playful; archetype affinity: collage field
- Secondary: Playable Poster - tags include playful; archetype affinity: collage field

### Interaction Archetype
- Archetype: Collage Field (78% confidence)
- Why: tags include glitches; tags include playful
...
- Preserve asymmetry when present - the archive tags (glitches, playful) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #191919 as the interaction signal.
...
- Preserve the experimental posture signaled by the archive tags: glitches, playful.
