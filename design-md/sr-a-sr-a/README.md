# SR_A SR_A Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [SR_A SR_A](https://sr-a.com/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/sr-a-sr-a). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![SR_A SR_A desktop capture](./screenshots/desktop.jpg)

### Mobile
![SR_A SR_A mobile capture](./screenshots/mobile.jpg)
