# Minimal Space - White Voyage Inspired Design System

[DESIGN.md](./DESIGN.md) derived from the Arte Collective poster [Minimal Space - White Voyage](https://arte-collective.com/collections/minimalism/products/minimal-space-white-voyage). This entry intentionally ignores the storefront chrome and instead translates the poster artwork into an imagined interactive website system with web/mobile guidance, spatial mechanics, and motion rules.
...
### Web
![Minimal Space - White Voyage desktop capture](./screenshots/desktop.jpg)

### Mobile
![Minimal Space - White Voyage mobile capture](./screenshots/mobile.jpg)
