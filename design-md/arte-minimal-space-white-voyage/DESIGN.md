...
- Core palette: #f8f8f8, #e4e4e4, #454343, #e7e7e7
...
- Aura: Minimal Space - White Voyage should feel like a drifting internet relic whose full poster composition becomes a shallow-depth, glow-rail field.
...
- Color 3: #454343 - accent / interactive signal
- Color 4: #e7e7e7 - supporting surface or hover state
- Color 5: #fcfcfd - supporting surface or hover state
- Color 6: #b9b8b8 - supporting surface or hover state
- Color 7: #f8f8f9 - supporting surface or hover state
- Color 8: #f7f8f8 - supporting surface or hover state
...
- Buttons tend toward #454343 backgrounds with #ffffff text, and links inherit #454343 as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(69, 67, 67, 0.35)
...
- Keep the palette anchored to #f8f8f8, #e4e4e4, and #454343.
...
- Source: Arte Collective (https://arte-collective.com/collections/minimalism/products/minimal-space-white-voyage)
- Live site: https://arte-collective.com/collections/minimalism/products/minimal-space-white-voyage
