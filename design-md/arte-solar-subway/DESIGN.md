# Design System Inspiration of Solar Subway

## 1. Visual Theme & Atmosphere

Solar Subway reads as type-led composition, spatial depth. The concept capture resolves to a light-leaning system built around #e6e6e6, #deddde, and accent notes from #e4e4e4. Solar Subway is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #e6e6e6, #deddde, #e4e4e4, #352a2a
...
- Aura: Solar Subway should feel like a drifting internet relic whose full poster composition becomes a shallow-depth, glow-rail field.
...
- Color 2: #deddde - primary text or opposing surface
- Color 3: #e4e4e4 - accent / interactive signal
- Color 4: #352a2a - supporting surface or hover state
- Color 5: #d9d8d9 - supporting surface or hover state
- Color 6: #e0dfe0 - supporting surface or hover state
- Color 7: #e2e1e1 - supporting surface or hover state
- Color 8: #9d9c99 - supporting surface or hover state
...
- Buttons tend toward #352a2a backgrounds with #ffffff text, and links inherit #352a2a as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(53, 42, 42, 0.35)
...
- Keep the palette anchored to #e6e6e6, #deddde, and #e4e4e4.
...
- Source: Arte Collective (https://arte-collective.com/collections/aesthetic/products/solar-subway)
- Live site: https://arte-collective.com/collections/aesthetic/products/solar-subway
