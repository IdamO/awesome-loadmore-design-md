# Contents Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Contents](https://www.contents.paris) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/contents). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: portfolio, colorful, photography
...
### Web
![Contents desktop capture](./screenshots/desktop.jpg)

### Mobile
![Contents mobile capture](./screenshots/mobile.jpg)
