...
### World Systems
- Primary: Luxury Archive - tags include photography; archetype affinity: portfolio artifact
...
- Preserve asymmetry when present - the archive tags (portfolio, colorful, photography) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #230a04 as the interaction signal.
...
- Preserve the experimental posture signaled by the archive tags: portfolio, colorful, photography.
