# Diffusion Cam Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Diffusion Cam](https://www.diffusion.cam/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/diffusion-cam). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: ai&generative, photography, participative
...
### Web
![Diffusion Cam desktop capture](./screenshots/desktop.jpg)

### Mobile
![Diffusion Cam mobile capture](./screenshots/mobile.jpg)
