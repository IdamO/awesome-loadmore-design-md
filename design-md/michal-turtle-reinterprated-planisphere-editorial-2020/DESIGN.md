...
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #d1d6da as the interaction signal.
...
- Inputs to preserve: tap, drag, press, hover
