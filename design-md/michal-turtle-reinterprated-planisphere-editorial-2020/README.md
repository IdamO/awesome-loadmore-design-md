# Michal Turtle Reinterprated – Planisphere Editorial 2020 Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Michal Turtle Reinterprated – Planisphere Editorial 2020](https://004.planisphere.eu/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/michal-turtle-reinterprated-planisphere-editorial-2020). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- World systems: Club Instrument, Luxury Archive
...
### Web
![Michal Turtle Reinterprated – Planisphere Editorial 2020 desktop capture](./screenshots/desktop.jpg)

### Mobile
![Michal Turtle Reinterprated – Planisphere Editorial 2020 mobile capture](./screenshots/mobile.jpg)
