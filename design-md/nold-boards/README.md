# Nold Boards Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Nold Boards](https://noldboards.ch/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/nold-boards). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Nold Boards desktop capture](./screenshots/desktop.jpg)

### Mobile
![Nold Boards mobile capture](./screenshots/mobile.jpg)
