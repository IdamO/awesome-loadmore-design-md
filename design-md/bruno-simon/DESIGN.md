...
### World Systems
- Primary: Club Instrument - tags include playful; tags include 3d-space
- Secondary: Collage Core - tags include playful

### Interaction Archetype
- Archetype: Portfolio Artifact (88% confidence)
- Why: tags include portfolio; tags include playful; description mentions portfolio; description mentions personal
...
> Build this as a Club Instrument page with a secondary cue from Collage Core using the Portfolio Artifact interaction model. Keep Amatic SC as the voice anchor, preserve the palette around #1e0f4a, #19063d, #472a71, drive the page through scroll, tap, and implement the mobile fallback as: Keep the asymmetry in rhythm and type, but simplify the layout into a single authored column with strong anchors.
