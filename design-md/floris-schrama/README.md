# Floris Schrama Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Floris Schrama](http://www.florisschrama.nl/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/floris-schrama). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Floris Schrama desktop capture](./screenshots/desktop.jpg)

### Mobile
![Floris Schrama mobile capture](./screenshots/mobile.jpg)
