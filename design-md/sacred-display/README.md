# Sacred Display Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Sacred Display](https://sacred.display.cz/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/sacred-display). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: 3d-space, arts&culture, digital-exhibition
- Credits: The Rodina
...
### Web
![Sacred Display desktop capture](./screenshots/desktop.jpg)

### Mobile
![Sacred Display mobile capture](./screenshots/mobile.jpg)
