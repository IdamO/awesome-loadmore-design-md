# Simone's Computer Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Simone's Computer](https://simone.computer) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/simone-s-computer). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Simone's Computer desktop capture](./screenshots/desktop.jpg)

### Mobile
![Simone's Computer mobile capture](./screenshots/mobile.jpg)
