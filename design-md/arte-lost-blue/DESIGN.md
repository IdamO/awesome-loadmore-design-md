# Design System Inspiration of Lost - Blue

## 1. Visual Theme & Atmosphere

Lost - Blue reads as type-led composition, spatial depth. The concept capture resolves to a dark-leaning system built around #295ae8, #e6e6e6, and accent notes from #2253e7. Lost - Blue is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #295ae8, #e6e6e6, #2253e7, #1d1b22
...
- Aura: Lost - Blue should feel like a drifting internet relic whose full poster composition becomes a shallow-depth, glow-rail field.
...
- Color 1: #295ae8 - canvas / dominant background
- Color 2: #e6e6e6 - primary text or opposing surface
- Color 3: #2253e7 - accent / interactive signal
- Color 4: #1d1b22 - supporting surface or hover state
- Color 5: #2757e8 - supporting surface or hover state
- Color 6: #2043b1 - supporting surface or hover state
- Color 7: #e1e1e1 - supporting surface or hover state
- Color 8: #4265c9 - supporting surface or hover state
...
- Let the main background color (#295ae8) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #2253e7 backgrounds with #ffffff text, and links inherit #2253e7 as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(34, 83, 231, 0.35)
...
- Keep the palette anchored to #295ae8, #e6e6e6, and #2253e7.
...
- Source: Arte Collective (https://arte-collective.com/collections/aesthetic/products/lost-blue)
- Live site: https://arte-collective.com/collections/aesthetic/products/lost-blue
