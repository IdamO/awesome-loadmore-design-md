...
### World Systems
- Primary: Collage Core - tags include playful
- Secondary: Cozy Desktop - tags include portfolio; tags include playful
...
- HUD layering: none
- Render tier: dom
- Primary depth cue in capture: rgba(0, 0, 0, 0.3) 0px 0px 20px 0px
