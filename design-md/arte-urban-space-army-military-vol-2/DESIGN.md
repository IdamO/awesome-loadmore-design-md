# Design System Inspiration of Urban Space Army - Military vol.2

## 1. Visual Theme & Atmosphere

Urban Space Army - Military vol.2 reads as playful interaction, sonic pacing, retro-computing cues. The concept capture resolves to a dark-leaning system built around #030303, #020201, and accent notes from #e6e6e6. Urban Space Army - Military vol.2 is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #030303, #020201, #e6e6e6, #e4e4e4
...
- Aura: Urban Space Army - Military vol.2 should feel like a live control poster whose full composition becomes a responsive HUD field instead of flat merch storytelling.
...
- Color 2: #020201 - primary text or opposing surface
- Color 3: #e6e6e6 - accent / interactive signal
- Color 4: #e4e4e4 - supporting surface or hover state
- Color 5: #1c1d1d - supporting surface or hover state
- Color 6: #818384 - supporting surface or hover state
- Color 7: #050505 - supporting surface or hover state
...
- Buttons tend toward #020201 backgrounds with #ffffff text, and links inherit #020201 as the interaction signal.
...
- Render tier: mixed
- Primary depth cue in capture: 0 24px 80px rgba(2, 2, 1, 0.35)
...
- Keep the palette anchored to #030303, #020201, and #e6e6e6.
...
- Source: Arte Collective (https://arte-collective.com/collections/technology/products/urban-space-army-military-vol-2)
- Live site: https://arte-collective.com/collections/technology/products/urban-space-army-military-vol-2
