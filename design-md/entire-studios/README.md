# Entire Studios Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Entire Studios](https://www.entirestudios.com/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/entire-studios). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: e-commerce, sound-design, clean-ui
...
### Web
![Entire Studios desktop capture](./screenshots/desktop.jpg)

### Mobile
![Entire Studios mobile capture](./screenshots/mobile.jpg)
