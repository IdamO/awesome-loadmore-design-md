# LCF SMC Show 21 Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [LCF SMC Show 21](https://lcf-smc-show-21.co.uk/undergraduate/design-for-performance) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/lcf-smc-show-21). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: 3d-space, tactile, digital-exhibition
...
### Web
![LCF SMC Show 21 desktop capture](./screenshots/desktop.jpg)

### Mobile
![LCF SMC Show 21 mobile capture](./screenshots/mobile.jpg)
