# Design System Inspiration of Hybrid Vigor

## 1. Visual Theme & Atmosphere

Hybrid Vigor reads as playful interaction. The live capture resolves to a light-leaning system built around #fbfbf9, #f35ca2, and accent notes from #aeaccf. When picking 2 organisms, their settings are blend to create a new set of 6. So you start with a very diverse set and end up with more and more similar shapes.

Desktop and mobile stay aligned but not identical: the desktop capture emphasizes a looser scroll narrative, while mobile compresses the same language into tighter interaction zones. The site's type system centers a bespoke stack, which becomes the fastest way to reproduce the feel.

Key Characteristics:
- Primary tone: bright surfaces with editorial contrast
- Core palette: #fbfbf9, #f35ca2, #aeaccf, #c8b4c9
...
### World Systems
- Primary: Collage Core - tags include net.art; tags include colorful; tags include playful
...
- Why: tags include net.art; tags include colorful; tags include playful
- Core verbs: scan, hover, collect
- Inputs: scroll, hover, tap

## 3. Color Palette & Roles

- Color 1: #fbfbf9 - canvas / dominant background
- Color 2: #f35ca2 - primary text or opposing surface
- Color 3: #aeaccf - accent / interactive signal
- Color 4: #c8b4c9 - supporting surface or hover state
- Color 5: #1b2aa1 - supporting surface or hover state
- Color 6: #95a5ad - supporting surface or hover state
- Color 7: #6ba5a0 - supporting surface or hover state
- Color 8: #5b62e6 - supporting surface or hover state
...
- Let the main background color (#fbfbf9) carry the atmosphere instead of layering multiple competing surfaces.
- Preserve asymmetry when present - the archive tags (net.art, playful, colorful) imply the site is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #aeaccf as the interaction signal.
...
- Keep the palette anchored to #fbfbf9, #f35ca2, and #aeaccf.
- Preserve the experimental posture signaled by the loadmo.re tags: net.art, playful, colorful.
...
- Source: loadmo.re (https://loadmo.re/posts/hybrid-vigor)
- Live site: http://hybrid.vigor.bio/
- Credits: Harm van den Dorpel
- Capture mode: live
