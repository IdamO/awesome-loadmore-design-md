...
- Preserve asymmetry when present - the archive tags (net.art, playful, colorful) imply the system is intentionally non-generic.
...
- Preserve the experimental posture signaled by the archive tags: net.art, playful, colorful.
