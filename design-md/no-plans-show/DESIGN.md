...
- Preserve asymmetry when present - the archive tags (portfolio, animation, glitches) imply the site is intentionally non-generic.
...
- Preserve the experimental posture signaled by the loadmo.re tags: portfolio, animation, glitches.
