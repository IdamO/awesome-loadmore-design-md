# Design System Inspiration of Monolith

## 1. Visual Theme & Atmosphere

Monolith reads as type-led composition, spatial depth. The concept capture resolves to a light-leaning system built around #e4e4e4, #1f1916, and accent notes from #191312. Monolith is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #e4e4e4, #1f1916, #191312, #97523c
...
- Aura: Monolith should feel like a sacred object from Aesthetic, with the entire poster composition expanded into a shallow 3D archive room.
...
- Color 2: #1f1916 - primary text or opposing surface
- Color 3: #191312 - accent / interactive signal
- Color 4: #97523c - supporting surface or hover state
- Color 5: #292019 - supporting surface or hover state
- Color 6: #140f0d - supporting surface or hover state
- Color 7: #c0a47f - supporting surface or hover state
- Color 8: #e8e8e6 - supporting surface or hover state
...
- Buttons tend toward #97523c backgrounds with #ffffff text, and links inherit #97523c as the interaction signal.
...
- Render tier: mixed
- Primary depth cue in capture: 0 24px 80px rgba(151, 82, 60, 0.35)
...
- Keep the palette anchored to #e4e4e4, #1f1916, and #191312.
...
- Source: Arte Collective (https://arte-collective.com/collections/aesthetic/products/monolith)
- Live site: https://arte-collective.com/collections/aesthetic/products/monolith
