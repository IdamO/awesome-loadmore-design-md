...
- Secondary: Playable Poster - description mentions drag

### Interaction Archetype
- Archetype: Spatial Exhibition World (83% confidence)
- Why: tags include 3d-space
...
- Preserve asymmetry when present - the archive tags (3d-space) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #dadcdd as the interaction signal.
...
- Preserve the experimental posture signaled by the archive tags: 3d-space.
