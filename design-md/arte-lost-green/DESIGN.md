# Design System Inspiration of Lost - Green

## 1. Visual Theme & Atmosphere

Lost - Green reads as type-led composition, spatial depth. The concept capture resolves to a dark-leaning system built around #26855a, #29875b, and accent notes from #213a2b. Lost - Green is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #26855a, #29875b, #213a2b, #e6e6e6
...
- Aura: Lost - Green should feel like a drifting internet relic whose full poster composition becomes a shallow-depth, glow-rail field.
...
- Color 1: #26855a - canvas / dominant background
- Color 2: #29875b - primary text or opposing surface
- Color 3: #213a2b - accent / interactive signal
- Color 4: #e6e6e6 - supporting surface or hover state
- Color 5: #e4e4e1 - supporting surface or hover state
- Color 6: #28875b - supporting surface or hover state
- Color 7: #298b5d - supporting surface or hover state
- Color 8: #7cac91 - supporting surface or hover state
...
- Let the main background color (#26855a) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #26855a backgrounds with #ffffff text, and links inherit #26855a as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(38, 133, 90, 0.35)
...
- Keep the palette anchored to #26855a, #29875b, and #213a2b.
...
- Source: Arte Collective (https://arte-collective.com/collections/aesthetic/products/lost-green)
- Live site: https://arte-collective.com/collections/aesthetic/products/lost-green
