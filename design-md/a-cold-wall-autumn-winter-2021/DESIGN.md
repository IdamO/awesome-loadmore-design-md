# Design System Inspiration of A-COLD-WALL AUTUMN WINTER 2021

## 1. Visual Theme & Atmosphere

A-COLD-WALL AUTUMN WINTER 2021 reads as editorial fashion energy. The live capture resolves to a dark-leaning system built around #110c0c, #4d3417, and accent notes from #694d20. Tactile website showing the AW21 lookbook, with glitch effects and sound design that reacts to browsing movements.

Desktop and mobile stay aligned but not identical: the desktop capture emphasizes a looser scroll narrative, while mobile compresses the same language into tighter interaction zones. The site's type system centers a bespoke stack, which becomes the fastest way to reproduce the feel.

Key Characteristics:
- Primary tone: cinematic dark surfaces with bright contrast
- Core palette: #110c0c, #4d3417, #694d20, #8e6e2b
...
### World Systems
- Primary: Club Instrument - description mentions sound; archetype affinity: club instrument
- Secondary: Fan Shrine - tags include fashion

### Interaction Archetype
- Archetype: Club Instrument (93% confidence)
- Why: description mentions sound; description mentions sing
- Core verbs: trigger, press, mix
- Inputs: tap, drag, press

## 3. Color Palette & Roles

- Color 1: #110c0c - canvas / dominant background
- Color 2: #4d3417 - primary text or opposing surface
- Color 3: #694d20 - accent / interactive signal
- Color 4: #8e6e2b - supporting surface or hover state
- Color 5: #aca3a1 - supporting surface or hover state
- Color 6: #625b57 - supporting surface or hover state
- Color 7: #ab9456 - supporting surface or hover state
- Color 8: #d5ac4a - supporting surface or hover state
...
- Let the main background color (#110c0c) carry the atmosphere instead of layering multiple competing surfaces.
- Preserve asymmetry when present - the archive tags (fashion) imply the site is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #694d20 as the interaction signal.
...
- Keep the palette anchored to #110c0c, #4d3417, and #694d20.
