# The New Company Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [The New Company](https://www.new.company) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/the-new-company). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![The New Company desktop capture](./screenshots/desktop.jpg)

### Mobile
![The New Company mobile capture](./screenshots/mobile.jpg)
