# Publication Studio Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Publication Studio](https://publicationstudio.cloud) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/publication-studio). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: arts&culture, online-magazine
...
### Web
![Publication Studio desktop capture](./screenshots/desktop.jpg)

### Mobile
![Publication Studio mobile capture](./screenshots/mobile.jpg)
