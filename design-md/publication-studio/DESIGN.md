# Design System Inspiration of Publication Studio

## 1. Visual Theme & Atmosphere

Publication Studio reads as exhibition-like framing. The live capture resolves to a dark-leaning system built around #8aa8d4, #7b9acb, and accent notes from #9cadba. Browsing clouds of floating publications.

Desktop and mobile stay aligned but not identical: the desktop capture emphasizes a looser scroll narrative, while mobile compresses the same language into tighter interaction zones. The site's type system centers a bespoke stack, which becomes the fastest way to reproduce the feel.

Key Characteristics:
- Primary tone: cinematic dark surfaces with bright contrast
- Core palette: #8aa8d4, #7b9acb, #9cadba, #abc1e4
...
### World Systems
- Primary: Luxury Archive - tags include arts&culture; tags include online-magazine; description mentions publication
- Secondary: Collage Core - archival visual bias

### Interaction Archetype
- Archetype: Editorial Archive Index (96% confidence)
- Why: tags include arts&culture; tags include online-magazine; description mentions publication
- Core verbs: browse, filter, open
- Inputs: scroll, tap, filter

## 3. Color Palette & Roles

- Color 1: #8aa8d4 - canvas / dominant background
- Color 2: #7b9acb - primary text or opposing surface
- Color 3: #9cadba - accent / interactive signal
- Color 4: #abc1e4 - supporting surface or hover state
- Color 5: #5f7294 - supporting surface or hover state
- Color 6: #738cb4 - supporting surface or hover state
- Color 7: #4a5a77 - supporting surface or hover state
- Color 8: #3c4861 - supporting surface or hover state
...
- Let the main background color (#8aa8d4) carry the atmosphere instead of layering multiple competing surfaces.
- Preserve asymmetry when present - the archive tags (arts&culture, online-magazine) imply the site is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #9cadba as the interaction signal.
...
- Nice-to-have embellishments:
  ...
  - description mentions publication
...
- Keep the palette anchored to #8aa8d4, #7b9acb, and #9cadba.
- Preserve the experimental posture signaled by the loadmo.re tags: arts&culture, online-magazine.
...
- Source: loadmo.re (https://loadmo.re/posts/publication-studio)
- Live site: https://publicationstudio.cloud
- Credits: Beautiful Company
