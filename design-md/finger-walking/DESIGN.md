...
### World Systems
- Primary: Collage Core - tags include net.art; tags include playful; archetype affinity: toy loop microgame
- Secondary: Playable Poster - tags include playful; archetype affinity: toy loop microgame

### Interaction Archetype
- Archetype: Toy Loop Microgame (80% confidence)
- Why: tags include game; tags include playful; tags include net.art
...
- Preserve asymmetry when present - the archive tags (playful, game, net.art) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #b0aca3 as the interaction signal.
...
- Preserve the experimental posture signaled by the archive tags: playful, game, net.art.
