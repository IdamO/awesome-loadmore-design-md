# 69 Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [69](https://sixty-nine.us/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/sixty-nine). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![69 desktop capture](./screenshots/desktop.jpg)

### Mobile
![69 mobile capture](./screenshots/mobile.jpg)
