# Design System Inspiration of Stellar

## 1. Visual Theme & Atmosphere

Stellar reads as type-led composition, spatial depth. The concept capture resolves to a dark-leaning system built around #232323, #986a5f, and accent notes from #e6e6e6. Stellar is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #232323, #986a5f, #e6e6e6, #282626
...
- Aura: Stellar should feel like a drifting internet relic whose full poster composition becomes a shallow-depth, glow-rail field.
...
- Color 1: #232323 - canvas / dominant background
- Color 2: #986a5f - primary text or opposing surface
- Color 3: #e6e6e6 - accent / interactive signal
- Color 4: #282626 - supporting surface or hover state
- Color 5: #e4e4e4 - supporting surface or hover state
- Color 6: #513f3a - supporting surface or hover state
- Color 7: #b29892 - supporting surface or hover state
- Color 8: #1b1b1b - supporting surface or hover state
...
- Let the main background color (#232323) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #986a5f backgrounds with #ffffff text, and links inherit #986a5f as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(152, 106, 95, 0.35)
...
- Keep the palette anchored to #232323, #986a5f, and #e6e6e6.
...
- Source: Arte Collective (https://arte-collective.com/collections/aesthetic/products/stellar)
- Live site: https://arte-collective.com/collections/aesthetic/products/stellar
