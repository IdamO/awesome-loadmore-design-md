...
### World Systems
- Primary: Collage Core - tags include net.art; tags include playful; tags include retro
- Secondary: Cozy Desktop - tags include retro; tags include playful

### Interaction Archetype
- Archetype: Collage Field (96% confidence)
- Why: tags include net.art; tags include playful; tags include retro; description mentions collage
...
- Preserve asymmetry when present - the archive tags (retro, net.art, playful) imply the system is intentionally non-generic.
...
- Preserve the experimental posture signaled by the archive tags: retro, net.art, playful.
