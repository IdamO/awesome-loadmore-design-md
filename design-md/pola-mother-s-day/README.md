# Pola - Mother's Day Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Pola - Mother's Day](https://www.pola.co.jp/wecaremore/mothersday/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/pola-mother-s-day). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Pola - Mother's Day desktop capture](./screenshots/desktop.jpg)

### Mobile
![Pola - Mother's Day mobile capture](./screenshots/mobile.jpg)
