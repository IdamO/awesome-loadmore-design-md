...
### World Systems
- Primary: Playable Poster - tags include tactile; tags include animation; archetype affinity: playable poster
...
- Why: tags include tactile; tags include animation; sticky layout
...
- Preserve asymmetry when present - the archive tags (tactile, animation) imply the system is intentionally non-generic.
...
- Preserve the experimental posture signaled by the archive tags: tactile, animation.
...
> Build this as a Playable Poster page with a secondary cue from Collage Core using the Playable Poster interaction model. Keep the extracted primary font as the voice anchor, preserve the palette around #ececec, #e65232, #da301c, drive the page through scroll, tap, hover, and implement the mobile fallback as: Split the poster into two to four scenes, preserve one hero interaction, and drop hover-only secondary behavior.
