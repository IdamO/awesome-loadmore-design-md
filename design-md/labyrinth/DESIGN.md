...
- Why: tags include game; tags include playful; tags include participative; description mentions game
...
- Preserve asymmetry when present - the archive tags (game, participative, playful) imply the system is intentionally non-generic.
...
- Preserve the experimental posture signaled by the archive tags: game, participative, playful.
