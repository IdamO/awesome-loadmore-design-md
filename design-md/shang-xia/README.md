# Shang Xia Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Shang Xia](https://www.shangxia.com/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/shang-xia). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Shang Xia desktop capture](./screenshots/desktop.jpg)

### Mobile
![Shang Xia mobile capture](./screenshots/mobile.jpg)
