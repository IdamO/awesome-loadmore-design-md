...
### World Systems
- Primary: Club Instrument - tags include music
- Secondary: Luxury Archive - archetype affinity: editorial archive index

### Interaction Archetype
- Archetype: Editorial Archive Index (68% confidence)
- Why: tags include educational; description mentions search
...
- Preserve asymmetry when present - the archive tags (graphic-design, music, educational) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit rgb(16, 36, 164) as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: rgb(16, 36, 164) 5px 0px 0px 0px inset
...
- Preserve the experimental posture signaled by the archive tags: graphic-design, music, educational.
...
> Build this as a Club Instrument page with a secondary cue from Luxury Archive using the Editorial Archive Index interaction model. Keep Base-Bloom as the voice anchor, preserve the palette around #f9f3fc, #f0b5fe, #a6b2d7, drive the page through scroll, tap, filter, and implement the mobile fallback as: Keep a single-column feed, bottom-sheet filters, a persistent current-section pill, and inline detail expansion.
