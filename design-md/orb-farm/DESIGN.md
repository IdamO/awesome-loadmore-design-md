...
- Preserve asymmetry when present - the archive tags (game, retro, net.art, default-aesthetics) imply the system is intentionally non-generic.
...
- Preserve the experimental posture signaled by the archive tags: game, retro, net.art, default-aesthetics.
