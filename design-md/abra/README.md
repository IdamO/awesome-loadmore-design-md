# ABRA Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [ABRA](http://www.abra.paris/x1.0/indexm.php) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/abra). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![ABRA desktop capture](./screenshots/desktop.jpg)

### Mobile
![ABRA mobile capture](./screenshots/mobile.jpg)
