# Design System Inspiration of Alex Heeyeon Kill

## 1. Visual Theme & Atmosphere

Alex Heeyeon Kill reads as exhibition-like framing. The live capture resolves to a light-leaning system built around #ebebeb, #fafaf8, and accent notes from #d8d8d7. Smart yet light interface using the metaphor of a stack of documents to let you explore a writer's works.

Desktop and mobile stay aligned but not identical: the desktop capture emphasizes a looser scroll narrative, while mobile compresses the same language into tighter interaction zones. The site's type system centers a bespoke stack, which becomes the fastest way to reproduce the feel.

Key Characteristics:
- Primary tone: bright surfaces with editorial contrast
- Core palette: #ebebeb, #fafaf8, #d8d8d7, #cbcbcb
...
### World Systems
- Primary: Luxury Archive - tags include arts&culture; archetype affinity: portfolio artifact
...
- Color 1: #ebebeb - canvas / dominant background
- Color 2: #fafaf8 - primary text or opposing surface
- Color 3: #d8d8d7 - accent / interactive signal
- Color 4: #cbcbcb - supporting surface or hover state
- Color 5: #9c9c9c - supporting surface or hover state
- Color 6: #b7b8b8 - supporting surface or hover state
- Color 7: #ededeb - supporting surface or hover state
- Color 8: #717273 - supporting surface or hover state
...
- Let the main background color (#ebebeb) carry the atmosphere instead of layering multiple competing surfaces.
- Preserve asymmetry when present - the archive tags (portfolio, arts&culture) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #d8d8d7 as the interaction signal.
...
- Keep the palette anchored to #ebebeb, #fafaf8, and #d8d8d7.
- Preserve the experimental posture signaled by the archive tags: portfolio, arts&culture.
...
- Live site: https://www.alexheeyeonkil.com/
