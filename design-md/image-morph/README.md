# Image Morph Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Image Morph](https://fluffy-swan-06378f.netlify.app/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/image-morph). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Image Morph desktop capture](./screenshots/desktop.jpg)

### Mobile
![Image Morph mobile capture](./screenshots/mobile.jpg)
