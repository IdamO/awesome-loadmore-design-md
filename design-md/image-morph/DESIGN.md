...
### World Systems
- Primary: Collage Core - tags include net.art; archetype affinity: toy loop microgame
- Secondary: Playable Poster - archetype affinity: toy loop microgame

### Interaction Archetype
- Archetype: Toy Loop Microgame (68% confidence)
- Why: tags include net.art; description mentions play; description mentions interact
...
- Preserve asymmetry when present - the archive tags (illustration, net.art) imply the system is intentionally non-generic.
...
- Preserve the experimental posture signaled by the archive tags: illustration, net.art.
