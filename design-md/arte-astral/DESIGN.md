# Design System Inspiration of Astral

## 1. Visual Theme & Atmosphere

Astral reads as type-led composition, spatial depth. The concept capture resolves to a light-leaning system built around #e6e6e6, #e4e4e4, and accent notes from #33323f. Astral is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #e6e6e6, #e4e4e4, #33323f, #60575b
...
- Aura: Astral should feel like a drifting internet relic whose full poster composition becomes a shallow-depth, glow-rail field.
...
- Color 3: #33323f - accent / interactive signal
- Color 4: #60575b - supporting surface or hover state
- Color 5: #282938 - supporting surface or hover state
- Color 6: #1c1b25 - supporting surface or hover state
- Color 7: #43383e - supporting surface or hover state
- Color 8: #a7a3a3 - supporting surface or hover state
...
- Buttons tend toward #282938 backgrounds with #ffffff text, and links inherit #282938 as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(40, 41, 56, 0.35)
...
- Keep the palette anchored to #e6e6e6, #e4e4e4, and #33323f.
...
- Source: Arte Collective (https://arte-collective.com/collections/aesthetic/products/astral)
- Live site: https://arte-collective.com/collections/aesthetic/products/astral
