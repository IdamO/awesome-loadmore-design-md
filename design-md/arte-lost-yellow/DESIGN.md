# Design System Inspiration of Lost - Yellow

## 1. Visual Theme & Atmosphere

Lost - Yellow reads as type-led composition, spatial depth. The concept capture resolves to a light-leaning system built around #e8b729, #e5e5e5, and accent notes from #342b1e. Lost - Yellow is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #e8b729, #e5e5e5, #342b1e, #e9b725
...
- Aura: Lost - Yellow should feel like a drifting internet relic whose full poster composition becomes a shallow-depth, glow-rail field.
...
- Color 1: #e8b729 - canvas / dominant background
- Color 2: #e5e5e5 - primary text or opposing surface
- Color 3: #342b1e - accent / interactive signal
- Color 4: #e9b725 - supporting surface or hover state
- Color 5: #d4a428 - supporting surface or hover state
- Color 6: #e8b726 - supporting surface or hover state
- Color 7: #e7b729 - supporting surface or hover state
...
- Let the main background color (#e8b729) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #e9b725 backgrounds with #111111 text, and links inherit #e9b725 as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(233, 183, 37, 0.35)
...
- Keep the palette anchored to #e8b729, #e5e5e5, and #342b1e.
...
- Source: Arte Collective (https://arte-collective.com/collections/aesthetic/products/lost-yellow)
- Live site: https://arte-collective.com/collections/aesthetic/products/lost-yellow
