# Viso Haus Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Viso Haus](https://viso.haus/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/viso-haus). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Viso Haus desktop capture](./screenshots/desktop.jpg)

### Mobile
![Viso Haus mobile capture](./screenshots/mobile.jpg)
