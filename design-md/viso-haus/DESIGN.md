...
### World Systems
- Primary: Playable Poster - tags include tactile; description mentions drag; archetype affinity: playable poster
...
- Why: tags include tactile; description mentions drag; sticky layout
...
> Build this as a Playable Poster page with a secondary cue from Collage Core using the Playable Poster interaction model. Keep __GTAmerica_36d514 as the voice anchor, preserve the palette around #080707, #e6dddd, #5a2317, drive the page through scroll, tap, hover, drag, and implement the mobile fallback as: Split the poster into two to four scenes, preserve one hero interaction, and drop hover-only secondary behavior.
