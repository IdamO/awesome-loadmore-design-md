...
- Links inherit #f99909 as the interaction signal.
...
- Preserve asymmetry when present - the archive tags (default-aesthetics, portfolio, net.art) imply the site is intentionally non-generic.

## 6. Depth & Elevation

- Primary depth cue: rgba(0, 0, 0, 0.12) 0px 1px 3px 0px, rgba(0, 0, 0, 0.24) 0px 1px 2px 0px.
- Radius cue: 3px.
...
- Preserve the experimental posture signaled by the loadmo.re tags: default-aesthetics, portfolio, net.art.
...
> Build a responsive landing page inspired by Nicky Tesla. Keep the palette centered on #f1efef, #dbf925, and #f99909. Use Roboto Mono for headlines, preserve the experimental mobile-first composition mood, and treat desktop and mobile as distinct compositions rather than a single squashed layout.
