...
- Core palette: #92ca66, #93ca66, #e5e5e5, #516540
...
- Aura: Minimal Space - Green Gravity should feel like a drifting internet relic whose full poster composition becomes a shallow-depth, glow-rail field.
...
- Color 1: #92ca66 - canvas / dominant background
- Color 2: #93ca66 - primary text or opposing surface
- Color 3: #e5e5e5 - accent / interactive signal
- Color 4: #516540 - supporting surface or hover state
- Color 5: #93cb66 - supporting surface or hover state
- Color 6: #aad389 - supporting surface or hover state
- Color 7: #93ca65 - supporting surface or hover state
- Color 8: #92cb66 - supporting surface or hover state
...
- Let the main background color (#92ca66) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #93ca65 backgrounds with #111111 text, and links inherit #93ca65 as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(147, 202, 101, 0.35)
...
- Keep the palette anchored to #92ca66, #93ca66, and #e5e5e5.
...
- Source: Arte Collective (https://arte-collective.com/collections/minimalism/products/minimal-space-green-gravity)
- Live site: https://arte-collective.com/collections/minimalism/products/minimal-space-green-gravity
