...
### World Systems
- Primary: Playable Poster - tags include colorful; tags include playful; archetype affinity: playable poster
- Secondary: Collage Core - tags include colorful; tags include playful; archetype affinity: playable poster

### Interaction Archetype
- Archetype: Playable Poster (66% confidence)
- Why: tags include playful; tags include colorful; sticky layout
...
- Preserve asymmetry when present - the archive tags (playful, colorful) imply the system is intentionally non-generic.
...
- Preserve the experimental posture signaled by the archive tags: playful, colorful.
...
> Build this as a Playable Poster page with a secondary cue from Collage Core using the Playable Poster interaction model. Keep Inter as the voice anchor, preserve the palette around #fdfdfd, #a2a3a4, #f6d3a5, drive the page through scroll, tap, hover, and implement the mobile fallback as: Split the poster into two to four scenes, preserve one hero interaction, and drop hover-only secondary behavior.
