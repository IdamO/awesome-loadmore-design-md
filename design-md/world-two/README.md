# World Two Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [World Two](http://www.world2.uk/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/world-two). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: participative, game, colorful
...
### Web
![World Two desktop capture](./screenshots/desktop.jpg)

### Mobile
![World Two mobile capture](./screenshots/mobile.jpg)
