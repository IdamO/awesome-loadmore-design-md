# DSR NY Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [DSR NY](https://dsrny.com/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/dsr-ny). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![DSR NY desktop capture](./screenshots/desktop.jpg)

### Mobile
![DSR NY mobile capture](./screenshots/mobile.jpg)
