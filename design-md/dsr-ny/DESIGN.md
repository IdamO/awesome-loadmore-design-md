...
### World Systems
- Primary: Luxury Archive - tags include photography; tags include minimal; archetype affinity: portfolio artifact
...
- Why: tags include portfolio; tags include photography; tags include minimal; description mentions portfolio
...
- Preserve asymmetry when present - the archive tags (portfolio, minimal, photography) imply the system is intentionally non-generic.
...
- Preserve the experimental posture signaled by the archive tags: portfolio, minimal, photography.
