# Two Much Rocks Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Two Much Rocks](http://twomuch.rocks) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/http-twomuch-rocks). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: participative, illustration, playful
...
### Web
![Two Much Rocks desktop capture](./screenshots/desktop.jpg)

### Mobile
![Two Much Rocks mobile capture](./screenshots/mobile.jpg)
