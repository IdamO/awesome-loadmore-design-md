# Radical PR Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Radical PR](http://www.radical-pr.com/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/radical-pr). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: minimal, default-aesthetics
- Credits: not listed
...
### Web
![Radical PR desktop capture](./screenshots/desktop.jpg)

### Mobile
![Radical PR mobile capture](./screenshots/mobile.jpg)
