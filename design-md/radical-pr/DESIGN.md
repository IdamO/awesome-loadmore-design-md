...
- Secondary: Luxury Archive - tags include minimal
...
- Preserve asymmetry when present - the archive tags (minimal, default-aesthetics) imply the system is intentionally non-generic.
...
- Preserve the experimental posture signaled by the archive tags: minimal, default-aesthetics.
