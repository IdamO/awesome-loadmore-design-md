# 1982 Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [1982](https://1982.co.uk/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/1982). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![1982 desktop capture](./screenshots/desktop.jpg)

### Mobile
![1982 mobile capture](./screenshots/mobile.jpg)
