...
### World Systems
- Primary: Fan Shrine - tags include e-commerce; description mentions drop; archetype affinity: commerce shrine stage
...
- Why: tags include e-commerce; description mentions drop
...
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #666465 as the interaction signal.
...
> Build this as a Fan Shrine page with a secondary cue from Luxury Archive using the Commerce Shrine Stage interaction model. Keep the extracted primary font as the voice anchor, preserve the palette around #ecedee, #a19f9f, #666465, drive the page through scroll, tap, hover, and implement the mobile fallback as: Use a single-column collectible feed with sticky purchase rails and clear release-state chips instead of shrinking desktop grids.
