# Rachel Maclean Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Rachel Maclean](http://www.rachelmaclean.com/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/rachel-maclean). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Rachel Maclean desktop capture](./screenshots/desktop.jpg)

### Mobile
![Rachel Maclean mobile capture](./screenshots/mobile.jpg)
