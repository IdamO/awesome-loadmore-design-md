...
- Secondary: Collage Core - tags include tactile; description mentions internet

### Interaction Archetype
- Archetype: Editorial Archive Index (83% confidence)
- Why: tags include arts&culture; description mentions collection
...
- Preserve asymmetry when present - the archive tags (tactile, clean-ui, arts&culture) imply the system is intentionally non-generic.
- Buttons tend toward rgba(0, 0, 0, 0) backgrounds with rgb(26, 26, 26) text, and links inherit rgb(26, 26, 26) as the interaction signal.
...
- Preserve the experimental posture signaled by the archive tags: tactile, clean-ui, arts&culture.
