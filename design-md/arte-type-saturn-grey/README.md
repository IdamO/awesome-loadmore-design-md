# Type Saturn - Grey Inspired Design System

[DESIGN.md](./DESIGN.md) derived from the Arte Collective poster [Type Saturn - Grey](https://arte-collective.com/collections/aesthetic/products/type-saturn-grey). This entry intentionally ignores the storefront chrome and instead translates the poster artwork into an imagined interactive website system with web/mobile guidance, spatial mechanics, and motion rules.
...
### Web
![Type Saturn - Grey desktop capture](./screenshots/desktop.jpg)

### Mobile
![Type Saturn - Grey mobile capture](./screenshots/mobile.jpg)
