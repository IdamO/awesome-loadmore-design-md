# Design System Inspiration of Type Saturn - Grey

## 1. Visual Theme & Atmosphere

Type Saturn - Grey reads as type-led composition, spatial depth. The concept capture resolves to a light-leaning system built around #e4e4e4, #b5b4b4, and accent notes from #aeacac. Type Saturn - Grey is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #e4e4e4, #b5b4b4, #aeacac, #b2b1b0
...
- Aura: Type Saturn - Grey should feel like a spatial type specimen whose full poster composition has been pushed into browser depth, not a flat print inside a grid.
...
- Color 2: #b5b4b4 - primary text or opposing surface
- Color 3: #aeacac - accent / interactive signal
- Color 4: #b2b1b0 - supporting surface or hover state
- Color 5: #bbbab9 - supporting surface or hover state
- Color 6: #e8e8e7 - supporting surface or hover state
- Color 7: #d1d1d0 - supporting surface or hover state
- Color 8: #656363 - supporting surface or hover state
...
- Buttons tend toward #656363 backgrounds with #ffffff text, and links inherit #656363 as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(101, 99, 99, 0.35)
...
- Keep the palette anchored to #e4e4e4, #b5b4b4, and #aeacac.
...
- Source: Arte Collective (https://arte-collective.com/collections/aesthetic/products/type-saturn-grey)
- Live site: https://arte-collective.com/collections/aesthetic/products/type-saturn-grey
