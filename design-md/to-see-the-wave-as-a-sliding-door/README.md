# To See The Wave As A Sliding Door Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [To See The Wave As A Sliding Door](https://toseethewaveasaslidingdoor.com/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/to-see-the-wave-as-a-sliding-door). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: minimal, typography, animation
...
### Web
![To See The Wave As A Sliding Door desktop capture](./screenshots/desktop.jpg)

### Mobile
![To See The Wave As A Sliding Door mobile capture](./screenshots/mobile.jpg)
