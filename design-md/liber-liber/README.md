# A Scroll of One's Own Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [A Scroll of One's Own](http://liberliber.net/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/liber-liber). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![A Scroll of One's Own desktop capture](./screenshots/desktop.jpg)

### Mobile
![A Scroll of One's Own mobile capture](./screenshots/mobile.jpg)
