# Harry Boyd Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Harry Boyd](http://www.harryboyd.co.uk/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/harry-boyd). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: portfolio, tactile, clean-ui
- Credits: not listed
...
### Web
![Harry Boyd desktop capture](./screenshots/desktop.jpg)

### Mobile
![Harry Boyd mobile capture](./screenshots/mobile.jpg)
