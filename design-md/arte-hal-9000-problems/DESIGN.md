# Design System Inspiration of HAL 9000 = Problems

## 1. Visual Theme & Atmosphere

HAL 9000 = Problems reads as playful interaction, sonic pacing, retro-computing cues. The concept capture resolves to a dark-leaning system built around #191817, #e6e6e6, and accent notes from #171616. HAL 9000 = Problems is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #191817, #e6e6e6, #171616, #2a1a1a
...
- Aura: HAL 9000 = Problems should feel like a live control poster whose full composition becomes a responsive HUD field instead of flat merch storytelling.
...
- Color 1: #191817 - canvas / dominant background
- Color 2: #e6e6e6 - primary text or opposing surface
- Color 3: #171616 - accent / interactive signal
- Color 4: #2a1a1a - supporting surface or hover state
- Color 5: #381d1d - supporting surface or hover state
- Color 6: #141313 - supporting surface or hover state
- Color 7: #3a3434 - supporting surface or hover state
- Color 8: #e0e0e0 - supporting surface or hover state
...
- Let the main background color (#191817) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #381d1d backgrounds with #ffffff text, and links inherit #381d1d as the interaction signal.
...
- Render tier: mixed
- Primary depth cue in capture: 0 24px 80px rgba(56, 29, 29, 0.35)
...
- Keep the palette anchored to #191817, #e6e6e6, and #171616.
...
- Source: Arte Collective (https://arte-collective.com/collections/technology/products/hal-9000-problems)
- Live site: https://arte-collective.com/collections/technology/products/hal-9000-problems
