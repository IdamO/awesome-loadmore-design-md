# Censor Inspired Design System

[DESIGN.md](./DESIGN.md) derived from the Arte Collective poster [Censor](https://arte-collective.com/collections/minimalism/products/censor). This entry intentionally ignores the storefront chrome and instead translates the poster artwork into an imagined interactive website system with web/mobile guidance, spatial mechanics, and motion rules.
...
### Web
![Censor desktop capture](./screenshots/desktop.jpg)

### Mobile
![Censor mobile capture](./screenshots/mobile.jpg)
