...
- Core palette: #393939, #383838, #bfbfbd, #e6e6e6
...
- Aura: Censor should feel like a text artifact stretched into a calm browser field, where bars and phrases become the whole interaction surface.
...
- Color 1: #393939 - canvas / dominant background
- Color 2: #383838 - primary text or opposing surface
- Color 3: #bfbfbd - accent / interactive signal
- Color 4: #e6e6e6 - supporting surface or hover state
- Color 5: #e3e3e2 - supporting surface or hover state
- Color 6: #2c2c2c - supporting surface or hover state
- Color 7: #999897 - supporting surface or hover state
- Color 8: #414140 - supporting surface or hover state
...
- Let the main background color (#393939) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #414140 backgrounds with #ffffff text, and links inherit #414140 as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(65, 65, 64, 0.35)
...
- Keep the palette anchored to #393939, #383838, and #bfbfbd.
...
- Live site: https://arte-collective.com/collections/minimalism/products/censor
