# Daniel Givens Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Daniel Givens](https://danielgivens.com/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/daniel-givens). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: tactile, colorful, portfolio
- Credits: not listed
...
### Web
![Daniel Givens desktop capture](./screenshots/desktop.jpg)

### Mobile
![Daniel Givens mobile capture](./screenshots/mobile.jpg)
