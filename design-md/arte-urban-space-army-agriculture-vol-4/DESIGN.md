# Design System Inspiration of Urban Space Army - Agriculture vol.4

## 1. Visual Theme & Atmosphere

Urban Space Army - Agriculture vol.4 reads as playful interaction, sonic pacing, retro-computing cues. The concept capture resolves to a light-leaning system built around #e2dcd0, #c0a979, and accent notes from #e6e6e6. Urban Space Army - Agriculture vol.4 is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #e2dcd0, #c0a979, #e6e6e6, #e6dfd3
...
- Aura: Urban Space Army - Agriculture vol.4 should feel like a live control poster whose full composition becomes a responsive HUD field instead of flat merch storytelling.
...
- Color 1: #e2dcd0 - canvas / dominant background
- Color 2: #c0a979 - primary text or opposing surface
- Color 3: #e6e6e6 - accent / interactive signal
- Color 4: #e6dfd3 - supporting surface or hover state
- Color 5: #e4e4e4 - supporting surface or hover state
- Color 6: #52584a - supporting surface or hover state
- Color 7: #ded7ca - supporting surface or hover state
- Color 8: #bdb085 - supporting surface or hover state
...
- Let the main background color (#e2dcd0) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #c0a979 backgrounds with #ffffff text, and links inherit #c0a979 as the interaction signal.
...
- Render tier: mixed
- Primary depth cue in capture: 0 24px 80px rgba(192, 169, 121, 0.35)
...
- Keep the palette anchored to #e2dcd0, #c0a979, and #e6e6e6.
...
- Source: Arte Collective (https://arte-collective.com/collections/technology/products/urban-space-army-agriculture-vol-4)
- Live site: https://arte-collective.com/collections/technology/products/urban-space-army-agriculture-vol-4
