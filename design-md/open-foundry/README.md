# Open Foundry Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Open Foundry](https://open-foundry.com) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/open-foundry). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Open Foundry desktop capture](./screenshots/desktop.jpg)

### Mobile
![Open Foundry mobile capture](./screenshots/mobile.jpg)
