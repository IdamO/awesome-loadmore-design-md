# Desktop FM Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Desktop FM](http://desktop.fm/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/desktop-fm). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Desktop FM desktop capture](./screenshots/desktop.jpg)

### Mobile
![Desktop FM mobile capture](./screenshots/mobile.jpg)
