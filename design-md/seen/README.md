# Seen Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Seen](https://www.seen.space/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/seen). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: 3d-space, colorful, online-magazine
...
### Web
![Seen desktop capture](./screenshots/desktop.jpg)

### Mobile
![Seen mobile capture](./screenshots/mobile.jpg)
