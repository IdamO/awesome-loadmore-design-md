# Design System Inspiration of Floating In Entropy

## 1. Visual Theme & Atmosphere

Floating In Entropy reads as editorial fashion energy. The live capture resolves to a dark-leaning system built around #030303, #23221d, and accent notes from #5b5752. An ever-evolving virtual fashion collection.

Desktop and mobile stay aligned but not identical: the desktop capture emphasizes a looser scroll narrative, while mobile compresses the same language into tighter interaction zones. The site's type system centers untitled-bold, which becomes the fastest way to reproduce the feel.

Key Characteristics:
- Primary tone: cinematic dark surfaces with bright contrast
- Core palette: #030303, #23221d, #5b5752, #4b4438
- Typography stack: untitled-bold, untitled-regular, reckless
...
### World Systems
- Primary: Fan Shrine - tags include fashion; description mentions collection; description mentions fashion
...
- Why: tags include fashion; description mentions collection; description mentions fashion
...
- Color 1: #030303 - canvas / dominant background
- Color 2: #23221d - primary text or opposing surface
- Color 3: #5b5752 - accent / interactive signal
- Color 4: #4b4438 - supporting surface or hover state
- Color 5: #433c30 - supporting surface or hover state
- Color 6: #8e8b85 - supporting surface or hover state
- Color 7: #86837c - supporting surface or hover state
- Color 8: #817e77 - supporting surface or hover state

## 4. Typography Rules

### Font Families
- Primary: untitled-bold
- Secondary: untitled-regular
- Support: reckless
...
- Let the main background color (#030303) carry the atmosphere instead of layering multiple competing surfaces.
- Preserve asymmetry when present - the archive tags (fashion, ai&generative) imply the system is intentionally non-generic.
...
### Do
- Use untitled-bold consistently for headlines and interface labels.
- Keep the palette anchored to #030303, #23221d, and #5b5752.
- Preserve the experimental posture signaled by the archive tags: fashion, ai&generative.
...
> Build this as a Fan Shrine page with a secondary cue from Luxury Archive using the Commerce Shrine Stage interaction model. Keep untitled-bold as the voice anchor, preserve the palette around #030303, #23221d, #5b5752, drive the page through scroll, tap, hover, and implement the mobile fallback as: Use a single-column collectible feed with sticky purchase rails and clear release-state chips instead of shrinking desktop grids.



## 15. Source Capture & Validation

- Source: loadmo.re (https://loadmo.re/posts/floating-in-entropy)
- Live site: https://superficial.studio/entropy/
