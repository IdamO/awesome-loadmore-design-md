# Max Bittker Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Max Bittker](https://maxbittker.com/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/max-bittker). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: portfolio, retro, default-aesthetics, net.art
- Credits: not listed
...
### Web
![Max Bittker desktop capture](./screenshots/desktop.jpg)

### Mobile
![Max Bittker mobile capture](./screenshots/mobile.jpg)
