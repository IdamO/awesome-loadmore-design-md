# Design System Inspiration of CTRL Z

## 1. Visual Theme & Atmosphere

CTRL Z reads as playful interaction, sonic pacing, retro-computing cues. The concept capture resolves to a light-leaning system built around #e1e1de, #e4e4e4, and accent notes from #e3e3e0. CTRL Z is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #e1e1de, #e4e4e4, #e3e3e0, #e2e2df
...
- Aura: CTRL Z should feel like a live control poster whose full composition becomes a responsive HUD field instead of flat merch storytelling.
...
- Color 1: #e1e1de - canvas / dominant background
- Color 2: #e4e4e4 - primary text or opposing surface
- Color 3: #e3e3e0 - accent / interactive signal
- Color 4: #e2e2df - supporting surface or hover state
- Color 5: #e2e2e0 - supporting surface or hover state
- Color 6: #85817e - supporting surface or hover state
- Color 7: #e7e7e6 - supporting surface or hover state
- Color 8: #e1e2df - supporting surface or hover state
...
- Let the main background color (#e1e1de) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #85817e backgrounds with #ffffff text, and links inherit #85817e as the interaction signal.
...
- Render tier: mixed
- Primary depth cue in capture: 0 24px 80px rgba(133, 129, 126, 0.35)
...
- Keep the palette anchored to #e1e1de, #e4e4e4, and #e3e3e0.
...
- Source: Arte Collective (https://arte-collective.com/collections/technology/products/ctrl-z)
- Live site: https://arte-collective.com/collections/technology/products/ctrl-z
