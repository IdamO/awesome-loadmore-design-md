# ABC Dinamo Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [ABC Dinamo](https://abcdinamo.com/typefaces/otto) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/abc-dinamo). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![ABC Dinamo desktop capture](./screenshots/desktop.jpg)

### Mobile
![ABC Dinamo mobile capture](./screenshots/mobile.jpg)
