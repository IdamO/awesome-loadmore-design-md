...
### World Systems
- Primary: Collage Core - tags include net.art; tags include playful; tags include tactile
- Secondary: Playable Poster - tags include playful; tags include tactile; archetype affinity: collage field
...
- Preserve asymmetry when present - the archive tags (tactile, net.art, playful) imply the system is intentionally non-generic.
- Buttons tend toward rgba(0, 0, 0, 0) backgrounds with rgb(0, 0, 0) text, and links inherit #497452 as the interaction signal.
...
- Preserve the experimental posture signaled by the archive tags: tactile, net.art, playful.
