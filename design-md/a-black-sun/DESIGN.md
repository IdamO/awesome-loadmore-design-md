...
- Preserve asymmetry when present - the archive tags (sound-design, minimal) imply the system is intentionally non-generic.
...
- Preserve the experimental posture signaled by the archive tags: sound-design, minimal.
