# Design System Inspiration of Art House by The Webster

## 1. Visual Theme & Atmosphere

Art House by The Webster reads as editorial fashion energy, spatial depth, exhibition-like framing. The live capture resolves to a light-leaning system built around #98d2e1, #55b2c9, and accent notes from #77c3d5. Superficial.studio got inspired by Yves Klein and David Hockney to design fantasy virtual spaces with 3D interactive products.

Desktop and mobile stay aligned but not identical: the desktop capture emphasizes a looser scroll narrative, while mobile compresses the same language into tighter interaction zones. The site's type system centers a bespoke stack, which becomes the fastest way to reproduce the feel.

Key Characteristics:
- Primary tone: bright surfaces with editorial contrast
- Core palette: #98d2e1, #55b2c9, #77c3d5, #3daac3
...
### World Systems
- Primary: Luxury Archive - tags include digital-exhibition; tags include fashion; archetype affinity: spatial exhibition world
- Secondary: Fan Shrine - tags include fashion; description mentions product; archetype affinity: spatial exhibition world

### Interaction Archetype
- Archetype: Spatial Exhibition World (96% confidence)
- Why: tags include 3d-space; tags include digital-exhibition; tags include fashion; description mentions 3d
...
- Color 1: #98d2e1 - canvas / dominant background
- Color 2: #55b2c9 - primary text or opposing surface
- Color 3: #77c3d5 - accent / interactive signal
- Color 4: #3daac3 - supporting surface or hover state
- Color 5: #54a1b4 - supporting surface or hover state
- Color 6: #3aa4bc - supporting surface or hover state
- Color 7: #90b299 - supporting surface or hover state
- Color 8: #9ecca2 - supporting surface or hover state
...
- Let the main background color (#98d2e1) carry the atmosphere instead of layering multiple competing surfaces.
- Preserve asymmetry when present - the archive tags (fashion, 3d-space, digital-exhibition) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #77c3d5 as the interaction signal.
...
- Keep the palette anchored to #98d2e1, #55b2c9, and #77c3d5.
- Preserve the experimental posture signaled by the archive tags: fashion, 3d-space, digital-exhibition.
...
- Source: loadmo.re (https://loadmo.re/posts/art-house-by-the-webster)
- Live site: https://art-house.thewebster.us
