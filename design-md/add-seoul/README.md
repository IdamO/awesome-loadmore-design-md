# Add seoul Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Add seoul](http://add-seoul.com) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/add-seoul). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: e-commerce, fashion, tactile
- Credits: 131design
...
### Web
![Add seoul desktop capture](./screenshots/desktop.jpg)

### Mobile
![Add seoul mobile capture](./screenshots/mobile.jpg)
