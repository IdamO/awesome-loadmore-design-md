# The Peach Spring Beyond This World Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [The Peach Spring Beyond This World](http://beurownmastr.com/ty/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/the-peach-spring-beyond-this-world). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![The Peach Spring Beyond This World desktop capture](./screenshots/desktop.jpg)

### Mobile
![The Peach Spring Beyond This World mobile capture](./screenshots/mobile.jpg)
