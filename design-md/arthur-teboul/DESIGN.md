...
- Why: tags include portfolio; tags include minimal; tags include playful
- Core verbs: read, browse, contact, draw
- Inputs: scroll, tap
...
- Preserve asymmetry when present - the archive tags (portfolio, tactile, minimal, playful) imply the system is intentionally non-generic.
...
- Preserve the experimental posture signaled by the archive tags: portfolio, tactile, minimal, playful.
