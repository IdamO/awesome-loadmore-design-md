# Boring Conversation Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Boring Conversation](https://boringconversation.chat/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/boring-conversation). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- World systems: Cozy Desktop, Luxury Archive
...
- Tags: participative, default-aesthetics, minimal
- Credits: Maja
...
### Web
![Boring Conversation desktop capture](./screenshots/desktop.jpg)

### Mobile
![Boring Conversation mobile capture](./screenshots/mobile.jpg)
