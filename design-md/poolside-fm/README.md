# PoolSide FM Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [PoolSide FM](https://poolside.fm) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/poolside-fm). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: music, retro, default-aesthetics
...
### Web
![PoolSide FM desktop capture](./screenshots/desktop.jpg)

### Mobile
![PoolSide FM mobile capture](./screenshots/mobile.jpg)
