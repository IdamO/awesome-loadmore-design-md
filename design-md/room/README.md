# ROOM Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [ROOM](https://www.room.haus/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/room). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![ROOM desktop capture](./screenshots/desktop.jpg)

### Mobile
![ROOM mobile capture](./screenshots/mobile.jpg)
