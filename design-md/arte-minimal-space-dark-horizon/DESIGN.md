...
- Core palette: #1d1c1c, #e5e5e5, #1d1d1c, #1e1d1d
...
- Aura: Minimal Space - Dark Horizon should feel like a drifting internet relic whose full poster composition becomes a shallow-depth, glow-rail field.
...
- Color 3: #1d1d1c - accent / interactive signal
- Color 4: #1e1d1d - supporting surface or hover state
- Color 5: #171717 - supporting surface or hover state
- Color 6: #858484 - supporting surface or hover state
- Color 7: #1c1c1c - supporting surface or hover state
- Color 8: #1c1d1c - supporting surface or hover state
...
- Buttons tend toward #1d1c1c backgrounds with #ffffff text, and links inherit #1d1c1c as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(29, 28, 28, 0.35)
...
- Keep the palette anchored to #1d1c1c, #e5e5e5, and #1d1d1c.
...
- Source: Arte Collective (https://arte-collective.com/collections/minimalism/products/minimal-space-dark-horizon)
- Live site: https://arte-collective.com/collections/minimalism/products/minimal-space-dark-horizon
