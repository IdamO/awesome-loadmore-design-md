...
### World Systems
- Primary: Club Instrument - tags include sound-design; description mentions sound
- Secondary: Cozy Desktop - description mentions browser
...
- Preserve asymmetry when present - the archive tags (game, sound-design) imply the system is intentionally non-generic.
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #c6c6c6 as the interaction signal.
...
- Preserve the experimental posture signaled by the archive tags: game, sound-design.
