# Messenger Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Messenger](https://messenger.abeto.co/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/messenger). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Messenger desktop capture](./screenshots/desktop.jpg)

### Mobile
![Messenger mobile capture](./screenshots/mobile.jpg)
