# Dinamo Typefaces Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Dinamo Typefaces](https://abcdinamo.com) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/dinamo-typefaces). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: typography, colorful, graphic-design
- Credits: not listed
...
### Web
![Dinamo Typefaces desktop capture](./screenshots/desktop.jpg)

### Mobile
![Dinamo Typefaces mobile capture](./screenshots/mobile.jpg)
