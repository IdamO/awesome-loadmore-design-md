# Design System Inspiration of Ascend

## 1. Visual Theme & Atmosphere

Ascend reads as type-led composition, spatial depth. The concept capture resolves to a dark-leaning system built around #1f1e1c, #e6e6e6, and accent notes from #161513. Ascend is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #1f1e1c, #e6e6e6, #161513, #e4e4e4
...
- Aura: Ascend should feel like a drifting internet relic whose full poster composition becomes a shallow-depth, glow-rail field.
...
- Color 1: #1f1e1c - canvas / dominant background
- Color 2: #e6e6e6 - primary text or opposing surface
- Color 3: #161513 - accent / interactive signal
- Color 4: #e4e4e4 - supporting surface or hover state
- Color 5: #1a1918 - supporting surface or hover state
- Color 6: #121010 - supporting surface or hover state
- Color 7: #35312e - supporting surface or hover state
- Color 8: #a5886d - supporting surface or hover state
...
- Let the main background color (#1f1e1c) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #a5886d backgrounds with #ffffff text, and links inherit #a5886d as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(165, 136, 109, 0.35)
...
- Keep the palette anchored to #1f1e1c, #e6e6e6, and #161513.
...
- Source: Arte Collective (https://arte-collective.com/collections/aesthetic/products/ascend)
- Live site: https://arte-collective.com/collections/aesthetic/products/ascend
