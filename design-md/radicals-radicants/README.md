# Radicals Radicants Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Radicals Radicants](http://radicalsradicants.com) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/radicals-radicants). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: arts&culture, default-aesthetics, colorful
...
### Web
![Radicals Radicants desktop capture](./screenshots/desktop.jpg)

### Mobile
![Radicals Radicants mobile capture](./screenshots/mobile.jpg)
