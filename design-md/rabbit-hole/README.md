# Rabbit Hole Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Rabbit Hole](https://www.rabbithole.tube) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/rabbit-hole). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: net.art, arts&culture, glitches
...
### Web
![Rabbit Hole desktop capture](./screenshots/desktop.jpg)

### Mobile
![Rabbit Hole mobile capture](./screenshots/mobile.jpg)
