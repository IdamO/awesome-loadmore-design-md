# Han Kjøbenhavn Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Han Kjøbenhavn](https://hankjobenhavn.com/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/han-kjobenhavn). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
- Tags: e-commerce, fashion, default-aesthetics
- Credits: not listed
...
### Web
![Han Kjøbenhavn desktop capture](./screenshots/desktop.jpg)

### Mobile
![Han Kjøbenhavn mobile capture](./screenshots/mobile.jpg)
