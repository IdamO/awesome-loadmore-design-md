...
### World Systems
- Primary: Luxury Archive - tags include arts&culture; tags include digital-exhibition; tags include typography
- Secondary: Playable Poster - tags include typography; description mentions poster; description mentions event

### Interaction Archetype
- Archetype: Editorial Archive Index (90% confidence)
- Why: tags include arts&culture; tags include digital-exhibition; tags include typography; description mentions exhibition
...
- Preserve asymmetry when present - the archive tags (arts&culture, typography, digital-exhibition) imply the system is intentionally non-generic.
...
- Preserve the experimental posture signaled by the archive tags: arts&culture, typography, digital-exhibition.
