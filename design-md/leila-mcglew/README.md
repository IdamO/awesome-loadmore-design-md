# Leila Mcglew Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Leila Mcglew](http://leilamcglew.com) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/leila-mcglew). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Leila Mcglew desktop capture](./screenshots/desktop.jpg)

### Mobile
![Leila Mcglew mobile capture](./screenshots/mobile.jpg)
