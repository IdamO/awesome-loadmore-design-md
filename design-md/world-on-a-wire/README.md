# World On a Wire Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [World On a Wire](https://worldonawire.net/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/world-on-a-wire). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![World On a Wire desktop capture](./screenshots/desktop.jpg)

### Mobile
![World On a Wire mobile capture](./screenshots/mobile.jpg)
