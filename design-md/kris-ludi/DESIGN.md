...
- Preserve asymmetry when present - the archive tags (portfolio, minimal, typography) imply the system is intentionally non-generic.
...
- Preserve the experimental posture signaled by the archive tags: portfolio, minimal, typography.
