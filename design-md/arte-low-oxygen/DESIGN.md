# Design System Inspiration of Low Oxygen

## 1. Visual Theme & Atmosphere

Low Oxygen reads as type-led composition, spatial depth. The concept capture resolves to a dark-leaning system built around #202020, #d5d5d5, and accent notes from #e6e6e6. Low Oxygen is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #202020, #d5d5d5, #e6e6e6, #7e7e7e
...
- Aura: Low Oxygen should feel like a drifting internet relic whose full poster composition becomes a shallow-depth, glow-rail field.
...
- Color 1: #202020 - canvas / dominant background
- Color 2: #d5d5d5 - primary text or opposing surface
- Color 3: #e6e6e6 - accent / interactive signal
- Color 4: #7e7e7e - supporting surface or hover state
- Color 5: #d5d5d4 - supporting surface or hover state
- Color 6: #d4d5d5 - supporting surface or hover state
- Color 7: #d6d5d6 - supporting surface or hover state
...
- Let the main background color (#202020) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #d5d5d4 backgrounds with #111111 text, and links inherit #d5d5d4 as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(213, 213, 212, 0.35)
...
- Keep the palette anchored to #202020, #d5d5d5, and #e6e6e6.
...
- Source: Arte Collective (https://arte-collective.com/collections/aesthetic/products/low-oxygen)
- Live site: https://arte-collective.com/collections/aesthetic/products/low-oxygen
