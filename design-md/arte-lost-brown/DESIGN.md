# Design System Inspiration of Lost - Brown

## 1. Visual Theme & Atmosphere

Lost - Brown reads as type-led composition, spatial depth. The concept capture resolves to a dark-leaning system built around #562f2e, #e6e6e6, and accent notes from #201a19. Lost - Brown is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #562f2e, #e6e6e6, #201a19, #552c2c
...
- Aura: Lost - Brown should feel like a drifting internet relic whose full poster composition becomes a shallow-depth, glow-rail field.
...
- Color 1: #562f2e - canvas / dominant background
- Color 2: #e6e6e6 - primary text or opposing surface
- Color 3: #201a19 - accent / interactive signal
- Color 4: #552c2c - supporting surface or hover state
- Color 5: #55302f - supporting surface or hover state
- Color 6: #412525 - supporting surface or hover state
- Color 7: #603532 - supporting surface or hover state
- Color 8: #dddddd - supporting surface or hover state
...
- Let the main background color (#562f2e) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #552c2c backgrounds with #ffffff text, and links inherit #552c2c as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(85, 44, 44, 0.35)
...
- Keep the palette anchored to #562f2e, #e6e6e6, and #201a19.
...
- Source: Arte Collective (https://arte-collective.com/collections/aesthetic/products/lost-brown)
- Live site: https://arte-collective.com/collections/aesthetic/products/lost-brown
