# Minimal Space - Yellow Breathe Inspired Design System

[DESIGN.md](./DESIGN.md) derived from the Arte Collective poster [Minimal Space - Yellow Breathe](https://arte-collective.com/collections/minimalism/products/minimal-space-yellow-breathe). This entry intentionally ignores the storefront chrome and instead translates the poster artwork into an imagined interactive website system with web/mobile guidance, spatial mechanics, and motion rules.
...
### Web
![Minimal Space - Yellow Breathe desktop capture](./screenshots/desktop.jpg)

### Mobile
![Minimal Space - Yellow Breathe mobile capture](./screenshots/mobile.jpg)
