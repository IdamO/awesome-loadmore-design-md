...
- Core palette: #e6e6e6, #fcda57, #fbda59, #7f7443
...
- Aura: Minimal Space - Yellow Breathe should feel like a drifting internet relic whose full poster composition becomes a shallow-depth, glow-rail field.
...
- Color 1: #e6e6e6 - canvas / dominant background
- Color 2: #fcda57 - primary text or opposing surface
- Color 3: #fbda59 - accent / interactive signal
- Color 4: #7f7443 - supporting surface or hover state
- Color 5: #fbda58 - supporting surface or hover state
- Color 6: #fedf5a - supporting surface or hover state
- Color 7: #fedc58 - supporting surface or hover state
- Color 8: #e8e3cd - supporting surface or hover state
...
- Let the main background color (#e6e6e6) carry the atmosphere instead of layering multiple competing surfaces.
...
- Buttons tend toward #fcda57 backgrounds with #111111 text, and links inherit #fcda57 as the interaction signal.
...
- Render tier: dom
- Primary depth cue in capture: 0 24px 80px rgba(252, 218, 87, 0.35)
...
- Keep the palette anchored to #e6e6e6, #fcda57, and #fbda59.
...
- Source: Arte Collective (https://arte-collective.com/collections/minimalism/products/minimal-space-yellow-breathe)
- Live site: https://arte-collective.com/collections/minimalism/products/minimal-space-yellow-breathe
