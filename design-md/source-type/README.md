# Source Type Inspired Design System

[DESIGN.md](./DESIGN.md) extracted from the public [Source Type](https://www.sourcetype.com/) website, cross-referenced with [loadmo.re](https://loadmo.re/posts/source-type). This is not the official design system. The goal is to give an AI agent enough grounded design language to recreate the feel without flattening it into generic SaaS UI.
...
### Web
![Source Type desktop capture](./screenshots/desktop.jpg)

### Mobile
![Source Type mobile capture](./screenshots/mobile.jpg)
