# Design System Inspiration of Urban Space Army - Military vol.3

## 1. Visual Theme & Atmosphere

Urban Space Army - Military vol.3 reads as playful interaction, sonic pacing, retro-computing cues. The concept capture resolves to a light-leaning system built around #f9f9f9, #e3e4e5, and accent notes from #239ddd. Urban Space Army - Military vol.3 is treated here as a poster-derived website concept. The source is the Arte Collective poster, but the design guidance describes how to turn the art into a live browser world with depth, motion, and mobile behavior.
...
- Core palette: #f9f9f9, #e3e4e5, #239ddd, #373d40
...
- Aura: Urban Space Army - Military vol.3 should feel like a live control poster whose full composition becomes a responsive HUD field instead of flat merch storytelling.
...
- Color 2: #e3e4e5 - primary text or opposing surface
- Color 3: #239ddd - accent / interactive signal
- Color 4: #373d40 - supporting surface or hover state
- Color 5: #e8e8e8 - supporting surface or hover state
- Color 6: #fbfbfa - supporting surface or hover state
- Color 7: #83bbd8 - supporting surface or hover state
- Color 8: #faf7f6 - supporting surface or hover state
...
- Buttons tend toward #239ddd backgrounds with #ffffff text, and links inherit #239ddd as the interaction signal.
...
- Render tier: mixed
- Primary depth cue in capture: 0 24px 80px rgba(35, 157, 221, 0.35)
...
- Keep the palette anchored to #f9f9f9, #e3e4e5, and #239ddd.
...
- Source: Arte Collective (https://arte-collective.com/collections/technology/products/urban-space-army-military-vol-3)
- Live site: https://arte-collective.com/collections/technology/products/urban-space-army-military-vol-3
