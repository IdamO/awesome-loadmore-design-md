...
### World Systems
- Primary: Cozy Desktop - tags include participative; description mentions computer; archetype affinity: desktop shell world
- Secondary: Collage Core - tags include colorful

### Interaction Archetype
- Archetype: Desktop Shell World (96% confidence)
- Why: tags include participative; description mentions computer; title mentions computer
...
- Preserve asymmetry when present - the archive tags (participative, colorful) imply the system is intentionally non-generic.
- Buttons tend toward rgb(52, 52, 52) backgrounds with rgb(52, 52, 52) text, and links inherit rgb(52, 52, 52) as the interaction signal.
...
- Preserve the experimental posture signaled by the archive tags: participative, colorful.
