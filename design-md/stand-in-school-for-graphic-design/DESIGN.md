# Design System Inspiration of Stand in School for Graphic Design

## 1. Visual Theme & Atmosphere

Stand in School for Graphic Design reads as playful interaction. The live capture resolves to a light-leaning system built around #fcfcfc, #625e5b, and accent notes from #a49d9c. Website for the Stand in School for Graphic Design with playful gravity interactions.
...
- Core palette: #fcfcfc, #625e5b, #a49d9c, #1e1c1a
...
- Archetype: Toy Loop Microgame (93% confidence)
- Why: tags include playful; description mentions play; description mentions interact
...
- Color 2: #625e5b - primary text or opposing surface
- Color 3: #a49d9c - accent / interactive signal
- Color 4: #1e1c1a - supporting surface or hover state
- Color 5: #dfdbab - supporting surface or hover state
- Color 6: #c9afa3 - supporting surface or hover state
- Color 7: #93d42e - supporting surface or hover state
- Color 8: #97685d - supporting surface or hover state
...
- Body sample: 21.6px / weight 400 / line-height 21.6px
...
- Buttons tend toward transparent backgrounds with inherit text, and links inherit #a49d9c as the interaction signal.
...
- Keep the palette anchored to #fcfcfc, #625e5b, and #a49d9c.
...
> Build this as a Playable Poster page with a secondary cue from Collage Core using the Toy Loop Microgame interaction model. Keep the extracted primary font as the voice anchor, preserve the palette around #fcfcfc, #625e5b, #a49d9c, drive the page through tap, drag, and implement the mobile fallback as: Keep only tap and drag; remove precision mechanics, shorten the loop, and enlarge hit targets.


## 15. Source Capture & Validation

- Source: loadmo.re (https://loadmo.re/posts/stand-in-school-for-graphic-design)
- Live site: https://estende.eka-gd-ma.ee/
- Credits: Agathe Mathel Seppe-Hazel Laeremans
- Capture mode: live
